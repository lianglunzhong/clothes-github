	...
	<div class="container">
		<div class="crumbs">
			<div>
				...
				<a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > my account</a> > address book
			</div>
					...
					<dl class="address-book col-sm-6 col-xs-12">
						<dd class="last">
							<div class="address-book-form">
								<p class="top-btn"><a class="btn btn-primary btn-xs"  href="<?php echo LANGPATH; ?>/address/add">ADD NEW</a>
								</p>
                <?php
					...
					?>
                                ...
                                if ($address['is_default']):
                                    ?>
											<li>
												<label>Label:</label>
												<div>This is your default shipping address</div>
											</li>
                            <?php
                                endif;
                                ?>
								...
								<form method="post" action="<?php echo LANGPATH; ?>/address/set_default">
									<p class="top-btn">
										<a  href="<?php echo LANGPATH; ?>/address/edit/<?php echo $address['id']; ?>" class="a-red edit_address JS_popwinbtn" title="<?php echo $address['id']; ?>" >Edit</a>
										<a class="a-underline delete" href="javascript:delete_address(<?php echo $address['id']; ?>)">Delete</a>
...
<input type="hidden" id="e_address_id" name="address_id" value="">
        ...
        <script>
            function changeSelectCountry1(){
				...
				<li>
					<label class="col-sm-3 col-xs-12"><span>*</span> City / Town:</label>
					<div class="col-sm-9 col-xs-12">
        ...
        <label class="error a4" style="display:none;"  generated="true" id="guo_eon">Please choose your country.</label>
				...
				<li>
					<label class="col-sm-3 col-xs-12"><span>*</span> Zip / Postal Code:</label>
					<div class="col-sm-9 col-xs-12">
        ...
        <em style="display:block;">If there is no zip code in your area, please enter 0000 instead.</em>
				...
				<li>
					<label class="col-sm-3 col-xs-12"><span>*</span> Phone:</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" id="e_phone" value="" name="phone" class="text text-long col-sm-12 col-xs-12" />
						<p class="phone-tips">Please leave correct and complete phone number for 
            accurate delivery by postman</p>
					</div>
				</li>
        ...
        <input type="text" name="cpf" class="text text_long" value="" />
			...
			<div>
				...
				<div class="col-sm-9 col-xs-12">
					...
					<input type="submit" value="save & Add New" class="btn btn-primary btn-sm" id="submitAdd" />
					<input type="submit" id="submitSave" value="save" class="btn btn-primary btn-sm" />
				</div>
			</div>
		</form>
	</div>
