        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-8 col-md-8">
                    <a href="/"><img src="<?php echo STATICURLHTTPS; ?>/assets/images/2016/logo.png" alt=""></a>
                </div>
                <div class="col-xs-4 col-md-4">
                    <a href="https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf/splash.fdf&amp;dn=www.choies.com&amp;lang=en" target="_blank"><img src="<?php echo STATICURLHTTPS; ?>/assets/images/card3.png"></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="shipping-information">
                        <div class="information-con">
                            ...
                            <div class="billing-address" id="payment_address">
                                ...
                                <a href="javascript:;" class="red JS-popwinbtn1">Edit</a>
                            </div>
                        ...
                        <div class="payment-wrap">
                            <div class="payment-p">
                                <div class="payment-message">
                                    ...
                                    <div class="fll">Order NO.:<span class=" f16 bold"><?php echo $order['ordernum']; ?></span></div>
                                </div>
                                ...
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                    <ul>
                                        <li class="clearfix">
                                            ...
                                            <br><br><br>
                                            <div class="error hide" id="card_error1">Please choose your credit card type.</div> 
                                        </li>
                                        <li class="clearfix">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="card_error">The credit card number is incorrect.</div>
                                        </li>
                                        <li class="clearfix">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="expire_error">The month of expiry date is incorrect.</div>                                                               
                                        </li>
                                        <li class="clearfix">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="cvv_error">Please enter a 3-digit CVV/CVC Code.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="PAY NOW" id="paybutton" name="paybutton" class="btn btn-primary btn-lg" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
