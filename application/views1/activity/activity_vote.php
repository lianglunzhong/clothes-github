          ...
          <div class="site-content">
            <div class="main-container clearfix">
                <div class="container">
                    <div class="row">
                    <div class="col-xs-12">
                        <a href=""><img src="<?php echo STATICURL; ?>/assets/images/activity/vote-top-1.jpg"></a>
                        <a href="<?php echo LANGPATH;?>/customer/login?redirect=<?php echo LANGPATH; ?>/activity/model_vote"><img src="<?php echo STATICURL; ?>/assets/images/activity/vote-top-2.jpg"></a>
                        <form action="<?php echo LANGPATH;?>/activity/model_vote" method="post" id="formvote">
                            ...
                            <?php foreach($skuArr as $k=>$v){
                             ...
                             <li class="pro-item col-xs-6 col-sm-3">
                                    ...
                                    <div class="title clearfix mb10">
                                        ...
                                        <div class="flr"><a href=""><i class="myaccount"></i><b class="red"><?php echo isset($votes[$v]) && $votes[$v] ? $votes[$v] : 0; ?> Votes</b></a></div>
                                    </div>
                                </li>
                            <?php } ?>
                        ...
                        <div class="vote-bottom">
                            ...
                            <div class="vote-box col-xs-12 col-sm-6">
                                <div class="clearfix vote-textarea">
                                    <span><input name="Fruit" type="checkbox" value="" />I wanna give CHOIES some suggestions about the model/outfits.</span>
                                    <textarea class="textarea-long" name="comment" maxlength="500" 
                                                style="width: 100%; height: 63px;color: #878787;background-color: #fff;" onfocus="this.value=''; this.onfocus=null;" value="">Leave your comment...</textarea>
                                </div>
                                <div class=" vote-sub">
                                    <p>Share with your Facebook friends or Pinterest friends to vote together.</p>
                                    <p class="red">The more you share, the more opportunities you win $100 gift card. </p>
                                    ...
                                    <button type="button" id="bu" class="btn btn-default btn-lg mt20">SUBMIT</button>
                                </div>
                            </div>
                        </form>
