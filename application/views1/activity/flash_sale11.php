...
<a href="<?php echo $link;  ?>" class="visible-xs-inline-block btn btn-primary btn-sm hidden-sm hidden-md hidden-lg">CHOOSE SIZE</a>
                ...
                <script type="text/javascript">
                    ...
                    <div class="tab-bottom hidden-xs">
                        <div class="tab-menu">
                            <ul>
                ...
                <?php
                    ...
                    foreach($usdsArr as $usd => $products)
                    {
                        $key ++;
                    ?>
                            <div class="v-show" <?php if($key > 1) echo 'style="display:none"'; ?>>
                                <div class="v-content">
                                ...
                                <?php
                                    ...
                                    ?>
                                            <li>
                                        <a target="_blank" href="<?php echo $product->permalink(); ?>"><img src="<?php echo Image::link($product->cover_image(), 7); ?>" alt="" /></a><span><?php echo Site::instance()->price($product->price(), 'code_view'); ?></span>
                                            </li>
                                    <?php
                                    }
                                    ?>
                                ...
                                <div> <a href="/<?php echo $usd; ?>" target="_blank" style="color:#ff0000;text-decoration:underline;font-weight:bold;text-align:center;font-size:18px;padding:20px 0 15px 0;display:block;"><i>View More Deals</i>  </a>
                                </div>
                            </div>
                     <?php
                    }
                    ...
                    <div class="tab-bottom-mobile container visible-xs-block hidden-sm hidden-md hidden-lg">
                        <div class="w-tit">
                            <h2>USD 9.9</h2>
                        </div>
                    ...
                    ?>
                                ...
                                <li class="col-xs-6">
                                    ...
                                    <p class="price">
                                    <?php echo Site::instance()->price($product->price(), 'code_view'); ?>
                                    </p>
                                </li>
                                <?php
                                    }
                                    ?>
                                <ul>
                                    <div> <a href="/usd-9" style="color:#ff0000;text-decoration:underline;font-weight:bold;text-align:center;font-size:12px;padding:10px 0 0 0;display:block;" target="_blank"><i>View More Deals</i>  </a> </div>
                        </div>
                    </div>
                    <div class="tab-bottom-mobile container visible-xs-block hidden-sm hidden-md hidden-lg">
                        <div class="w-tit">
                    ...
                    <?php echo Site::instance()->price($product->price(), 'code_view'); ?>
                                    ...
                                    ?>
                                <ul>
                                    <div> <a href="usd-13" style="color:#ff0000;text-decoration:underline;font-weight:bold;text-align:center;font-size:12px;padding:10px 0 0 0;display:block;" target="_blank"><i>View More Deals</i>  </a> </div>
                        </div>
                    </div>
                </article>
