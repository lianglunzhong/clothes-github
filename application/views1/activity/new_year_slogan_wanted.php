...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta name="keywords" content="<?php if(isset($keywords)){$keywords;} ?>" />
        ...
        <link rel="image_src" href="http://www.choies.com/images/activity/slogan-02.jpg"/>
        <meta property="og:title" content="Choies 2015 Slogan Wanted!!!" />
        <meta property="og:url" content="http://www.choies.com/activity/new_year_slogan_wanted" />
        ...
        <meta property="og:image" content="http://www.choies.com/images/activity/slogan-02.jpg">
        <style>
    ...
    <body>
                            ...
                            <div class="mybag JS_show">
                                ...
                                <div class="mybag_box JS_showcon hide">
                                    ...
                                    <div class="mybag_con">
                                        ...
                                        <!--<p class="ppexpress mt10"><a href="javascript:void(0)" style="background:none;" onclick="location.href='/payment/ppec_set';" id="pp_express"><img src="<?php echo STATICURL; ?>/ximg/ppec.jpg" alt="Click here to pay via PayPal Express Checkout" style="vertical-align: middle;"></a></p>-->
                                    </div>
                                            ...
                                            <ul class="fix accessories">
                                                ...
                                                <li style="padding-bottom: 0;">
                                                    <dl>
                                                        ...
                                                        ?>
                                                        <dt>
                                                            <a href="/sand-river-baby-cashmere"><img src="<?php echo STATICURL; ?>/ximg/sand_river.jpg" /></a>
                                                        </dt>
                                                    </dl>
                                                </li>
                                            </ul>
                            ...
                            <div class="mybag JS_show">
                                ...
                                <div class="mybag_box JS_showcon hide">
                                    ...
                                    <div class="mybag_con">
                                        ...
                                        <p class="cart_button_empty" style="display:none;"><a href="/cart/view" class="btn40_16_red">VIEW MY BAG</a></p>
                                        <!--<p class="ppexpress mt10"><a href="javascript:void(0)" style="background:none;margin-right: 40px;" onclick="location.href='/payment/ppec_set';" id="pp_express"><img src="<?php echo STATICURL; ?>/ximg/ppec.jpg" alt="Click here to pay via PayPal Express Checkout" style="vertical-align: middle;padding-left:20px;"></a></p>-->
                                    </div>
        ...
        <!-- main begin -->
        <img src="http://www.choies.com/images/activity/slogan-02.jpg" style="display:none;">
        <section id="main">
            <!-- crumbs -->
            <div class="layout">
            ...
            <div class="lp_slogan layout fix">
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/slogan-img.jpg" /></p> 
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/slogan-01.jpg" /></p>
                <div id="step2"></div>
                <div class="lp-main">
                    <h1><i>&nbsp;&nbsp;NOW PLZ Help Choies to Write a NEW ONE for 2015!!!</i></h1>
                    ...
                    {
                        ?>
                        <p><a href="#" class="JS_popwinbtn1 view_btn btn1">sign up</a> <span style="font-weight:bold;font-size:15px;">or</span> <a href="#" class="JS_popwinbtn1 view_btn btn2">sign in</a><span style="font-weight:bold;font-size:15px;"> to Sumbit Your Slogan.</span></p>
                        <?php
                    }
                    ?>
                    </div>
                    <form action="#" method="post" class="lp_vote_form form" id="giveawayForm">
                        <ul class="lp_vote_formcon">
                            <li class="fix">
                                <label><span>*</span> Name:</label>
                                <div class="right_box"><input type="text" name="name" value="" class="text" /></div>
                            </li>
                            <li class="fix">
                                <label><span>*</span> Slogan:</label>
                                <div class="right_box"><textarea name="comments1" id="comments1" onkeydown="commentChange();" style="color:#a3a3a3" onfocus="if(this.value=='Please write no more than 5 words.') {this.value='';}this.style.color='#000';" onblur="if(this.value=='') {this.value='Please write no more than 5 words.';this.style.color='#a3a3a3';}">Please write no more than 5 words.</textarea></div>
                    ...
                    <p class=" slogan-02"><img src="<?php echo STATICURL; ?>/ximg/activity/slogan-02.jpg" /></p>
                    <p class="center" style="color:#666666;font-size:15px;text-transform:uppercase;font-weight:bold;padding-top:15px;">&nbsp;&nbsp;&nbsp;&nbsp;SHARE THIS to Your SNS Friends to broaden your wisdom together! </p>
                    <div class="lp_vote_share">
                        <div>
                            <a target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo urlencode('http://www.choies.com/activity/new_year_slogan_wanted'); ?>" class="a1">facebook</a>
                            <a target="_blank" href="http://twitter.com/share?url=<?php echo urlencode('http://www.choies.com/activity/new_year_slogan_wanted'); ?>" class="a2">twitter</a>
                            <a target="_blank" href="http://choiescloth.tumblr.com/" class="a3">tumblr</a>
                        </div>
                        <div id="step5"></div>
                ...
                <p style="margin:0 auto;width:748px;margin-top:40px;"><img src="<?php echo STATICURL; ?>/ximg/activity/slogan-03.jpg" /></p>
        ...
        if ($type != 'payment' && $type != 'purchase' && $type != 'cart')
        {
            ...
            <footer>
                <div class="w_top">
                    ...
                    <div class="card">
                        <p>
                            <img src="<?php echo STATICURL; ?>/ximg/card-0509.jpg" usemap="#Card" />
