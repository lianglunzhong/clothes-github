...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="image_src" href="http://www.choies.com/images/activity/vote-fb.jpg"/>
        <meta property="og:title" content="Vote for Choies Annual Best Design" />
        <?php $c_url = URL::current(FALSE); ?>
        <meta property="og:url" content="http://www.choies.com<?php echo $c_url; ?>" />
        <meta property="og:description" content="SOS! Please help Choies vote out the 2014 Annual Best Design." />
        <meta property="og:image" content="http://www.choies.com/images/activity/vote-fb.jpg">
        <style>
            ...
            .lp_vote_formcon{ width:550px; margin:20px auto;}
            .lp_vote_formcon li{ margin-bottom:10px;}
            .lp_vote_formcon .right_box input{background-color:#fff;width:300px;height:30px;display:block;}
            .lp_vote_formcon li label{ display:inline-block; width:70px; margin-right:5px;float:left;font-size:14px;font-weight:bold;}
            .lp_vote_formcon li .btn{ width:150px; height:35px; line-height:35px; background-color:#dc1a2a; font-size:18px; border-radius:5px; margin-top:10px;margin-left:144px;}
            ...
            .lp_vote_history li .name{ margin-right:5px; width:80px; color:#5f9514;}
    ...
    <body>
        ...
        <!-- main begin -->
        <img src="http://www.choies.com/images/activity/vote-fb.jpg" style="display:none;">
        <section id="main">
            <!-- crumbs -->
            <div class="layout">
            ...
            <section class="layout fix">
                <div class="lp_slogan layout fix">
                    <p><img src="/images/activity/vote_result_01.jpg" /></p>
                    <p><img src="/images/activity/vote_result_02.jpg" /></p>
                    <div class="lp-main">
                        <!-- <div class="vote-tips">
                            <h1>tips for voting:</h1>
                            <p>
                            1.
                            <?php
                            ...
                            {
                                ?>
                                <span style="color:red;">YOU ARE ALREADY IN!</span>
                                <?php
                            }
                            else
                            {
                                ?>
                                <a href="#" class="view_btn btn1 JS_popwinbtn1">log in</a> or <a href="#" class="view_btn btn2 JS_popwinbtn1">register</a> to Enter the Vote.
                                <?php
                            }
                            ?>
                            </p>
                            <p>2.  Each voter can vote 3 of your favorite items below.  And please tick the<input type="checkbox"/> to mark them.</p>
                            <p>3.  Click the "Submit" Button to complete your vote.</p>
                        </div> -->
                        <form action="#" method="post" class="lp_vote_form form" id="voteForm">
                            <div class="votting">
                                <h1>Designs FOR VOTING:
                                <!-- <span style="font-size:18px;color:#ff0000;text-transform:none;">You can vote no more than 3 items altogether.</span> -->
                                </h1>
                                <div class="f16 tips design">
                                    <ul>
                                    <?php
                                    $count = 0;
                                    ...
                                    ?>
                                        <li <?php if($count % 4 == 0) echo 'class="last"'; ?>>
                                            <a href="<?php echo $product->permalink(); ?>" target="_blank"><img src="<?php echo Image::link($product->cover_image(), 1); ?>" width="225" height="300"/></a>
                                            <div>
                                                <span>
                                                    <input type="checkbox" onClick="doCheck(this)" name="design<?php echo $count; ?>" value="<?php echo $sku; ?>" id="<?php echo $product_id; ?>" class="mr5" />
                                                    <label for="<?php echo $product_id; ?>">SKU# <?php echo $sku; ?></label>
                                                </span>
                                                <span class="vote-number"><i class="fa fa-heart"></i><?php echo isset($votes[$sku]) && $votes[$sku] ? $votes[$sku] : 0; ?> votes</span>
                                            </div>
                                        </li>
                                    <?php
                                    }
                                ...
                                <!-- <div class="vote-form">
                                    <ul class="lp_vote_formcon">
                                        <li class="fix">
                                            <label><span>*</span> Name:</label><div class="right_box"><input type="text" name="name" value="" class="text" /></div>
                                        </li>
                                        <li class="fix">
                                            <label><span>*</span> Vote for:</label><div class="right_box"><input type="text" name="sku" id="sku" value="" class="text" readonly="true"/></div>
                                        </li>
                                        <li>
                                            <input type="submit" name="" value="submit" class="btn view_btn" />
                                        </li>
                                    </ul>
                                </div> -->
                            </form>
                            ...
                            <div class="lp_vote_share">
                                <div>
                                    <a href="http://www.facebook.com/sharer.php?u=http://www.choies.com<?php echo $c_url; ?>" target="_blank" class="a1">facebook</a>
                                    <a href="http://twitter.com/share?url=http://www.choies.com<?php echo $c_url; ?>" target="_blank" class="a2">twitter</a>
                                    <a href="http://thatisstylish.tumblr.com" target="_blank" class="a3">tumblr</a>
                                </div>
                        ...
                        <div class="lp_vote_bottom">
                            ...
                            ?>
                                <li>
                                    ...
                                    <p class="con">Voted For:  <?php echo $comment['sku']; ?></p>
                                </li>
                            <?php
                            }
                            ?>
        ...
        if ($type != 'payment' && $type != 'purchase' && $type != 'cart')
        {
            ...
            <footer>
                <div class="w_top">
                    <div class="top layout fix">
                        ...
                        <dl class="last">
                            ...
                            <dd class="sns fix">
                                ...
                                <a  href="http://thatisstylish.tumblr.com" target="_blank" class="sns3" title="tumblr"></a>
                    ...
                    <div class="card">
                        <p>
                            <img src="/images/card-0509.jpg" usemap="#Card" />
