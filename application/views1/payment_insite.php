                    ...
                    <div>
                        <div id="payment_wrap">
                            ...
                            <div class="payment_p">
                                ...
                                <p class="payment_message_p">We accept the following credit/debit cards.Don't leave until payment result returns.<br>(Note: For security purposes, we will not save any of your credit card data.)</p>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">          
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="payment_td_right">We Accept:</td>
                                                <td width="300">
                                                    <ul class="payment_ul">
...
<div id="popup_container" style="display:none;position: absolute; z-index: 99999; padding: 0px; overflow-y: hidden; margin: 0px; min-width: 310px; max-width: 310px; top: 240px; left: 300px;" class="ui-draggable">
    ...
    <div id="popup_content" class="alert">
        <div id="popup_message">The credit card number is incorrect</div>
        <div id="popup_panel">
