    ...
    <div class="w-signup container">
        ...
        <div class="row">
            <div class="left col-sm-6 col-xs-12">
                ...
                <form class="signin-form sign-form form" method="post" action="/customer/login/<?php if (!empty($_GET['redirect'])) echo '?redirect=' . htmlspecialchars($_GET['redirect']); ?>">
                    ...
                    <ul class="method">
                        ...
                        <li class="insurance JS-show">
							...
							<div style="display: none;top:50%;" class="ins-info JS-showcon hidden-xs hidden-sm hidden-md">
                                        <b class="arrow-up"></b>
                                        <div class="ins-tipscon" style="margin-top:1px;padding:2px 5px;">Tick to keep login for 14 days.</div>
                            </div>
                        </li>
                        <li>
                            <input class="btn btn-primary btn-lg mr10" type="submit" name="submit" value="Sign In">
                            <a class="text-underline" href="<?php echo LANGPATH; ?>/customer/forgot_password">Forgot password?</a>
                        </li>
                        <li>
                            <?php
                    ...
                    <ul class="method">
                        ...
                        <li class="insurance JS-show">
							...
							<div style="display: none;top:74%;" class="ins-info JS-showcon hidden-xs hidden-sm hidden-md">
                                        <b class="arrow-up"></b>
                                        <div class="ins-tipscon" kai="13" style="margin-top:1px;padding:2px 5px;">Tick to keep login for 14 days.</div>
                            </div>
                        </li>
                        <li>
                            <input class="btn btn-primary btn-lg mr10" type="submit" name="submit" value="Sign Up" onclick="return loading();">
                        </li>
                    </ul>
                </form>
            </div>
