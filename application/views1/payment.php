        ...
        <div class="icontainer">
            <div class="login">
                ...
                <div class="cart_paypal">
                    <h2>Your Order Number: <span><?php echo $ordernum; ?></span><img src="<?php echo STATICURLHTTPS; ?>/assets/images/loading.gif" /></h2>
                    <p>The payment page is loading to come up, it will take a few seconds or more.</p>
                    <p>Please don't leave, and if you have any further questions,</p>
                    <p class="bottom">Please contact: <a href="mailto:<?php echo Site::instance()->get('email'); ?>"><?php echo Site::instance()->get('email'); ?></a></p>
                </div>
                <div class="message">
