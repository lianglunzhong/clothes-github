...
<div class="site-content">
    <div class="main-container clearfix">
        <div class="container">
            ...
            {
                $image_src = Catalog::instance($catalog->get('id'))->get('image_src');
                if ($image_src)
                {
                    $image_map = $catalog->get('image_map');
                    if ($image_map)
            ...
            <div class="visible-xs <?php
                    $phonebannerarr = array('black-friday','cyber-monday','christmas-sale','boho-chic');
            ?>">
                <p class="mb25 img-active">
            ...
            ?>
                ...
                <div class="font18 mt20 ml20 hide" id="no_result">Désolé, aucun résultat ne correspond.</div>
                ...
                <div class="pro-list">
                    ...
                    for ($i = 0; $i < $_limit; $i++)
                    {
                        ...
                        <li class="pro-item col-xs-6 col-sm-3">
                            ...
                            <div class="title">
                                <a href="<?php echo $plink; ?>" title="<?php
                                 $cname = Product::instance($product_id, LANGUAGE)->transname();
                            
                                 echo isset($cname) ? $cname : $product_inf['name']; ?>">
                                <?php
                                ...
                                ?>
                                <?php echo isset($cname) ? $cname : $product_inf['name']; ?>
                                </a>
                            </div>
                            <p class="price">
                                <?php
                            ...
                            <?php if ($product_inf['type'] != 0): ?>
                                <a href="#" id="<?php echo $product_id; ?>" attr-lang="<?php echo LANGUAGE; ?>" class="btn-qv quick_view"  data-reveal-id="myModal">VUE RAPIDE</a>
                            <?php endif; ?>
                            <div class="add-wish">
    ...
    /*                        if ($secondhalf):
            ...
            {
                ?>
                <div class="font18 mt20">Désolé, aucun résultat ne correspond.</div>
                <?php
            }
        }
        ?>
