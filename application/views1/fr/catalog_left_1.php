...
/*    if ($catalog_id == 92 OR $parent_id == 92)
    {
        $childrens = array(
            ...
            array('Maxi Robes', LANGPATH . '/maxi-dresses-c-207'),
            array('Robes En Dentelle ', LANGPATH . '/lace-dresses-c-209'),
            array('Robes Moulantes', LANGPATH . '/bodycon-dresses-c-211'),
            array('Robes Épaules Dénudées', LANGPATH . '/off-the-shoulder-dresses-c-504'),
            array('Robes Noires', LANGPATH . '/black-dresses-c-203'),
            array('Robes Blanches', LANGPATH . '/white-dresses-c-204'),
            array('Robes En Sequins', LANGPATH . '/backless-dress-c-456'),
            array('Robes De Bal', LANGPATH . '/party-dresses-c-205'),
        );
    }
    else
    {*/
...
<div class="list-main">
    ...
    <aside class="filter-left hidden-xs">
        ...
        <div class="category-list">
            ...
            {
            ?>
                <p class="down "><span class="list-detail-title">Catégorie</span>
            ...
            <ul class="bar-l" id="bar">
                ...
                <p class="down no-line"><span class="list-detail-title">Taille</span>
                    <a class="fa fa-angle-up JS_down"></a>
                </p>
                <ul class="menu JS_menu hide double" id="size_ul" style="display: block;">
                </ul>
                <p class="down "><span class="list-detail-title">Couleur</a></span>
                    <a class="fa fa-angle-up JS_down"></a>
                </p>
                <ul class="menu JS_menu hide double" id="color_ul" style="display: block;">
                </ul>
                <p class="down "><span class="list-detail-title">Prix</span>
                    <a class="fa fa-angle-up JS_down"></a>
                </p>
            ...
            <ul class="bar-r">
                <li class=" item-r pick">
                    ...
                    if (!empty($gets1))
                    {
                        ...
                        $gets1[] = 'pick=1';
                    ?>
                    <a href="<?php echo '?' . implode('&', $gets1); ?>" class=""> Choix de l'idole</a>
                </li>
    ...
    <div class="category-sidebar-container">
        <div class="sidebar-nav ">
            <h5 class="sort-nav-toggle JS-toggle">
                <span><b class="visible-phone">Trier &</b>AFFINER<i class="fa fa-caret-down"></i></span>
            </h5>
            ...
            <div class="sort-nav-section JS-toggle-box hide" id="phone_filter" style="overflow: hidden; display: none;">
                ...
                <div class="accordion-group visible-phone">
                    ...
                    <a class="accordion-toggle " href="javascript:void(0);">Catégorie<i class="fa fa-caret-down flr"></i></a>
                    </div>
                ...
                ?>
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle " href="javascript:void(0);">TAILLE<i class="fa fa-caret-down flr"></i></a>
                        </div>
                        <div class="accordion-body JS-toggle-box hide">
                            <div class="accordion-inner">
                    ...
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle " href="javascript:void(0);">PRIX<i class="fa fa-caret-down flr"></i></a>
                        </div>
                        <div class="accordion-body JS-toggle-box hide">
                            <div class="accordion-inner">
                    ...
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle " href="javascript:void(0);">COULEUR<i class="fa fa-caret-down flr"></i></a>
                        </div>
                        <div class="accordion-body JS-toggle-box hide">
                            <div class="accordion-inner">
...
?>
<div id="bar1" class="hide">Effacer tout</div>
