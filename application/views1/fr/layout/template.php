                                            ...
                                            <div class="nav-box">
                                                <div class="nav-list01 fll">
                                                    <dl class="nav-ul">
                                                        ...
                                                        <dl class="col-xs-6">
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/92">Robes</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/621">Tops</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/953">Manteaux</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/961">Pulls & Tricots</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/53">Chaussures</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/52">Accessories</a></dd>
                                                        </dl>
                                                    </dl>
                                                </div>
                                                    <?php
