                                ...
                                ?>
                                    <div class="pic">
                                        <a href="<?php echo Product::instance($product_id, LANGUAGE)->permalink(); ?>">
                                            ...
                                            {
                                                ?>
                                                <div class="pic2" style="display:none;"><img data-original="http://img1.choies.com/pimg/192/<?php echo $images[1]['id'].'.'.$images[1]['suffix']; ?>" src="/assets/images/loading.gif" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                                <?php
                                            }
                                            ?>
                                        </a>
