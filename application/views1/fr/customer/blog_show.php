...
$c_admin = DB::select('admin')->from('celebrits')->where('id', '=', $cele_id)->execute()->get('admin');
...
?>
            ...
            <div class="container">
                <div class="crumbs">
                    <div>
                        ...
                        <a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > Mon Compte</a> >MON BLOG SHOW
                    </div>
        ...
        <?php echo View::factory(LANGPATH.'/customer/left'); ?>
            <?php echo View::factory(LANGPATH.'/customer/left_1'); ?>
                    ...
                    <li <?php if (!$onshowed) echo 'class="on"'; ?>>POUR MONTRER</li>
                    <li <?php if ($onshowed) echo 'class="on"'; ?>>MONTRÉ</li>
                        </ul>
                        <div class="JS_tabcon1 detail-tabcon hidden-xs">
                            <div <?php echo $onshowed ? 'style="display:none;"' : 'style="display:block;"'; ?>>
                                <p>Comment remplir un show?</p>
                                <p>
                                    <span>1. Copiez le lien de l'article et collez-le dans dans votre blog.</span>
                                    <span>2. Rédigez votre show url dans la colonne de droite et cliquez sur « Soumettre ».</span>
                                </p>
                                <div class=" table-responsive">
                                    <table class="user-table">
                                        <tbody>
                                            <tr>
                                                <th width="20%">N°de Show</th>
                                                <th width="40%">Info Produits</th>
                                                <th width="40%">Lien de Show</th>
                                            </tr>
                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="pr-info fix">
                                                        ...
                                                        <div class="right">
                                                        <p>Article# : <?php echo $data['sku']; ?></p>
                                                        <p><?php echo Product::instance($product_id, LANGUAGE)->get('name'); ?></p>
                                                        <p>
                                                            N°de Commande: 
                                                            <a><?php echo $data['ordernum']; ?></a>
                                                        </p>
                                                        <input class="copy-link btn btn-primary btn-xs" type="button" value="Copier le lien d’article" name="<?php echo Product::instance($product_id, LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>">
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <input type="hidden" name="sku" value="<?php echo $data['sku']; ?>" />
                                                            ...
                                                            <a class="addMoreLink a-red">ajoutez un nouveau lien</a>
                                                            <input class="link-btn btn btn-primary btn-xs" type="submit" value="SOUMETTRE">
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <?php
            $pagination = str_replace(array('PAGE', 'NEXT', 'PRE', 'Records Found'), array('SEITE', 'Suivant', 'Précédent', 'Rekord Gefunden'), $pagination1);
                        echo $pagination;
                        ?>
                                </div>
                           ...
                           <span>1. Copiez le lien de l'article et collez-le dans dans votre blog.</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="pr-info fix">
                                                        ...
                                                        <input class="copy-link btn btn-primary btn-xs" type="button"  name="<?php echo Product::instance($product_id, LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Copy Item Link" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="show-link">
                                                        <div class="showurl">
                                                <?php
                                                $urls = DB::select('id', 'url')->from('celebrity_products')->where('ordernum', '=', $data['ordernum'])->and_where('sku', '=', $data['sku'])->execute()->as_array();
                                                foreach ($urls as $url):
                                                    ?>
                                                ...
                                                ?>
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <a class="addMoreLink a-red">ajoutez un nouveau lien</a>
                                                                    <br>
                                                                    <input type="submit" value="SOUMETTRE" class="btn btn-primary btn-xs">
                                                                    <a style="text-decoration:underline;margin-left:10px;" class="link-cancel" href="#">Annuler</a>
                                                                    <br>
                                                                    <br>
                                                                </form>
                                                            </div>
                                                            <input type="button" value="RÉDIGER" class="btn btn-default btn-xs link-edit" name="">
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php
                            ...
                            <?php
                        $pagination = str_replace(array('PAGE', 'NEXT', 'PRE', 'Records Found'), array('SEITE', 'Suivant', 'Précédent', 'Rekord Gefunden'), $pagination2);
                        echo $pagination; 
                        ?>
                 ...
                 <span>1. Copiez le lien de l'article et collez-le dans dans votre blog.</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="pr-info fix">
                                                        ...
                                                        <input class="copy-link btn btn-primary btn-xs" type="button" value="Copier le lien d’article" name="<?php echo Product::instance($product_id, LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Copy Item Link">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                        ...
                        <?php
             $pagination = str_replace(array('PAGE', 'NEXT', 'PRE', 'Records Found'), array('SEITE', 'Suivant', 'Précédent', 'Rekord Gefunden'), $pagination);
                        echo $pagination; 
                        ?>                      
