                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-7">
                                    <div class="con cle">
                                        ...
                                        <p class="pc-btn"><a href="<?php echo $link; ?>" id="<?php echo $c_images['product_id']; ?>" attr-lang="<?php echo LANGUAGE; ?>" class="btn btn-default btn-lg mt20">ACHETER MAINTENANT</a></p>
                                        <p class="phone-btn"><a href="<?php echo $link; ?>" class="btn btn-default btn-lg ">ACHETER MAINTENANT</a></p>
                            <?php
                            if ($c_images['type'] != 1 && $c_images['link_sku'] && strlen($c_images['link_sku']) > 0)
                            {
                                ?>
                                <p class="pc-btn"><a class="btn btn-default btn-lg mt20 JS-popwinbtn1">OBTENIR LE LOOK</a></p>
                                <?php
                            }
                            ?>
...
if (!empty($skus))
{
    ...
    <div class="JS-popwincon1 popwincon hide">
        ...
        <div class="look-pro">
            ...
            ?>
                            <p><a href="<?php echo $sku_link; ?>" class="btn btn-default btn-xs" target="_blank">VOIR LES DÉTAILS</a>
                            </p>
            <?php
            if (!$instock)
                echo '<span class="red outstock">EN RUPTURE DE</span>';
            ?>
                        </li>
                <?php
                    }
                ...
                <div class="add-bag">
                    <input value="Ajouter au Panier" class="btn btn-primary btn-lg" type="submit"><a href="<?php echo LANGPATH; ?>/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a-underline add-wishlist">LISTE DE SOUHAITS</a>
                </div>
