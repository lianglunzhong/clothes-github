<div class="site-content">
    <div class="main-container clearfix">
        <div class="container">
            <div class="crumbs">
                <div class="fll">
                    <a href="<?php echo LANGPATH; ?>/" class="home">ACCUEIL</a>&gt; <span><?php echo $brands['name']; ?>
                </div>
            </div>
            <!-- aside -->
            <div class="list-main">
                ...
                <div class="filter-bar">
                    ...
                    if (!empty($gets1))
                    {
                        ...
                        $gets1[] = 'pick=1';
                    ?>
                    <a href="<?php echo isset($_SERVER['REDIRECT_URL']) ? $_SERVER['REDIRECT_URL'] : '' . '?' . implode('&', $gets1); ?>" class=""> <i class="myaccount"></i> Icon's Pick</a>
                </li>
                ...
                foreach($products as $i => $product)
                {
                    ...
                    <li class="pro-item col-xs-6 col-sm-3">
                        ...
                        <?php if ($product_inf['type'] != 0): ?>
                            <a href="#" id="<?php echo $product_id; ?>" class="JS-popwinbtn quick_view" data-reveal-id="myModal"><span class="btn-qv">VUE RAPIDE</span></a>
                        <?php endif; ?>
                        <div class="add-wish">
                        <a class="add_to_wishlist" data-product="<?php echo $product_id; ?>">
                            <span class="wish-title">Ajouter à la liste d'envies</span>
                        ...
                        <div class="sign-warp">
                            ...
                            <div class="wishlist_success">
                                ...
                                <p class="wish"><i class="fa fa-heart"></i>Ajouter à la liste d'envies</p>
                            </div>
                        </div>
                        <?php
                        if ($secondhalf && $secondhalf !=1):
        ...
        {
            ?>
            <div class="font18 mt20">PRODUITS RECOMMANDÉS</div>
