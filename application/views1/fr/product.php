                    ...
                    <div id="gallery">
                        <div id="JS_productPic" class="productpic loadding">
                           ...
                           else
                           {
                            ...
                            {
                                ?>
                                <div class="myImages-icon"><img src="<?php echo STATICURL; ?>/assets/images/ship-in24-2.png" /></div>
                                <?php
                            }
                            ?>
                ...
                <div class="pro-right" style="margin-left:0px;">
                            ...
                            <div class="row">
                                <dl class="col-xs-12 col-md-9">
                                    <div class="pro-stock">
                                        Article# : <span id="product_sku"><?php echo $product->get('sku'); ?></span>
                                        <?php
                                        if(!empty($brands))
                                        {
                                            ?>
                                            <a target="_blank" href="<?php echo LANGPATH; ?>/brand/list/<?php echo $brands['id']; ?>">par <?php echo $brands['name']; ?></a>
                                            <?php
                                        }
                                        else
                                        {
                                            ?>
                                            <a target="_blank" href="<?php echo LANGPATH; ?>/brand/list/220">par Zonewetwo</a>
                                        <?php
                                        }
                                        ?>
                                    </div>
                                    ...
                                    if ($vip_level)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                ?>
                                                    <del><?php echo $currency_change; ?><!--<span class="orign_price">--><?php echo Site::instance()->price($p_price, 'code_view'); ?><!--</span>--></del>   
                                                    <!--<span class="price_now">NOW  <?php //echo $currency_change; ?>--><span class="product_price"><?php echo Site::instance()->price($price, 'code_view'); ?></span>
                                                <?php
                                                }
                                                else
                                                {
                        ...
                        <dd>
                            <div id="action_form" class="JS-popwincon">
                                <p class="product-note-title" style="display:none;">veuillez sélectionner la taille
                                ...
                                <form action="<?php echo LANGPATH; ?>/cart/add" method="post" id="formAdd" class="product-pl">
                                    ...
                                    if (!empty($attributes['size']))
                                    {
                                        ?>
                                            ...
                                            <?php
                                                ...
                                                {
                                                ?>
                                                <span class="size-charts JS-popwinbtn2 ml10 hidden-xs"><a data-reveal-id="myModal3">Guide des tailles</a></span>
                                                <?php
                                                }
                                                ?>
                                                         </div>
                                    ...
                                    <div class="total" style=" margin-top:15px;">
                                        ...
                                        if($instock)
                                        {
                                            ...
                                            {
                                        ?>
                                            <input class="btn btn-primary btn-lg" id="addCart" value="Ajouter au panier" type="submit" style="text-transform: none;">
                                        <?php
                                            }
                                        }
                                        else
                                        {
                                            ?>
                                            <button class="btn btn-primary btn-lg" disabled="disabled">En rupture de Stock</button>
                                            <?php
                                        }
                                        ?>    
                                            ...
                                            <span class="fa fa-heart" style="display:none;"></span>Liste d’envies
                                            <?php
                                            if($wishlists)
                                            {
                                            ?>
                            ...
                            <div>
                                ...
                                $sortArr_small = Kohana::config('sorts.' . LANGUAGE);
                                    if (!empty($filter_sorts))
                                    {
                                        ...
                                        if(in_array($en_name, $sortArr_en))
                                        {
                                            ...
                                            echo '<tr><td width="25%" style="font-weight:bold;"><p>' . strtoupper($small_name) . ':</p></td><td width="75%"><p>' . ucfirst($small_filter[strtolower($sort)]) . '</p></td></tr>';
                                        }
                                        echo '</table>';
                                        echo '<br>';
                                    }
                                ...
                                {
                                ?> 
                                    <a class="fix" style="cursor:pointer;margin-top:3px;text-decoration: underline;font-weight: bold;" data-reveal-id="myModal3">Guide des tailles</a>
                                <?php
                                }
                                ?>
                                </div>
                ...
                <div class="phone-product-info col-sm-12">
                    <div class="accordion-group visible-phone">
                        ...
                        <div class="accordion-group visible-phone">
                            ...
                            <div class="accordion-heading JS-toggle">
                                <a class="accordion-toggle " href="javascript:void(0);">LIVRAISON
                                    <i class="fa flr fa-caret-down"></i>
                                </a>
                            </div>
                            <div class="accordion-body JS-toggle-box hide">
                                <div class="accordion-inner">
                                    <ul class="unstyled">
                                        <div class="bd">
                                            ...
                                            <h4>Politique de retour:</h4>
                                           <p>Pas satisfait de votre commande, vous pouvez nous contacter et de le retourner dans 60 jours.</p>
                                            <p>Pour <span class="red">Maillots de bain</span>, et Sous-vêtements, si il n'y a aucun problème de qualité, nous n'offrent pas le service de retour et d'échange, veuillez nous comprendre
                                                <a target="_blank" class="red" href=""title="return policy">la politique de retour</a>
                                            </p>
                                            <h4>Attention:</h4>
                                       <p>Les commandes peuvent être soumises à des droits d'importation, si vous voulez éviter d'être facturé pour l'impôt supplémentaire par la douane locale, veuillez nous contacter, nous allons utiliser Hong Kong Post.</p>
                                        </div>  
            ...
            <div class="four-partake phone-size hidden-sm hidden-md hidden-lg">
                ...
                <div class="index-fashion buyers-show">
                    <div class="phone-fashion-top w-tit">
                        <h2>D'autres Clients Ont Également Consulté</h2>
                    </div>
                ...
                if (isset($videos) AND !empty($videos))
                {
                    ...
                    <div class="other-customers">
                        ...
                        <div class="product-carousel">
                            ...
                            if($count > 8)
                            {
                                ...
                                <div class="clearfix"></div>
                                <div class="bt-view"><p>Voir Plus+</p></div>
                            <?php
                            }
                            ?>
                            </div>  
                            ...
                            foreach ($link_images as $key => $link_img)
                            {
                                ...
                                <ul <?php if($key > 0) echo 'class="more-view mt10 hide"'; ?>>
                                    ...
                                    <li style="width:65%;">
                                        ...
                                        <a class="btn btn-primary btn-sm flr" data-reveal-id="myModal5<?php echo $key; ?>" title="<?php echo $key; ?>" >STYLES ET CONSEILS</a>
                                    </li>
                    <?php
                            ...
                            if (!empty($skus))
                            {
                                ...
                                <form action="<?php echo LANGPATH;?>/cart/add_more" method="post" class="form3" id="form<?php echo $key; ?>">
                                    ...
                                    <div class="clearfix items<?php echo $key; ?>">
                                        ...
                                        foreach ($skus as $sku)
                                        {
                                            ...
                                            <li>
                                                ...
                                                <?php
                                                if (!$instock)
                                                    echo '<span class="outstock red">En rupture de Stock</span>';
                                                ?>
                                            </li>
                                        <?php
                                        }
                                    ...
                                    <div class="add-bag" style="margin-bottom:40px;">
                                        <input value="Ajouter au panier" class="btn btn-primary btn-lg" type="submit"><a href="<?php echo LANGPATH; ?>/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a-underline add-wishlist">Ajouter à la liste d'envies</a>
                                    </div>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            {
                                ?>
                                <div class="bt-view a-underline mt10"><p>Voir Plus+</p></div>
                                <?php
                            }
                            ?>
                            </div>  
            ...
            <div class="four-lay">
                <div class="box-title">
                    <ul>
                        ...
                        <li class="" id="recent_li">CONSULTÉ RÉCEMMENT </li>
                        <p style="left:120px;">
                            <b></b>
                        </p>
                    </ul>                           
...
<div id="myModal3" class="reveal-modal xlarge">
    ...
    <ul class="JS-tab-size size-tab two-bor">
        <?php if ($set_id != 2): ?>
            <li class="dt-s2 current">VETEMENTS</li>
            <li class="dt-s2 pc-size" style="width:250px;">Table de Conversion</li>
        <?php endif; ?>
        <?php if ($set_id == 2): ?>
            <li class="dt-s2 current">CHAUSSURES</li>
<!--         <?php // else: ?>
    <li class="dt-s2 two-bor">CHAUSSURES</li> -->
        <?php endif; ?>
        <?php if (Product::instance($product_id)->get('set_id') != 2 AND !empty($celebrity_lists)): ?>
            <li class="dt-s2 pc-size">Rapport D'essai</li>
        <?php endif; ?>
        ...
        if ($set_id != 2)
        {
            ...
            <div class="bd">
                ...
                <table class="user-table">
                    <tr>
                        <th width="10%" rowspan="2">Taille</th>
                        <?php
                        if (!empty($us_sizes))
                        {
                            ?>
     ...
     <p>Veuillez utiliser ces tableaux des tailles pour aider à déterminer votre tailles. Comme les tailles sur notre site sont mesurées manuellement, il peut exister quelques nuances. Si vous avez une condition de dimensionnement spécifique ou vous souhaitez en savoir plus d'information, veuillez communiquer avec notre Service à la clientèle: <a href="mailto:service_<?php echo LANGUAGE; ?>@choies.com">service_<?php echo LANGUAGE; ?>@choies.com</a>. </p>
        ...
        <div class="bd size-mesurements hide">
            ...
            <div class="clearfix">
                ...
                <p>
                    <strong>a) Tour de Poitrine</strong>
                    <br> *Cen’est pas votre taille de soutien-gorge!
                    <br> *Porter un soutien-gorge sans rembourrage (votre robe aura un soutien-gorge intégré)
                    <br> *Relaxer les bras sur les côtés
                    <br> *Tirer ruban dans la plus grande partie de la poitrine 
                </p>
                <p>
                    <strong>b) Tour de Taille </strong>
                    <br> *Trouvez la taille naturelle
                    <br> *Ceci est la plus petite partie de la taille 
                    <br> *Habituellement, environ pouces au- dessus de nombril
                    <br> *Gardez ruban un peu lâche pour permettre de respirer
                </p>
                <p>
                    <strong>c) Tour de Hanche</strong>
                    <br> *Trouvez la partie la plus large des hanches
                    <br> *Habituellement, environ 8 pouces au- dessous de la taille naturelle
                    <br> *Le ruban doit pinceau sur les deux hanches
                </p>
                    </div>
            </div>
            <h3>CHAUSSURES</h3>
            <div class="clearfix">
                ...
                <div class="right flr" style="padding-left:25px;">
                    <h4>LONGUEUR DU PIED</h4>
                    <p>Mesurez le pied en plaçant une règle plate le long de la partie intérieure du pied entre le talon et les orteils.</p>
                    <h4>HAUTEUR DES CHAUSSURES</h4>
                    <p>Mesurer l'arrière de la chaussure à partir du dessus de la chaussure passepoilées à la partie inférieure des talons reposant sur la surface plane.</p>
                    <h4>HAUTEUR DU TALON</h4>
                    <p>Mesurer l'arrière des talons du point où il se connecte à la chaussure, appelé couture, à la partie inférieure des talons reposant sur la surface plane.</p>
                    <h4>HAUTEUR DU TUBE </h4>
                    <p>=HAUTEUR DES CHAUSSURES - HAUTEUR DU TALON</p>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
window._fbq.push(["track", "ViewContent", { content_type: 'product', content_ids: ['<?php echo $product_id; ?>'], product_catalog_id: '516630661844855' }]);
</script>
