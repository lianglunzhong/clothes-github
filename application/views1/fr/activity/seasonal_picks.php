    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="banner" id="banner">
                <div class="ibanner">
                    <ul class="bannerPic">
                        <li><a href="#" title=""><img src="<?php echo STATICURL; ?>/ximg/<?php echo  LANGUAGE; ?>/activity_croptops_banner1.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="<?php echo STATICURL; ?>/ximg/<?php echo  LANGUAGE; ?>/activity_croptops_banner2.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="<?php echo STATICURL; ?>/ximg/<?php echo  LANGUAGE; ?>/activity_croptops_banner3.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="<?php echo STATICURL; ?>/ximg/<?php echo  LANGUAGE; ?>/activity_croptops_banner4.jpg" alt="" /></a></li>
                    </ul>
                    <div class="banner_lr">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit1 fix mb25">
                    <h4 id="d1"><img src="<?php echo STATICURL; ?>/ximg/activity/croptop_tit1.png" />TOPS COURTS</h4>
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit2 fix mb25">
                    <h4 id="d2"><img src="<?php echo STATICURL; ?>/ximg/activity/croptop_tit2.png" />JUPES</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VOIR PLUS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
