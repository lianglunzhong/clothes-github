...
<div class="site-content">
    <div class="main-container clearfix">
        <div class="container">
            <div class="crumbs">
                <div class="fll">
                    <a href="/" class="home"><?php echo isset($repla['crumbs_first']) ? $repla['crumbs_first'] : 'home' ?></a>
                    <?php
            ...
            <div class="product-view">
                ...
                <div class="pro-right" style="margin-left:0px;">
                            <h3><?php echo isset($repla['crumbs_fourth']) ? $repla['crumbs_fourth'] : $product_name; ?></h3>
                            <?php
                            $instock = 1;
                            $stock = $product->get('stock');
                            if (!$product->get('status') OR ($stock == 0 AND $stock != -99))
                            ...
                            <div class="row">
                                <dl class="col-xs-12 col-md-9">
                                    <div class="pro-stock">
                                        SKU : <span id="product_sku"><?php echo $product->get('sku'); ?></span>
                                        <?php
                                        if(!empty($brands))
                                        {
                                            ?>
                                            <a target="_blank" href="/brand/list/<?php echo $brands['id']; ?>">by <?php echo $brands['name']; ?></a>
                                            <?php
                                        }
                                        else
                                        {
                            ...
                            <div class="price-box">
                                <p class="price">
                                    ...
                                    else
                                    {
                                        ...
                                        ?>
                                            <?php echo isset($repla['crumbs_fifth']) ? $repla['crumbs_fifth'] : 'Price'; ?> : <span style="font-size:24px;"><?php echo $currency_change; ?><span class="product_price"><?php echo Site::instance()->price($price, 'code_view'); ?></span></span>
                                            <?php
                                        }
                                    }
                                    ?>                                
                        ...
                        <dd>
                            <div id="action_form" class="JS-popwincon">
                                ...
                                <form action="/cart/add" method="post" id="formAdd">
                                        ...
                                        ?>
                                                <div class="btn-size" style=" margin-top:20px;">
                                                    <div class="selected-box">
                                                        <p class="fll"> 
                                                            <span class="mt10">
                                                    <?php echo isset($repla['crumbs_sixth']) ? $repla['crumbs_sixth'] : 'Size'; ?>
                                                         :</span>
                                                        </p>
                                                            <div class="drop-down select-down" id="select_size">
                                                            <div class="drop-down-hd JS-show1">
                                                                <span id="size-val">
                                                        <?php echo isset($repla['crumbs_eighth']) ? $repla['crumbs_eighth'] : 'SELECT SIZE'; ?></span>
                                                    ...
                                                    {              
                                                        ...
                                                        foreach ($attributes['size'] as $attribute)
                                                        {
                                                            ...
                                                            if(array_key_exists($attribute, $stocks))
                                                            {
                                                                ...
                                                                <a href="javascript:void(0);"><?php echo $attribute; ?></a></li>
                                                                <?php
                                                                }
                                                                else
                                                                {
                                                                    ?>
                                                                    <li title="<?php echo $stocks[$attribute]; ?>" id="<?php echo $attribute; ?>" class="drop-down-option <?php echo $js_show; ?>" data-attr="<?php echo $attribute; ?>"><a href="javascript:void(0);"><?php echo $attribute; ?></a>
                                                                    <?php
                                                                }
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <li title="0" id="<?php echo $attribute; ?>"  class="drop-down-option hide <?php echo $js_show; ?>" data-attr="<?php echo $attribute; ?>"><a href="javascript:void(0);"><?php echo $attribute; ?></a>
                                                            <?php
                                                            }
                                                            ?>
                                                            <?php
                                                ...
                                                {
                                                ?>
                                                <span class="size-charts JS-popwinbtn2 ml10 hidden-xs"><a data-reveal-id="myModal3"><?php echo isset($repla['crumbs_seventh']) ? $repla['crumbs_seventh'] : 'Size Guide'; ?></a></span>
                                                <?php
                                                }
                                                ?>
                                                </div>
                                                    <div class="qty-box">
                                                        ...
                                                        <?php echo isset($repla['crumbs_ninth']) ? $repla['crumbs_ninth'] : 'Qty'; ?>:</span>
                                    ...
                                    <div class="total" style=" margin-top:15px;">
                                        ...
                                        {
                                        ?>
                                            <input type="hidden" id="aget" value='<?php echo "http://www.choies.com/".LANGPATH . "customer/login?redirect=/product/".$product->get('link')."_p".$product_id; ?>' />
                                            <?php
                                            $giftarr = Site::giftsku();
                                            if(!in_array($product_id,$giftarr))
                                            {
                                            ?>
                                                <input class="btn btn-primary btn-lg" id="addCart" value="<?php echo isset($repla['crumbs_tenth']) ? $repla['crumbs_tenth'] : 'ADD TO BAG'; ?>" type="submit">
                                            <?php
                                            }
                                            ?>
                                        <?php
                                        ...
                                        {
                                            ?>
                                            <button class="btn btn-primary btn-lg" disabled="disabled">OUT OF STOCK</button>
                                            <?php
                                        }
                                        ?>    
                                        ...
                                        <?php echo isset($repla['crumbs_eleventh']) ? $repla['crumbs_eleventh'] : 'Wishlist';     
                                                    if($wishlists){
                                                    ?>
                                                    <span id="wishlists">
                                                        <?php 
                            ...
                            <div class="col-md-3 hidden-xs">
                                <a href="#" style="cursor: default;"><img src="<?php echo STATICURL; ?>/assets/images/1611/free_standard_shipping.jpg"></a>
                            </div>
                            </div>
                        <div>
                            <ul class="JS-tab detail-tab two-bor" style="margin-top:30px;">
                                <li class="dt-s1 current">
                            <?php echo isset($repla['details_first']) ? $repla['details_first'] : 'DETAILS';?> </li>
                                <?php
                                $models = '';
                                ...
                                {
                                    ?>
                                    <li class="dt-s1">MODEL INFO</li>
                                    <?php
                                }
                                ?>
                                <li class="dt-s1"><?php echo isset($repla['details_sixth']) ? $repla['details_sixth'] : 'DELIVERY';?></li>
                            ...
                            <div class="JS-tabcon detail-tabcon">
                                ...
                                {
                                ?> 
                                    <a class="fix" style="cursor:pointer;margin-top:3px;text-decoration: underline;font-weight: bold;" data-reveal-id="myModal3"><?php echo isset($repla['crumbs_seventh']) ? $repla['crumbs_seventh'] : 'Size Guide'; ?></a>                             
                                <?php
                                }
                                ?>
                                </div>
                                ...
                                ?>
                                <div class="bd hide">
                                    <p style="color:#F00;"><?php echo isset($repla['shipone']) ? $repla['shipone'] : 'Receiving time = Processing time（3-5 working days）+ Shipping time'; ?></p>

                                    <h4><?php echo isset($repla['shiptwo']) ? $repla['shiptwo'] : 'Shipping'; ?>:</h4>
                                    <p>(1)<?php echo isset($repla['shipthree']) ? $repla['shipthree'] : 'Free shipping worldwide (10-15 working days)';?></p>
                                    <p style="color:#F00; padding-left:18px;"><?php echo isset($repla['shipfor']) ? $repla['shipfor'] : 'For any orders of $15 or more';?>.</p>
                                    <p>(2) <?php echo isset($repla['shipfive']) ? $repla['shipfive'] : '$ 15 Express Shipping(4-7 working days)';?></p>

                                    <p style="padding-left:18px;"><?php echo isset($repla['shipsix']) ? $repla['shipsix'] : 'Check details in';?> <a target="_blank" class="red" href="/shipping-delivery" title="Shipping &amp; Delivery"><?php echo isset($repla['shipseven']) ? $repla['shipseven'] : 'Shipping &amp; Delivery';?></a>.</p>

                                    <h4><?php echo isset($repla['shipeight']) ? $repla['shipeight'] : 'Return Policy';?>:</h4>

                                    <p><?php echo isset($repla['shipnine']) ? $repla['shipnine'] : 'Not satisfied with your order, you can contact us and return it in 60 days';?>. </p>

                                    <p><?php echo isset($repla['shiptenone']) ? $repla['shiptenone'] : 'For';?> 
                                        <span class="red"><?php echo isset($repla['shiptentwo']) ? $repla['shiptentwo'] : 'Swimwear and Underwear';?></span>, <?php echo isset($repla['shipele']) ? $repla['shipele'] : 'if there is no quality problem, we do not offer return &amp; exchange service, please understand. Check details in';?> 
                                        <a target="_blank" class="red" href="/returns-exchange" title="return policy"><?php echo isset($repla['shipeleone']) ? $repla['shipeleone'] : 'return policy';?></a>
                                    </p>
                                    <h4><?php echo isset($repla['shipeletwo']) ? $repla['shipeletwo'] : 'Extra Attention';?>:</h4>
                                    <p><?php echo isset($repla['shipelethree']) ? $repla['shipelethree'] : 'Orders may be subject to import duties, if you want to avoid being charged for extra tax by your local custom, please contact us, we will use HongKong Post';?>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="phone-product-info col-sm-12">
                    <div class="accordion-group visible-phone">
                        ...
                        <div class="accordion-group visible-phone">
                            ...
                            <div class="accordion-heading JS-toggle">
                                <a class="accordion-toggle " href="javascript:void(0);">DELIVERY
                                    <i class="fa flr fa-caret-down"></i>
                                </a>
                            </div>
                            <div class="accordion-body JS-toggle-box hide">
                        ...
                        <div class="accordion-group visible-phone">
                            <div class="accordion-heading JS-toggle">
                                <a class="accordion-toggle " href="javascript:void(0);">CONTACT
                                    <i class="fa flr fa-caret-down"></i>
                                </a>
                            </div>
                            <div class="accordion-body JS-toggle-box hide">
                ...
                $(function(){
                    $.ajax({
                        ...
                        success: function(relate_products){
                            var lan = '<?php echo strtolower($repla['lang']);?>';
                            var langs = '';
                            if(lan)
                            {
                                langs = '?lang='+lan;
                            ...
                            else
                            {
                                for(var o in relate_products)
                                {
                                    ...
                                    for(var p in relate_products[o])
                                    {
                                        ...
                                        relate_html += '<a href="' + relate_product['link'] + langs + '">\
            ...
            if(!$is_mobile)
            {
                ...
                ?>
                    <div class="other-customers">
                        <div class="w-tit">
                            <h2>
                    <?php echo isset($repla['footer_ninth']) ? $repla['footer_ninth'] : "Buyers' Show";?> </h2>
                        </div>
                        <div class="product-carousel">
                                ...
                                for($i = 0;$i < $cel_num;$i ++)
                                {
                                    ...
                                    ?>
                                    <li>
                                        <a target="_blank" href="/lookbook/<?php echo $c_image['id']; ?>-1" <?php if($i % 8 == 0){ echo 'style="display:block;"';}elseif($i % 4 == 3){ echo 'style="margin:0;"'; } ?>>
                            ...
                            if($count > 8)
                            {
                                ...
                                for($j = 8;$j < $count;$j ++)
                                {
                                    ...
                                    ?>
                                    <li>
                                        <a target="_blank" href="/lookbook/<?php echo $c_image['id']; ?>-1" <?php if($j % 8 == 0){ echo 'style="display:block;"';}elseif($j % 4 == 3){ echo 'style="margin:0;"'; } ?>>
                                            <img src="<?php echo STATICURL; ?>/simg/<?php echo $c_image['image']; ?>">
                                        </a>
                                    </li>
                                <?php
                                ...
                                <div class="clearfix"></div>
                                <div class="bt-view"><p>View More+</p></div>
                            <?php
                            }
                            ?>
                        </div>                         
                            ...
                            if (!empty($skus))
                            {
                                ...
                                <form action="/cart/add_more" method="post" class="form3" id="form<?php echo $key; ?>">
                                    ...
                                    <div class="clearfix items<?php echo $key; ?>">
                                        ...
                                        foreach ($skus as $sku)
                                        {
                                            ...
                                            <li>
                                                ...
                                                <?php
                                                if (!$instock)
                                                    echo '<span class="outstock red">out of stock</span>';
                                                ?>
                                            </li>
                                        <?php
                                        }
                                    ...
                                    <div class="add-bag" style="margin-bottom:40px;">
                                        <input value="ADD TO BAG" class="btn btn-primary btn-lg" type="submit"><a href="/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a-underline add-wishlist">Add to wishlist</a>
                                    </div>
                ...
                <div class="other-customers hidden-xs" id="alsoview" style="display:none;">
                    <div class="w-tit">
                        <h2>
                    <?php echo isset($repla['footer_first']) ? $repla['footer_first'] : 'You May Also Like'; ?></h2>
                    </div>
                    <div class="box-dibu1">
        ...
        <div id="personal-recs">
            ...
            <div class="four-lay">
                <div class="box-title">
                    ...
                    <?php echo isset($repla['footer_second']) ? $repla['footer_second'] : 'FLASH SALE'; ?>  </li>
                        <li class="">
                    <?php echo isset($repla['footer_third']) ? $repla['footer_third'] : 'new in'; ?></li>
                        <li class="">
                    <?php echo isset($repla['footer_fourth']) ? $repla['footer_fourth'] : 'top sellers'; ?> </li>
                        <li class="" id="recent_li">
                    <?php echo isset($repla['footer_fifth']) ? $repla['footer_fifth'] : 'recently viewed'; ?> </li>
                        <p style="left:120px;">
                            <b></b>
                        </p>
                    </ul>                           
                    ...
                    <div>
                        <div class="hide-box-0">
                            ...
                            if(!empty($flash_sales))
                            {
                                foreach($flash_sales as $flash)
                                {
                                    ...
                                    ?>
                                    <li class="rec-item"> 
                                        <a href="<?php echo LANGPATH; ?>/product/<?php echo $flash_link . '_p' . $flash['product_id']; ?><?php echo isset($repla['lang']) && !empty($repla['lang']) ? '?lang='.strtolower($repla['lang']) : ''; ?>"> 
                            ...
                            elseif(!empty($related_products))
                            {
                                foreach($related_products as $pid)
                                {
                                    ...
                                    ?>
                                    <li class="rec-item"> 
                                        <a href="<?php echo LANGPATH; ?>/product/<?php echo $relate_link . '_p' . $pid; ?><?php echo isset($repla['lang']) && !empty($repla['lang']) ? '?lang='.strtolower($repla['lang']) : ''; ?>"> 
                        ...
                        <div class="hide-box-1 hide">
                            ...
                            foreach($news as $pdetail)
                            {
                                ?>
                                <li class="rec-item"> 
                                    <a href="<?php echo LANGPATH; ?>/product/<?php echo $pdetail['link'] . '_p' . $pdetail['id']; ?><?php echo isset($repla['lang']) && !empty($repla['lang']) ? '?lang='.strtolower($repla['lang']) : ''; ?>"> 
                        ...
                        <div class="hide-box-2 hide">
                            ...
                            {
                            $hots = DB::query(Database::SELECT, 'SELECT cp.product_id FROM catalog_products cp left join products p on cp.product_id = p.id   WHERE cp.catalog_id = 32 and p.visibility = 1 AND p.status=1 AND p.stock <> 0 ORDER BY cp.position DESC LIMIT 0, 7')->execute()->as_array();
                            ...
                            foreach($hots as $h)
                            {
                                ...
                                ?>
                                <li class="rec-item"> 
                                    <a href="<?php echo $hproduct->permalink(); ?><?php echo isset($repla['lang']) && !empty($repla['lang']) ? '?lang='.strtolower($repla['lang']) : ''; ?>"> 
...
<!--         <?php // else: ?>
    ...
    <div class="JS-tabcon-size size-tabcon size-table-box">
        ...
        <div class="bd size-mesurements hide">
            <h3>CLOTHING</h3>
            <div class="clearfix">
                <div class="fll"><img src="<?php echo STATICURL; ?>/assets/images/docs/size-guide1.jpg" /></div>
                <div class="right flr" style="padding-left:20px;">
                <p>
                    <strong>a) Bust</strong>
                    <br> *This is not your bra size!
                    <br> *Wear an unpadded bra (your dress will have a built-in bra)
                    <br> *Relax arms at sides
                    <br> *Pull tape across the fullest part of the bust
                </p>
                <p>
                    <strong>b) Waist</strong>
                    <br> *Find the natural waist
                    <br> *This is the smallest part of the waist
                    <br> *Usually about 1 in. above belly button
                    <br> *Keep tape slightly loose to allow for breathing room 
                </p>
                <p>
                    <strong>c) Hip</strong>
                    <br> *Find the widest part of the hips
                    <br> *Usually about 8 in. below natural waist
                    <br> *Tape should brush across both hipbones
                </p>
                    </div>
            </div>
            <h3>SHOES</h3>
            <div class="clearfix">
                <div class="fll"><img src="<?php echo STATICURL; ?>/assets/images/docs/size-guide6.jpg" /></div>
    ...
    $(function(){
        $("#formAdd").submit(function(){
            ...
            $.ajax({
                ...
                alert('Sorry, you have already picked your gift. If you prefer this one, please delete the one you chose before from the cart, if you have ordered, please contact our CS to delete your order.')            
              <?php  }
                 ?>
...
<!-- Facebook Pixel Code -->
    <script>
        ...
        fbq('init', '1622560484706520');
        fbq('track', 'PageView');
        fbq('track', 'ViewContent');
    </script>
    <noscript>
        < img height="1" width="1"
             src="https://www.facebook.com/tr?id=1622560484706520&ev=PageView
&noscript=1"/>
    </noscript>