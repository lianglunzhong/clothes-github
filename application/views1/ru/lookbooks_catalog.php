            ...
            <div class="container">
                <div class="crumbs">
                    <div class="fll">
                        ...
                        <a href="<?php echo LANGPATH; ?>/lookbook" rel="nofollow">Лукбук</a>
                       <!-- <span>Dresses</span>-->
                    </div>
                </div>
                <ul class="filter-bar cf">
                    <div class="fll fa-2x">Лукбук</div>
                    <!--<li class="item-l drop-down JS-show" style="float:right">
                    ...
                    <li class="item-l drop-down JS-show" style="float:right">
                        <div class="drop-down-hd">
                            Bottoms <i class="fa fa-caret-down"></i>
                        </div>
                                    ...
                                    <div class="meta-bar">
                                        ...
                                        <div class="meta-pro-botton">
                                            <div class="meta-pro-mes fll" >
                                                ...
                                                {
                                                ?>
                                                <a href="" title="Нравится" class="notadd meta-heart-on met-pc" data-product="<?php echo $v['product_id']; ?>"></a>                                    
                                                <?php
                                                }
                                                else
                                                {
                                                ...
                                                <a href="" title="Нравится" class="add_to_wishlist meta-heart-on met-pc" data-product="<?php echo $v['product_id']; ?>"></a>                           
                                                <?php
                                                }
                                                ?>
                                                <div class="loves-count fll" id="wish1_<?php echo $v['product_id']; ?>"><?php echo $v['wish']['wish']; ?></div>
                                            </div>
                                            <a  class="btn btn-primary btn-xs flr" target="_blank" href="<?php echo LANGPATH; ?>/lookbook/<?php echo $lookbook['id']; ?>">Подробнее</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
