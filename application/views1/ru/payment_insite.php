        ...
        <section class="cart">
            <section class="shipping_delivery fix">
                <article class="shipping_delivery_left payment_box">
                    ...
                    <div>
                        <div id="payment_wrap">
                            <div class="payment_h1">Bestellung überprüfen und bezahlen</div>
                            <div class="payment_p">
                                ...
                                <p class="payment_message_p">Wir akzeptieren die folgenden Kreditkarten/Debitkarten. Verlassen Sie bitte diese Seite nicht, bis das Zahlungsergebnis zurückgibt.<br>(Hinweis: Aus Sicherheitsgründen werden wir keine Ihre Kreditkartendaten sparen.)</p>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">          
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="payment_td_right">Zahlungsmethode:</td>
                                                <td width="300">
                                                    <ul class="payment_ul">
                                                        <li style="background-position:0 0;"><label for="cardType1"><img src="<?php echo STATICURL; ?>/ximg/visa.jpg" alt="Visa"></label></li>
                                                        <script>
                                                            cartypes[4] = "VISA";
                                                        </script>

                                                        <li style="background-position:-90 0;"><label for="cardType2"><img src="<?php echo STATICURL; ?>/ximg/master.jpg" alt="MasterCard"></label></li>
                                                        <script>
                                                            cartypes[5] = "MASTER";
                                                        </script>
                                            ...
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Kartennummer:</td>
                                            ...
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Ablaufdatum:</td>
                                            ...
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Kartenprüfnummer:</td>    
                                                        ...
                                                        <tbody><tr>
                                                                ...
                                                                <td><div class="payment_icon_en">
                                                                        <div class="payment_icon_box_en">
                                                                            <div class="payment_icon_box_txt_en">Was ist CVV2 ?</div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="500" style="text-align: center;padding-top: 8px;">
                                                    <input type="submit" value="Jetzt bezahlen" id="paybutton" name="paybutton" class="ui_btn_orange jq_btn01"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                        ...
                        <div class="payment_icon_box_close jq_close01" id="jq_close02"></div>
                            ...
                            <div style=" line-height:68px;">Lade Daten, bitte warten Sie einen Moment!</div>
                            </div>
                        </div>
                ...
                <div class="order_summary flr">
                    <div class="cart_side">
                        ...
                        <ul class="total">
                            ...
                            ?>
                            <li class="fwb"><i>Zusätzliche Zahlungssicherheit mit:</i><img src="<?php echo STATICURL; ?>/ximg/card11.jpg"></li>
                        </ul>
                    </div>
                </div>
            </section>
...
<div class="payment_icon_box_close jq_close01" id="jq_close02"></div>
  ...
  <div class="payment_p"><img id="loadingImg" src="/assets/images/loading.gif" width="100" height="68" alt="">  
...
<div id="popup_container" style="display:none;position: absolute; z-index: 99999; padding: 0px; overflow-y: hidden; margin: 0px; min-width: 310px; max-width: 310px; top: 240px; left: 300px;" class="ui-draggable">
    ...
    <div id="popup_content" class="alert">
        <div id="popup_message">Die Kreditkartennummer ist falsch</div>
        <div id="popup_panel">
...
function checkFormData()
{
    ...
    else
    {
        ...
        if(month == 0)
        {
            $popup_message.innerHTML = 'Das Verfallsdatum des Monats ist falsch';
            $popup_overlay.style.display = 'block';
            $popup_container.style.display = 'block';
            return false;
        }
        else
        {
            ...
            if(year == 0)
            {
                $popup_message.innerHTML = 'Das Verfallsdatum des Jahres ist falsch';
                $popup_overlay.style.display = 'block';
                $popup_container.style.display = 'block';
                return false;
            }
            else
            {
                ...
                if(cvv2.length != 3)
                {
                    $popup_message.innerHTML = 'Bitte geben Sie eine dreistellige CVV2-Code ein';
                    $popup_overlay.style.display = 'block';
                    $popup_container.style.display = 'block';
                    return false;
                }
