    ...
    <div class="container">
        <div class="crumbs">
            <div style="display:inline;">
                ...
                <a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > Личный кабинет</a> >  Неоплаченные Заказы
            </div>
...
<a href="<?php echo LANGPATH; ?>/product/<?php echo $product['link']; ?>"><img src="<?php echo image::link(Product::instance($p['product_id'])->cover_image(), 3); ?>" /></a>
                        ...
                        {
                            ?>                              
                    <a href="<?php echo LANGPATH; ?>/order/view/<?php echo $order['ordernum']; ?>" class="btn btn-primary btn-xs mb10">Платить</a>
                         <?php } ?> 
                    </td>
                    </tr>
                </table>
        ...
        ?></p>
            ...
            //  echo $amount;
                ...
                if(!$order['refund_status'] and $amount > 0 and $order['payment_status'] == 'new'){ ?>
                                ...
                                <a class="btn btn-primary btn-sm mb10" href="<?php echo LANGPATH; ?>/order/view/<?php echo $order['ordernum']; ?>">Детали заказа</a>
        <?php }  ?>
                            </td>
                            <td width="20%">
