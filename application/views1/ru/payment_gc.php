<style> 
    ...
    #payment_wrap .payment_ul li { float:left; margin-right:6px; line-height: 15px;}
    ...
    .ui_btn_orange { 
        ...
        color: #FEF4E9; border: solid 1px #F47A20; background: #F78D1D; background: -webkit-gradient(linear, left top, left bottom, from(#FAA51A), to(#F47A20)); background: -moz-linear-gradient(top, #FAA51A, #F47A20); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#faa51a', endColorstr='#f47a20'); margin-right:-25px;
    }
...
<div class="cart_header">
    <div class="layout">
        <a href="<?php echo LANGPATH; ?>/" class="logo"><img src="<?php echo STATICURL; ?>/ximg/logo.png" /></a>
        <div class="cart_step">
            <h2><img src="<?php echo STATICURL; ?>/ximg/payment_step3.png" /></h2>
            <div class="cart_step_bottom">
                <span>Отправка и доставка</span>
                <span>Платеж И Подтверждение</span>
                <span class="on">Размещение Заказа</span>
            </div>
        </div>
            ...
            <section class="shipping_delivery fix">
                <article class="shipping_delivery_left payment_box">
                    ...
                    <div>
                        ...
                        <div id="payment_address" class="mb25" style="border: 1px solid #D6D5D5;padding: 15px;margin-bottom: 30px;height: 67px;width: 660px;">
                          <div style="background: #f8f8f8;font: bold 16px Arial;margin-bottom: 15px;">Адрес счета</div>
                          ...
                          <a href="#" class="a_red JS_popwinbtn1" style="font-style: italic;font-size:12px;margin-left:3px;">Редактировать</a></dt>
                        </div>
                        <div id="payment_wrap">
                            <div class="payment_h1">Оплата Кредитной Картой</div>
                            <div class="payment_p">
                                <div class="payment_message">
                                    ...
                                    Номер Заказа:<span class="c_red f16 bold"><?php echo $order['ordernum']; ?></span>
                                </div>
                                <p class="payment_message_p">Пожалуйста, выберите тип карты, заполните информацию ниже, и нажмите “Платить Сейчас”.<br>
                                <span style="font-weight:bold;font-style: italic;">Примечание</span>: в целях безопасности, мы не будем сохранять любые даты вашей банковской карты.</p>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">          
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Мы принимаем:</td>
                                                <td>
                                                    <ul class="payment_ul">
                                                        <ul class="cad">
                                                            <li>
                                            ...
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Номер карты:</td>
                                                <td>
                                                    <div class="card_num">
                                                        <input type="text" class="ui_input" style="width:280px; " maxlength="16" name="cardNo" id="cardNo" onclick="error_clean('card_error')">
                                                        <div class="error" id="card_error">Номер кредитной карты указан неверно.</div>     
                                                    </div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Дата истечения срока:</td>
                                                <td>
                                                    <?php
                                                    $now_month_list = '<option value="0"> Месяц </option>';
                                                    $all_month_list = '<option value="0"> Месяц </option>';
                                                    $m = date('m');
                                                    ?>
                                                    ...
                                                    <div class="error" id="expire_error">Год Даты окончания неверен.</div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Код СVV2:</td>    
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                <td width="80"><input type="text" maxlength="3" class="ui_input" style="width:60px;" id="cvv2" name="cardSecurityCode" onclick="error_clean('cvv_error')"></td>
                                                                <td>
                                                                    <div class="payment_icon_en">
                                                                        <div class="payment_icon_box_en">
                                                                            <div class="payment_icon_box_txt_en">Что такое CVV2 ?</div>
                                                    ...
                                                    <div class="error" id="cvv_error">Пожалуйста, введите 3-цифра CVV2-код.</div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="487" style="text-align: center;padding-top: 8px;">
                                                    <input type="submit" value="Платить Сейчас" id="paybutton" name="paybutton" class="ui_btn_orange jq_btn01"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                ...
                <div class="order_summary flr">
                    <div class="cart_side">
                        ...
                        <ul class="total">
                            <li class="font14"><label>Итого: </label><span><?php echo $currency['code'] . round($order['amount_products'], 2); ?></span></li>     
                            <li><label>Ориентировочная Доставка: </label><span><?php echo $currency['code'] . round($order['amount_shipping'], 2); ?></span></li>
                            <?php
                            $amount_point = $order['points'] / 100;
                            if ($order['amount_coupon'] + $amount_point > 0):
                                ?>
                                <li><label>Платеж с купоном и баллами: </label><span><?php echo $currency['code']; ?><?php echo round($order['amount_coupon'] + $amount_point, 2); ?></span></li>
                                <?php
                            endif;
                            ?>
                            <li class="total_num font14"><label>Итого со скидкой: </label><span class="font18"><?php echo $currency['code'] . round($order['amount'], 2); ?></span></li>
                            <li class="fwb"><i> Дополнительная безопасность платежа с:</i><img src="<?php echo STATICURL; ?>/ximg/card11.jpg"></li>
                        </ul>
                    </div>
                </div>
            </section>
...
function checkFormData()
{
    ...
    if(cardNo.length == 0)
    {
        ...
        $popup_message.innerHTML = 'Номер кредитной карты указан неверно.';
    ...
    if(month == 0)
    {
        ...
        $popup_message.innerHTML = 'Месяц Даты окончания неверен.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    {
        $popup_message = document.getElementById('expire_error');
        $popup_message.innerHTML = 'Год Даты окончания неверен.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(cvv2.length != 3 || reg.test(cvv2) != true)
    {
        ...
        $popup_message.innerHTML = 'Пожалуйста, введите 3-цифра CVV2-код.';
        $popup_message.style.display = 'block';
        error = 1;
    }
