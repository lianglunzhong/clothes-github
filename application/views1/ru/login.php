                ...
                <form class="signin-form sign-form form" method="post" action="<?php echo LANGPATH; ?>/customer/login/<?php if (!empty($_GET['redirect'])) echo '?redirect=' . htmlspecialchars($_GET['redirect']); ?>">
                    ...
                    <ul class="method">
                        ...
                        <li>
                            ...
                            $page = isset($_SERVER['HTTP_SELF']) ? 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['HTTP_SELF'] . LANGPATH . '/' . htmlspecialchars($redirect) : 'http://' . $_SERVER['HTTP_HOST'] . LANGPATH . '/' . htmlspecialchars($redirect);
