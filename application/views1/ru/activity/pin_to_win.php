...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Home</a>  >  Pin to win</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
                        ...
                        <!--giveaway start-->
                        <div class="pinToWin">
                                <div><a href="http://pinterest.com/pin/38210296811539709/" target="_blank"><img src="<?php echo STATICURL; ?>/ximg/activity/banner_pinterest_1.png" alt="" title=""/></a></div>
                                <div><img src="<?php echo STATICURL; ?>/ximg/activity/banner_pinterest_2.jpg" alt="" title=""/></div>
                                <div class=" rules">
                                        <h3>HOW TO ENTER:</h3>
