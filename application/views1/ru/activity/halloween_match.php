...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Home</a>  >  Halloween Match</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
                ...
                <div class="lp_match">
                        <div id="step1"></div>
                        <p><img src="<?php echo STATICURL; ?>/ximg/activity/halloween_01.jpg" /></p>
                        <p><img src="<?php echo STATICURL; ?>/ximg/activity/halloween_img1.png" /></p>
                        <p><img src="<?php echo STATICURL; ?>/ximg/activity/halloween_img2.png" /></p>
<!--                        <div class="match_sign halloween_sign fix">
                        ...
                        <form action="#" method="post" id="winForm">
                                <div class="match_box halloween_box">
                                        <img src="<?php echo STATICURL; ?>/ximg/activity/halloween_img3.png" width="820" height="580" />
                                        <div class="con">
                                                <div class="tit">
...
<!--                                                <ul class="bottom">
                                ...
                                <div id="step4"></div>
<!--                                <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_tit1.jpg" width="820" height="85" /></p>
                        ...
                        <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_tit2.jpg" /></p>
        ...
        <div style="background:#fff; height: 280px;" id="inline_example2">
                <div class="login">
                        ...
                        <div class="login_l fll ml10">
                                ...
                                <form id="loginForm" method="post" action="<?php echo LANGPATH; ?>/customer/login?redirect=activity/halloween_match#step2" class="">
                                        <ul>
                                                <li>
                        ...
                        <div class="login_l fll">
                                ...
                                <form id="registerForm" method="post" action="<?php echo LANGPATH; ?>/customer/register?redirect=activity/halloween_match#step2" class="">
                                        <ul>
                                                <li>
                                                        <label><span>*</span> Email:</label>
