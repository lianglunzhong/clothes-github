    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="lp_slogan wid805">
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/slogan_img.jpg" /></p>
                <div id="step1"></div>
                <div id="step2"></div>
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/slogan_01.jpg" /></p>
                ...
                <form action="#" method="post" class="lp_vote_form form" id="sloganForm">
                    <ul class="lp_vote_formcon">
                        ...
                        <li class="center"><img src="<?php echo STATICURL; ?>/ximg/activity/slogan_02.jpg" /></li>
                        <li class="center">
            ...
            $("#sloganForm").validate({
                ...
                {
                ?>
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/slogan_03.jpg" /></p>
