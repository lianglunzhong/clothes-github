...
<section id="main">
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="lp_match">
                <div id="step1"></div>
<!--                        <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_banner.jpg" alt="" /></p>
                ...
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_winner1.png" /></p>
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_winner2.png" /></p>
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_winner3.png" /></p>
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_winner4.png" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                        <area shape="rect" coords="151,311,206,343" href="mailto: lisaconnor@choies.com" />
                    </map>
                </p>
                <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_missingtit.png" /></p>
                <div id="step2"></div>
                <form action="#" method="post" id="winForm">
                    <div class="match_box">
                        <img src="<?php echo STATICURL; ?>/ximg/activity/match_img1.jpg" alt="" />
                        <div class="con">
                            <div class="tit">
...
<!--                                                <div class="bottom">SKU of the item that you match:<input type="text" name="sku1" value="" class="text" /></div>-->
                    ...
                    <div class="match_box">
                        <img src="<?php echo STATICURL; ?>/ximg/activity/match_img2.jpg" alt="" />
                        <div class="con">
                            <div class="tit">
...
<!--                                                <div class="bottom">SKU of the item that you match:<input type="text" name="sku2" value="" class="text" /></div>-->
                    ...
                    <div class="match_box">
                        <img src="<?php echo STATICURL; ?>/ximg/activity/match_img3.jpg" alt="" />
                        <div class="con">
                            <div class="tit">
...
<!--                                                <div class="bottom">SKU of the item that you match:<input type="text" name="sku3" value="" class="text" /></div>-->
                    ...
                    <!--                                <div id="step4"></div>
                                                    <p><img src="<?php echo STATICURL; ?>/ximg/activity/match_tit1.jpg" /></p>
