                ...
                <div class="container">
                    <div class="crumbs">
                        <div class="fll">
                            ...
                            <a href="http://www.choies.com/apparels" rel="nofollow">Шоу Покупателей</a>&gt; 
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-7">
                                    <div class="con cle">
                                        ...
                                        <p class="pc-btn"><a href="<?php echo $link; ?>" id="<?php echo $c_images['product_id']; ?>" class="btn btn-default btn-lg mt20">КУПИТЬ СЕЙЧАС</a></p>
                                        <p class="phone-btn"><a href="<?php echo $link; ?>" class="btn btn-default btn-lg ">КУПИТЬ СЕЙЧАС</a></p>
                            <?php
                            if ($c_images['type'] != 1 && $c_images['link_sku'] && strlen($c_images['link_sku']) > 0)
                            {
                                ?>
                                <p class="pc-btn"><a class="btn btn-default btn-lg mt20 JS-popwinbtn1">Получить этот лук</a></p>
                                <?php
                            }
                            ?>
            ...
            ?>
                        ...
                        foreach ($skus as $sku)
                        {
                            ...
                            ?>
                                ...
                                ?>
                                                <p><a href="<?php echo $sku_link; ?>" class="btn btn-default btn-xs" target="_blank">Подробнее</a>
                                                </p>
                                <?php
                                if (!$instock)
                                ...
                                ?>
                                    ...
                                    <div class="add-bag">
                                        <input value="ДОБАВИТЬ В КОРЗИНУ" class="btn btn-primary btn-lg" type="submit"><a href="<?php echo LANGPATH; ?>/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a-underline add-wishlist">ZUR WUNSCHLISTE</a>
                                    </div>
