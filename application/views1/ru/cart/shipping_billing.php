<div class="cart_header">
    <div class="layout">
        ...
        <div class="cart_step">
            <h2><img src="<?php echo STATICURL; ?>/ximg/payment_step1.png" /></h2>
            <div class="cart_step_bottom">
                <span class="on">Отправка и доставка</span>
            ...
            <article class="shipping_delivery_left fll">
                            ...
                            <dd>
                                <ul class="shipping_address">
                                    ...
                                    foreach ($addresses as $key => $value)
                                    {
                                        ...
                                        <li class="fix JS_shows_btn1">
                                            <div class="fix">
                                                ...
                                                <label for="radio<?php echo $key; ?>"><b class="s1">Адрес<?php echo $key + 1; ?></b></label>
                                                <div class="flr address_edit JS_shows1">
                                                    <?php
                                                    if ($key == $default_key)
                                                    {
                                                        ?>
                                                        <span class="b">выбрать</span>
                                                        <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">Редактировать</a>
                                                        <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Удалить</a>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <a href="<?php echo LANGPATH; ?>/address/set_default/<?php echo $value['id']; ?>" class="a_underline">Установить по умолчанию</a>
                                                        <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">Редактировать</a>
                                                        <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Удалить</a>
                                                        <?php
                                                    }
                                    ...
                                    <li class="fix last">
                                        ...
                                        <label for="radionew" class="a_underline add_new font14">+Добавить новый адрес</label>
                                    </li>
                                </ul>
                            </dd>
                        </dl>
                    ...
                    <div class="shipping_methods">
                        <ul class="fix">
                            ...
                            foreach ($site_shipping as $key => $price):
                                ...
                                $ship_name = str_replace(array('Working Day Shipping'), array('бизнес-дней доставка'), $price['name']);
                                ?>
                                <li>
                        ...
                        <p>
                            <input type="submit" value="Безопасности заказа" class="btn40_16_red" />
                        </p>
                    </div>
                </form>
                ...
                <div id="edit_address" class="JS_popwincon2 popwincon popwincon_user hide">
                    ...
                    <form action="<?php echo LANGPATH; ?>/cart/edit_address" method="post" class="form user_share_form user_form form1">
                        ...
                        <div class="center" style="margin-left: -63px;"><input type="submit" value="Дальше" class="btn30_14_black" /></div>
                    </form>
                </div>
            </article>
            ...
            <div class="order_summary flr">
                <div class="cart_side">
                                    ...
                                    <p>
                                        ...
                                        if (isset($product['attributes'])):
                                            foreach ($product['attributes'] as $attribute => $option):
                                                ...
                                                $attr = str_replace('one size', 'только один размер', $option);
                                                if ($attribute == 'delivery time')
                                                    $option = $option > 0 ? 'Срочный Заказ' . ' ( + ' . Site::instance()->price($option, 'code_view') . ' )' : 'Нормальный Заказ';
                                                echo ucfirst($attribute) . ': ' . $attr . '<br>';
                                            endforeach;
                                        endif;
                                        ?>
                                    </p> 
                    ...
                    <ul class="total">
                        ...
                        <li><label>Ориентировочная Доставка: </label><span id="shipping_total"><?php echo $cart_shipping == -1 ? Site::instance()->price($site_shipping[1]['price'], 'code_view') : Site::instance()->price($cart_shipping, 'code_view'); ?></span></li>
                        <?php
                        if ($cart['amount']['coupon_save'] + $cart['amount']['point'] > 0):
                            ?>
                            <li><label>Платеж с купоном и баллами: </label><span><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span></li>
                            <?php
                        endif;
...
<div class="hide" id="cart_delete" style="position: fixed;padding: 10px 10px 20px; top: 170px;left: 400px; z-index:100px;z-index: 1000; background: #FFFFFF; border-color: #F6F6F7; border:1px solid #cdcdcd;">
    ...
    <div class="order order_addtobag center" style="margin:20px;">
        <div style="font-size:13px;margin-bottom: 20px;">Вы уверены, что хотите удалить это?</div>
        <form action="<?php echo LANGPATH; ?>/cart/delete_address" method="post">
            <input type="hidden" name="address_id" id="address_id" value="" />
            <input type="submit" class="view_btn btn26" value="Удалить" />
            <a href="#" class="cancel" style="text-decoration:underline;margin-left:10px;">Отмена</a>
        </form>
    </div>
                            ...
                            $(".form1").validate({
                                ...
                                messages: {
                                    ...
                                    shipping_address: {
                                        ...
                                        maxlength:"Адрес превышает максимальную длину:200 символов."
                                    },
                                    shipping_zip: {
                                        required: "Введите ваш почтовый индекс,пожалуйста.",
                                        maxlength:"Почтовый индекс превышает максимальную длину:50 символов."
                                    },
                                    shipping_city: {
                                    ...
                                    shipping_phone: {
                                        ...
                                        maxlength:"Телефон превышает максимальную длину:50 символов."
                                    }
                                }
                            });
