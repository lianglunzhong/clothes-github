                                ...
                                <nav id="nav1" class="nav">
                                    <ul>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        if (isset($cache_shoes_content) AND !isset($_GET['cache'])){
                                                            ...
                                                            $shoes = DB::select('id')->from('catalogs')->where('link', '=', 'shoes')->execute()->get('id');
                                        ...
                                        <li class="JS-show">
                                            ...
                                            $accessory = DB::select('id')->from('catalogs')->where('link', '=', 'accessory')->execute()->get('id');
                                        ...
                                        <?php   
                                         ...
                                         $jewellery = DB::select('id')->from('catalogs')->where('link', '=', 'jewellery')->execute()->get('id');
