                    ...
                    <div class="step-nav step-nav1">
                        <ul class="clearfix">
                           <li>Модные программы<em></em><i></i></li>
                            ...
                            <li class="current">Получить Баннер<em></em><i></i></li>
                        </ul>
                    </div>
                </div>
                <article class="row">
                    ...
                    <div class="col-sm-10 col-xs-12">
                        <div class="fashion-tit">ПОЛУЧИТЬ БАННЕР</div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="col-xs-12">
                                            ...
                                            <a class="join_us" href="#">
                                                <img src="http://edm.choies.com/blogger/wanted_6_<?php echo LANGUAGE;?>.jpg" width="728" height="90" style="display:block;" class="mb10"/>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
