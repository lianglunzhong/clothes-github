        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-8 col-md-8">
                    <a href="<?php echo LANGPATH; ?>/" class="logo"><img src="<?php echo STATICURLHTTPS; ?>/assets/images/2016/logo.png" alt=""></a>
                </div>
                <div class="col-xs-4 col-md-4">
                    <a href="" target="_blank"><img src="<?php echo STATICURLHTTPS; ?>/assets/images/card3.png"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <div class="step-nav">
                        <ul class="clearfix">
                            <li>Отправка и доставка<em></em><i></i></li>
                            <li class="current">Платеж И Подтверждение<em></em><i></i></li>
            ...
            <div class="row">
                    ...
                    <div class="shipping-information">
                        <div class="information-con">
                            ...
                            <div class="billing-address" id="payment_address">
                                ...
                                <a href="javascript:;" class="red JS-popwinbtn1">Редактировать</a>
                            </div>
                        ...
                        <div class="payment-wrap">
                            <div class="payment-p">
                                <div class="payment-message">
                                    <div class="fll mr20">Сумма Заказа:
                                        <span class=" f16 bold"><?php echo round($order['amount'], 2) . ' ' . $order['currency']; ?></span>
                                    </div>
                                    <div class="fll">Номер Заказа:<span class=" f16 bold"><?php echo $order['ordernum']; ?></span></div>
                                </div>
                                <div class="clearfix"></div>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                    <ul>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Тип Кредитной Карты</label>
                                        ...
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em> Номер Кредитной Карты</label>
                                            <div class="payment-card-time">12-19 цифр, пробелы не допускаются</div>
                                            <div class="card-num">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="card_error">Номер кредитной карты указан неверно.</div>
                                        </li>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Дата истечения срока</label>
                                            <?php
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment-card-time fl">
                                                    Месяц</div>
                                            </div>
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment-card-time fl">Год</div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="expire_error">Год Даты окончания неверен.</div>                                                               
                                        </li>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Код Безопасности  <span style="font-weight:normal; color:#999">(CVV/CVC)</span></label>
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="cvv_error">ожалуйста, введите 3-цифра CVV/CVC-код.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="Платить Сейчас" id="paybutton" name="paybutton" class="btn btn-primary btn-lg" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                ...
                <div class="col-xs-12 col-sm-4 col-sm-offset-1">
                    <div class="order-summary">
                        <div class="cart-side">
                            <p>
                                <strong>Принимаемые Кредитные Карты</strong><br /><br />
                    Мы принимаем VISA, Electron, MasterCard и Дебет VISA или Дебет MasterCard.<br />
                    Если вы используете другой карты(например, Discover или American Express) Пожалуйста, платите с<a style="text-decoration:underline;" href="<?php echo LANGPATH; ?>/order/view/<?php echo $order['ordernum']; ?>" target="_blank">PayPal</a> вместо.
                                <br>
                                <br>
                                <strong>Политики о 60-дневном возврате</strong>
                    Если Вы не удовлетворяетесь с вашей покупкой, то просто напишите на
                                <a style="text-decoration:underline;" href="mailto:service@choies.com" target="_blank">service@choies.com</a> чтобы получить право на возврат (адрес возврата) или обмен авторизации в течение 60 дней после получения.
                            </p>
                            <div class="add-payment">
                                <strong>Дополнительная безопасность платежа с:</strong>
                                <span class="encryption"><b></b>Безопасно Оформить Заказ  256-bit SSL-шифрование по Norton</span>
                                <span>
...
<div class="loading" id="payment_wrap2" style="display:none;">
    <div class="loading-box">
        ...
        <div class="loading-prompt">Загрузка, пожалуйста, подождите минуточку!</div>
        </div>
    </div>
</div>
...
<div class="JS-popwincon1 popwincon popwincon-user hide">
    ...
    <div class="address-fill">
        ...
        <form action="/order/edit_address/<?php echo $order['id']; ?>" method="post" class="form payment-form form1">
            ...
            <ul>
                ...
                <li>
                    ...
                    <label class="error hide" style="display:none;" generated="true" id="guo_fon">Please choose your country.</label>
...
function checkFormData()
{
    ...
    if(cardNo.length == 0)
    {
        ...
        $popup_message.innerHTML = 'Введите номер карты,пожалуйста.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(month == 0)
    {
        ...
        $popup_message.innerHTML = 'Выберите дату истечения срока действия,пожалуйста.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(cvv2.length != 3 || reg.test(cvv2) != true)
    {
        ...
        $popup_message.innerHTML = 'Пожалуйста, введите 3-цифра CVV/CVC-код.';
        $popup_message.style.display = 'block';
        error = 1;
    }
