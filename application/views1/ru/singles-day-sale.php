		...
		<style>
			...
			.four-partake span.st_fblike_hcount{ display: none;}  
			</style>
		<!-- main begin -->
		<section id="main">
			...
			<div class="container">
                ...
                <div class="sale-filter">
					<img src="/assets/images/11-11-ru-2.jpg">
				</div>
				<div class="nov-box">
					...
					function acceptpc(obj){
						...
						var lan="ru";
						$.post('/activity/singles_day_sale', {data_id:data_id,lan:lan}, function(re){
							var strVar = "";
							$.each(re,function(i,item){
								...
								strVar += "<span class=\"mr5\">Оригинальная Цена: <del>"+item.orig_price+"<\/del><\/span>    <span style=\"display:none\">Sale Price: "+item.price+"<\/span>";
								strVar += "<\/div>";
								strVar += "<div class=\"price-11 mt5\">";
								strVar += "Две 11 Цена:<b class=\"red\">"+item.discount_price+"<\/b>";
								strVar += "<\/div>";
							    ...
							    strVar += "		<a class=\"mr5\" href='"+item.plink+"' target='_bank'> Смотреть Подробности<\/a><i class=\"fa fa-chevron-circle-right\"><\/i>";
							    strVar += "<\/div>";
								strVar += "</li>"
							})
						...
						<?php foreach ($data as $v){?>
							<li class="pro-item col-xs-6 col-sm-3">
								...
								<div class="original-sale mt5">
									 <span class="mr5">Оригинальная Цена: <del><?php echo $v['orig_price'];?></del></span>    <span style="display:none">Sale Price: <?php echo $v['price'];?></span>
								</div>
								<div class="price-11 mt5">
									 Две 11 Цена:<b class="red"> <?php echo $v['discount_price'];?></b>
								</div>
								...
								<div class="view-11 mt5">
									 <a class="mr5" href="<?php echo $v['plink'];?>" target='_bank'> Смотреть Подробности</a><i class="fa fa-chevron-circle-right"></i>
								</div>
							</li>
						<?php }?>
