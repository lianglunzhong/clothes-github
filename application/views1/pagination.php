...
<ul class="pagination flr">
    <!--<li><span class="n_border">RESULTS:<span><?php //echo $total_items; ?></span></span></li>-->
    ...
    <?php if ($next_page !== FALSE): ?>
        <li><a href="<?php echo $page->get_url($next_page); ?>" class="next_btn1" >NEXT »</a></li>
    <?php endif; ?>
    <?php if ($next_page == FALSE): ?>
        <li class="disabled"><a  class="next_btn1" >NEXT »</a></li>
    <?php endif; ?>
</ul>
<?php endif; ?>
