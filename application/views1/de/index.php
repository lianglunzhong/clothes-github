        <div class="site-content">
            ...
            <div id="homeBigBanner" class="flexslider topbanner hidden-xs">
                <ul class="slides">
                    ...
                    ?>
                    <li><a href="<?php echo LANGPATH.$link; ?>"><img src="<?php echo $banner_src; ?>"  alt="<?php echo $banner['title']; ?>" class="<?php echo LANGUAGE;?>_main_banner<?php echo $i;?>" /></a></li>
                    <?php }?>
                </ul>
            ...
            <div id="phoneBigBanner" class="flexslider topbanner hidden-sm hidden-md hidden-lg">
                <ul class="slides">
                    ...
                    ?>
                    <li>
                        <a href="<?php echo LANGPATH.$link; ?>"><img class="<?php echo LANGUAGE;?>_main_banner<?php echo $i;?>" src="<?php echo $banner_src; ?>" alt="" /></a>
                    </li>
                    <?php }}?>
                </ul>
                <script type="text/javascript">
                    ...
                    ?>
                                <li class="col-xs-6 col-sm-4">
                                    <a class="img" href="<?php echo LANGPATH.$banner['link'];?>">
                                    ...
                                    <span><a href="<?php echo LANGPATH.$banner['link'];?> "><?php echo $banner['alt'];?></a></span>          
                                </li>
                    <?php 
                            }
                        }
                                ...
                                <li class="hot col-xs-12 hidden-sm hidden-md hidden-lg">
                                    <table class="phone-hot" >
                                        <tbody>
                                            <tr>
                                                <td class="col-xs-6">
                                                    <a href="<?php echo LANGPATH;?>/daily-new/week2">New In ›</a>
                                                </td>
                                                <td class="col-xs-6">
                                                    <a href="<?php echo LANGPATH;?>/clothing-c-615">CLothing ›</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-xs-6">
                                                    <a href="<?php echo LANGPATH;?>/shoes-c-53">Shoes ›</a>
                                                </td>
                                                <td class="col-xs-6">
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-xs-6">
                                                    <a href="<?php echo LANGPATH;?>/outlet-c-101">Sale ›</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
