        ...
        <div class="icontainer">
            <div class="login">
                ...
                <div class="cart_paypal">
                    <h2>IHRE BESTELLNUMMER: <span><?php echo $ordernum; ?></span><img src="<?php echo STATICURLHTTPS; ?>/assets/images/loading.gif" /></h2>
                    <p>Die Bezahlseite ist geladen zu kommen, es wird ein paar Sekunden oder länger dauern.</p>
                    <p>Bitte gehen Sie nicht aus, und falls Sie noch Frage haben oder Hilfe benötigen, </p>
                    <p class="bottom">kontaktieren Sie uns bitte hier: <a href="mailto:service@choies.com">service@choies.com</a></p>
                </div>
                <div class="message">
