                        ...
                        <form action="#" method="post" id="formAdd">
                            ...
                            <div class="total">
                                ...
                                <div style="height:20px;">
                                    <div class="add-success" style="display:none"><i class="fa fa-check"></i>Item Added to Bag!</div>
                                </div>
                            </div>
                        </form>
                    </div> -->
                    ...
                    <div id="action_form" class="JS-popwincon">
                        ...
                        <form action="#" method="post" id="formAdd">
                                    ...
                                    <div class="clearfix">
                                        <ul class="size-list">
                                            <li class="drop-down-option" id="one size" data-attr="one size">
                                                <a href="javascript:void(0);">Eine Größe</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="total">
                                ...
                                <div style="height:20px;">
                                    <div class="add-success" style="display:none"><i class="fa fa-check"></i>Produkt In Warenkorb gelegt</div>
                                </div>
                            </div>
                        </form>
                    </div>
