                        ...
                        <ul class="shopping-total">
                            ...
                            elseif($cart['amount']['items'] >=15 && $cart['amount']['items'] < 79 && $customer_id)
                            {
                                ...
                                if(!in_array($country,$no_express_countries) && !empty($country))
                                {
                                    $islarge = 1;
                            ?>
                                <p class="hidden-xs">Noch  <span><?php echo Site::instance()->price($add_price,'code_view');?></span> Artikel hinzufügen, um <span>Kostenlosen Versand</span><b></b> zu genießen. </p>
                            <?php
                                }
                            }
                            ?>
                            ...
                            ?> 
                            <li class="cart-phone-tip hidden-sm hidden-md hidden-lg"> 
                                <p>Noch <span class="red"><?php echo Site::instance()->price($add_price,'code_view');?></span> Artikel hinzufügen, um <span class="red">Kostenlosen Versand</span><b></b> zu genießen. </p>
                            </li>
                            <?php
                            }
                            ?>
