...
<!--                            <a href="--><?php //echo LANGPATH;?><!--/christmas-sale-c-490"><img src="--><?php //echo STATICURL;?><!--/assets/images/1611/christmas_sale.gif" class="--><?php //echo LANGUAGE;?><!--_top_banner"></a>-->
<!--                            </div>-->
<!--                        -->
<!--                        </div>-->
<!--                        -->
                        ...
                        <div class="col-xs-5 col-md-4 col-md-offset-1 col-lg-4 col-lg-offset-0">
                            <div class="n-search fll">
                                    <?php
                                        ...
                                        {
                                        $searchword=DB::select('name')->from('search_hotword')->where('active', '=', 1)->where('type', '=', 1)->where('lang', '=', '')->where('site_id', '=', 1)->execute()->get('name');
                                            ...
                                            <div class="nav-box">
                                                <div class="nav-list01 fll">
                                                    <dl class="nav-ul">
                                                        ...
                                                        <dl class="col-xs-7">
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/92">Kleider</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/621">Tops</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/953">Mäntel & Jacken</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/961">Pullover & Strickjacken</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/53">Schuhe</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/52">Accessoires</a></dd>
                                                        </dl>
                                                    </dl>
                                                </div>
                                                    <?php
...
<!--                                         <li class="cs-show">
                                   ...
                                   <div class="nav-list cs-list" style="margin-left:-400%;">
                                    ...
                                    <li class="cs-show" style="width:13%">
                                        ...
                                        <div class="nav-list cs-list" style="margin-left:-569%;">
                                            ...
                                            <div class="nav-box">
                                                <div class="nav-list01 fll">
                                                    <dl class="nav-ul01">
                                                        <dd><a href="<?php echo LANGPATH;?>/only-9-c-1170">Only $9.90</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/activity/flash_sale">Flash Sale</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/only-19-c-1171">Only $19.90</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/summer-clearance-c-451">Summer Clearance</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/only-29-c-1172">Only $29.90</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/biggest-deal-c-1174">Biggest Deal</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/outlet-c-101">Outlet</a></dd>
                                                                                                                                                             
                                                    </dl>
                                                </div>
                                                <div class="nav-list02 fll">
                                                        <!-- <a href="<?php echo LANGPATH;?>/biggest-deal-c-1174">
                                                        <img src="<?php echo STATICURL;?>/assets/images/1610/biggest_deal.jpg" class="navigation_banner6"></a> -->
                                                    <?php 
                                                   if(array_key_exists(4, $newindex_banners))
                                                   {
                                                   ?>
                                               <a href="<?php echo LANGPATH;?><?php echo $newindex_banners[4]['link']; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo $newindex_banners[4]['image']; ?>" class="navigation_banner6"></a>
                                                   <?php
                                                   }
                                                   ?>
                                                </div>
                                    ...
                                    <li class="cs-show" style="width:13%">
                                        <a href="<?php echo LANGPATH; ?>/choies-top-sellers-c-1188"> <?php echo isset($head_footer['head_eighth']) ? $head_footer['head_eighth'] : 'TOP SELLERS'; ?> 
                                        </a>
                                        ...
                                        <div class="nav-box">
                                            <div class="nav-list01 fll">
                                            <dl class="nav-ul">
                                                <dd><a href="<?php echo LANGPATH; ?>/top-seller-dresses-c-1189">Top Seller: Dresses</a></dd>
                                                <dd><a href="<?php echo LANGPATH; ?>/top-seller-blouses-and-shirts-c-1190">Top Seller: Blouses & Shirts </a></dd>
                                                <dd><a href="<?php echo LANGPATH; ?>/top-seller-coats-and-jackets-c-1191">Top Seller: Coats & Jackets  </a></dd>
                                                <dd><a href="<?php echo LANGPATH; ?>/top-seller-sweater-and-knits-c-1192">Top Seller: Sweater & Knits  </a></dd>
                                                <dd><a href="<?php echo LANGPATH; ?>/top-seller-skirts-c-1193">Top Seller: Skirts </a></dd>          
                                            </dl>
                                            </div>
                                            <div class="nav-list02 fll">
                                                    <!-- <a href="<?php echo LANGPATH; ?>/choies-top-sellers-c-1188">
                                                   ...
                                                   {
                                                   ?>
                                               <a href="<?php echo LANGPATH;?><?php echo $newindex_banners[9]['link']; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo $newindex_banners[9]['image']; ?>" class="navigation_banner6"></a>
                                                   <?php
                                                   }
                                                   ?>
                                            </div>
                    ...
                    <ul id="accordion" class="accordion">
                        ...
                        <li><div class="link"><span>NEUHEITEN</span><i class="fa fa-caret-right"></i></div>
                            ...
                            $newinarr = array(
                                                ...
                                                array('Kleider','92'),
                                                array('Tops','621'),
                                                array('Mäntel & Jacken','953'), 
                                                array('Pullover & Strickjacken','961'),
                                                array('Schuhe','53'),
                                                array('Accessoires','52'), 
                                             );
                                     ?>
