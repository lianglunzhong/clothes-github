        ...
        <div class="container">
            <div class="crumbs">
                <div class="fll">
                    ...
                    &gt;<span>Suchen : <strong><?php echo $keywords; ?></strong></span>
                </div>
            </div>
            <div class="list-main">
                ...
                <div class="filter-bar">
                    <ul class="bar-r">
                        ...
                        <?php
                            ...
                            ?>
                            <a href="<?php echo '?' . Security::xss_clean(implode('&', $gets1)); ?>" class="">Wahl der Berühmtheit</a>
                        </li>
                    ...
                    foreach ($products as $i => $product_id)
                    {
                        ...
                        <li class="pro-item col-xs-6 col-sm-3">
                            ...
                            <?php if ($product_inf->get('type') != 0): ?>
                                <a href="#" id="<?php echo $product_id; ?>" attr-lang="<?php echo LANGUAGE; ?>" class="quick_view btn-qv"  data-reveal-id="myModal">SCHNELLANSICHT</a>
                            <?php endif; ?>
                            <div class="add-wish">
                ...
                <div class="notfound">
                    ...
                    <div class="searchon-wp">
                        <div class="searchon-404">
                            <p class="font24"><strong>Entschuldigung!</strong> Der Artikel, nach dem Sie suchen, wurde nicht gefunden,<br />
