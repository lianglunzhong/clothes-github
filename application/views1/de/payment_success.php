...
$products = Order::instance($order['id'])->products();
    ...
    ?>
         //   window._fbq.push(['track', 'PixelInitialized', {}]);
            window._fbq.push(["track", "Purchase", { content_type: 'product', content_ids: [<?php echo $sqid; ?>], product_catalog_id: '908216835935784' }]);
                            ...
                            <nav id="nav1" class="nav">
                                <ul>
                                    <li class="JS-show p-hide" style="width:13%">
                                        <a href="<?php echo LANGPATH;?>/daily-new/week2">NEUHEITEN</a>
                                        <div class="nav-list JS-showcon hide">
                                            <span class="downicon tpn01"></span>
                                            <div class="nav-box">
                                                <div class="nav-list01 fll">
                                                    <dl class="nav-ul">
                                                        <dt class="title">FILTERN NACH</dt>
                                                        <dd><a href="<?php echo LANGPATH;?>/daily-new/week2">Diese Woche</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/daily-new/week1">Letzte Woche</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/daily-new/month">Letzter Monat</a></dd>
                                                        <dd><a href="<?php echo LANGPATH;?>/new-presale-c-1012">Vorverkauf</a></dd>
                                                    </dl>
                                                </div>
                                                    <?php
                                    ...
                                    <li class="JS-show" style="width:13%">
                                        <a href="<?php echo LANGPATH; ?>/clothing-c-615">BEKLEIDUNG</a>
                                        <div class="nav-list JS-showcon hide" style="margin-left:-100%;">
                                            <span class="downicon tpn02"></span>
                                            <div class="nav-box">
                                                <div class="nav-list03 fll">
                                                    <dl class="nav-ul01">
                                                        <dt class="title">EINKAUF NACH KATEGORIE</a></dt>
                                                            <?php
                                                            $links = array(
                                                                array('Alle Bekleidung', 'clothing-c-615'),
                                                                array('Kleider', 'dresses-c-92'),
                                                                array('Tops', 'clothing-tops-c-621'),
                                                                array('Mäntel & Jacken', 'coats-jackets-c-45'),
                                                                array('Pullover & Strickjacken', 'knitwear-sweaters-c-619'),
                                                                array('Anzüge & Koordinaten-Sets', 'two-piece-suit-c-177'),
                                                                array('Jumpsuits & Overalls', 'one-pieces-c-626'),                                   
                                                                array('Jeans', 'jeans-c-49'),
                                                                
                                                                array('Hosen & Leggings', 'pants-c-233'),
                                                                array('Shorts', 'shorts-c-51'),
                                                                array('Röcke', 'skirt-c-99'),
                                                                array('Bademode', 'swimwear-c-628'),
                                                    ...
                                                    <dl class="nav-ul01">
                                                        <dt class="title">EINKAUF NACH KATEGORIE</a></dt>
                                                            ...
                                                            $links = array(
                                                                ...
                                                                array('Taschen & Geldbeutel', 'bags-c-643'),
...
style="top: 0px;position: fixed; width: 100%; z-index: 999;">           
            ...
            <nav class="navbar-collapse collapse hidden-sm hidden-md hidden-lg">
                    ...
                    <ul id="accordion" class="accordion">
                        ...
                        <li>
                            <div class="link"><span class="icon-collection">KOLLEKTION</span><i class="fa fa-caret-right"></i></div>
                            <ul class="submenu">
                                <li class="back"><a class="back-btn" href="#"><i class="fa fa-caret-left"></i><span>Go Back</span></a></li>
                                    <?php
                                        $apparels_list = array(
                                            'Alle anzeigen' => '/clothing-c-615',
                                            'Übergroß' => '/plus-size-c-737 ',
                                            'Herbst/Winter 2015' => '/aw-2015-c-739 ',
                                            'Boutiquen' => '/boutiques-c-738 ',
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="step-nav">
                                    <ul class="clearfix">
                                        ...
                                        <li>Bezahlen<em></em><i></i></li>
                                        <li class="current">Erfolgreich<em></em><i></i></li>
                                    </ul>
                                </div>  
                            </div>  
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <article class="user col-sm-9 col-xs-12">
                            <h1 class="paysuccess-h">VIELEN DANK!</h1>
                            <ul class="paysuccess-t">
                                <li>Sie haben Ihre Zahlung erfolgreich abgeschlossen. </li>
                                <li>Klicken Sie auf Ihre Bestellnummer: <a class="success" href="<?php echo LANGPATH; ?>/order/view/<?php echo $order['ordernum']; ?>"><?php echo $order['ordernum']; ?></a> um mehr Details zu sehen.</li>
                                ...
                                <li><a href="<?php echo LANGPATH; ?>/" class="btn btn-primary btn-sm">WEITER KAUFEN</a></li>
                                <?php
...
?>
                ...
                <div class="container-fluid footer-signin hidden-xs">
                    <div class="container">
                        <form action="" method="post" id="letter_form">
                            <label class="">BLEIBEN SIE INFORMIERT</label>
                            <div>
                                ...
                                <input type="submit" id="letter_btn" value="ANMELDEN" class="btn btn-default">
                            </div>
                ...
                <div class="container">
                    <div class="footer-mid">
                        <div class="footer-ship">
                            <ul class="row">
                                <li class="col-xs-3"><a class="shipping-icon" href="<?php echo LANGPATH;?>/shipping-delivery"><span></span>VERSANDARTEN</a></li>
                                <li class="col-xs-3"><a class="returns-icon" href="<?php echo LANGPATH;?>/returns-exchange"><span></span>RÜCKGABE</a></li>
                                <li class="col-xs-3"><a class="size-icon" href="<?php echo LANGPATH;?>/size-guide"><span></span>GRÖSSENTABELLE</a></li>
                                <li class="col-xs-3"><a class="membership-icon" href="<?php echo LANGPATH;?>/vip-policy"><span></span>MITGLIEDSCHAFT</a></li>
                            </ul>
                        </div>
                        <div class="footer-context">
                            <dl>
                                <dt>ÜBER UNS</dt>
                                <dd><a href="<?php echo LANGPATH;?>/about-us">Wer wir sind</a></dd>
                            ...
                            <dl>
                                ...
                                <dd><a href="<?php echo LANGPATH;?>/important-notice">Hinweise</a></dd>
                            </dl>
                            <dl>
                                <dt>EINKAUFSFÜHRER</dt>
                                <dd><a href="<?php echo LANGPATH;?>/payment">Bezahlung</a></dd>
                                <dd><a href="<?php echo LANGPATH;?>/coupon-points">Gutscheine</a></dd>
                                <dd><a href="<?php echo LANGPATH;?>/how-to-order">Wie man bestellt</a></dd>
                            </dl>
                            <dl>
                                <dt>WIR AKZEPTIEREN</dt>
            ...
            <div class="footer-bottom hidden-xs">
                <p>
                    <a href=""><img src="/assets/images/2016/card-N.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;© 2006-2016 CHOIES.COM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo LANGPATH;?>/privacy-security">DATENSCHUTZRICHTLINIE</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo LANGPATH;?>/conditions-of-use">AGB</a> 
                </p>
