			...
			<div class="container">
				<div class="crumbs">
					<div>
						...
						<a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > KONTOÜBERSICHT</a> > MEIN BLOG SHOW
					</div>
							...
							<div <?php echo $onshowed ? 'style="display:none;"' : 'style="display:block;"'; ?>>
								...
								<div class=" table-responsive">
									<table class="user-table">
										<tbody>
											<tr>
												<th width="20%">Show Nr.</th>
												<th width="40%">Produktinfo.</th>
												<th width="40%">Show Link</th>
											</tr>
							<?php
											...
											<tr>
												...
												<td>
													<div class="pr-info fix">
														...
														<div class="right">
														<p>Artikel# : <?php echo $data['sku']; ?></p>
														<p><?php echo Product::instance($product_id, LANGUAGE)->get('name'); ?></p>
														<p>
															Bestell-Nr:
															<a><?php echo $data['ordernum']; ?></a>
														</p>
														<input class="copy-link btn btn-primary btn-xs" type="button" value="Artikel kopieren Link" name="<?php echo Product::instance($product_id ,LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>">
													</div>
												</td>
												<td>
                                                ...
                                                <input type="hidden" name="sku" value="<?php echo $data['sku']; ?>" />
															...
															<input class="link-btn btn btn-primary btn-xs" type="submit" value="Senden">
														</form>
													</div>
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													<div class="pr-info fix">
														...
														<input class="copy-link btn btn-primary btn-xs" type="button"  name="<?php echo Product::instance($product_id ,LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Artikel kopieren Link" />
													</div>
												</td>
												<td>
													<div class="show-link">
                                                ...
                                                ?>
                                                        ...
                                                        ?>
																	...
																	<a style="text-decoration:underline;margin-left:10px;" class="link-cancel" href="#">ABBRECHEN</a>
																	<br>
																	<br>
																</form>
															</div>
															<input type="button" value="EDITIEREN" class="btn btn-default btn-xs link-edit" name="">
													</div>
												</td>
											</tr>
											<?php
                                ...
                                ?>
											<tr>
												...
												<td>
													<div class="pr-info fix">
														...
														<input class="copy-link btn btn-primary btn-xs" type="button" value="Artikel kopieren Link" name="<?php echo Product::instance($product_id ,LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Artikel kopieren Link">
														</div>
													</div>
												</td>
												<td>
										...
										<?php foreach ($urls as $url): ?>
                                                        ...
                                                        ?>
																	<br>
																	<div class="more"></div>
																	<a class="addMoreLink a-red">ine weitere Link hinzufügen</a>
																	<br>
																	<input type="submit" value="Senden" class="btn btn-primary btn-xs">
																	<a style="text-decoration:underline;margin-left:10px;" class="link-cancel" href="#">ABBRECHEN</a>
																	<br>
