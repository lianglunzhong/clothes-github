	...
	<div class="container">
		<div class="crumbs">
			<div>
				...
				<a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > KONTOÜBERSICHT</a> > Konto Einstellung
			</div>
			...
			<article class="user col-sm-9 col-xs-12">
				...
				<div class="row">
					...
					<form action="#" method="post" class="user-form form col-sm-8" id="accountSettings">
						<ul>
							<li>
								<label class="col-sm-3 col-xs-12"><span>*</span> E-Mail:</label>
							...
							<li>
								<label class="col-sm-3 col-xs-12">Geschlecht:</label>
								<div class="col-sm-9 col-xs-12">
									<span class="w-radio"><input type="radio" name="gender" value="1" id="radio1" <?php if ($customer['gender'] == 1) echo 'checked'; ?> /> Frau</span>
									<span class="w-radio"><input type="radio" name="gender" value="0" id="radio2" <?php if ($customer['gender'] == 0) echo 'checked'; ?> /> Mann</span>
									<span class="w-radio"><input type="radio" name="gender" value="2" id="radio3" <?php if ($customer['gender'] == 2) echo 'checked'; ?> /> Andere</span>
								</div>
							</li>
							<li>								

								<label class="col-sm-3 col-xs-12">Geburtsdatum:</label>
								<div class="col-sm-9 col-xs-12">
							...
							<li>
								...
								<div class="btn-grid12 col-sm-9 col-xs-12">
									<input type="submit" name="" value="Speichern" class="btn btn-primary btn-sm" />
								</div>
							</li>
						</ul>
					</form>
