        <div class="site-content">
			...
			<div id="homeBigBanner" class="flexslider topbanner hidden-xs">
				<ul class="slides">
                    ...
                    ?>
					<li><a href="<?php echo $link; ?>"><img src="<?php echo $banner_src; ?>"  alt="<?php echo $banner['title']; ?>" class="main_banner<?php echo $i;?>" /></a></li>
					<?php }?>
				</ul>
			...
			<div id="phoneBigBanner" class="flexslider topbanner hidden-sm hidden-md hidden-lg">
				<ul class="slides">
	                ...
	                ?>
					<li>
						<a href="<?php echo $link; ?>"><img class="main_banner<?php echo $i;?>" src="<?php echo $banner_src; ?>" alt="" /></a>
					</li>
					<?php }}?>
				</ul>
				<script type="text/javascript">
					...
					?>
								<li class="col-xs-6 col-sm-4">
									...
									<span><a href="<?php echo $banner['link'];?> "  class="pin_banner<?php echo $i;?>"><?php echo $banner['alt'];?></a></span>			
								</li>
					<?php 
							}
						}
								...
								<li class="hot col-xs-12 hidden-sm hidden-md hidden-lg">
									<table class="phone-hot" >
										<tbody>
											...
											<tr>
												<td class="col-xs-6">
													<a href="">The Choies Galaxy ›</a>
												</td>
												<td class="col-xs-6">
													<a href="/outlet-c-101">Sale ›</a>
												</td>
											</tr>
										</tbody>
									</table>
            ...
            ?>
					<div class="n-ad hidden-xs">
						...
						if(isset($newindex_banners))
						{
	                        ...
	                        {
	                        ?>
	                           <a href="<?php echo $newindex_banners[6]['link']; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo $newindex_banners[6]['image']; ?>" class="central_banner"></a>
	                        <?php
	                        }
	                    }
                        ?>
					...
					<div class="arrivals hidden-xs">
						...
						if(isset($newindex_banners))
						{
	                        ...
	                        {
	                        ?>
	                           <a class="arr-pic" href="<?php echo $newindex_banners[7]['link']; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo $newindex_banners[7]['image']; ?>" class="newarrival_banner"></a>
	                        <?php
	                        }
	                    }
                        ?>
						...
						if(isset($totalindex3['link']))
						{
							...
							{ 
								...
								$pro_instance = Product::instance($proid);
								...
								?>
								<li class="col-xs-2">
									<a href="<?php echo $plink; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex3['imgsrc'][$keys]) ? $totalindex3['imgsrc'][$keys] : ''; ?>" class="new_banner<?php echo $j;?>"></a>
					...
					<div class="follow-us hidden-xs">
						...
						if(isset($newindex_banners))
						{
	                        ...
	                        {
	                        ?>
	                           <a class="flo-pic" href="<?php echo $newindex_banners[8]['link']; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo $newindex_banners[8]['image']; ?>" class="instagram_banner"></a>
	                        <?php
	                        }
	                    }
                        ?>
						<ul>
							<li class="col-xs-4">
								<a class="col-xs-12" href="<?php echo isset($totalindex2['link'][0]) ? $totalindex2['link'][0] : ''; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex2['imgsrc'][0]) ? $totalindex2['imgsrc'][0] : ''; ?>" class="ins_banner1"></a>
								<a class="col-xs-6" href="<?php echo isset($totalindex2['link'][1]) ? $totalindex2['link'][1] : ''; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex2['imgsrc'][1]) ? $totalindex2['imgsrc'][1] : ''; ?>" class="ins_banner2"></a>
								<a class="col-xs-6" href="<?php echo isset($totalindex2['link'][2]) ? $totalindex2['link'][2] : ''; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex2['imgsrc'][2]) ? $totalindex2['imgsrc'][2] : ''; ?>" class="ins_banner3"></a>
							</li>
							<li class="col-xs-4">
							<?php 
							if(isset($totalindex3['link']))
							{
								foreach($totalindex2['link'] as $key => $values)
								{
										...
										{
								 ?>
									<a class="col-xs-6" href="<?php echo isset($totalindex2['link'][$key]) ? $totalindex2['link'][$key] : ''; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex2['imgsrc'][$key]) ? $totalindex2['imgsrc'][$key] : ''; ?>" class="ins_banner<?php echo $key+1;?>"></a>
								<?php 
									   }
								}
							}
							...
							<li class="col-xs-4">
								<a class="col-xs-6" href="<?php echo isset($totalindex2['link'][9]) ? $totalindex2['link'][9] : ''; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex2['imgsrc'][9]) ? $totalindex2['imgsrc'][9] : ''; ?>" class="ins_banner10"></a>
								<a class="col-xs-6" href="<?php echo isset($totalindex2['link'][10]) ? $totalindex2['link'][10] : ''; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex2['imgsrc'][10]) ? $totalindex2['imgsrc'][10] : ''; ?>" class="ins_banner11"></a>
								<a class="col-xs-12" href="<?php echo isset($totalindex2['link'][11]) ? $totalindex2['link'][11] : ''; ?>"><img src="<?php echo STATICURL;?>/simages/<?php echo isset($totalindex2['imgsrc'][11]) ? $totalindex2['imgsrc'][11] : ''; ?>" class="ins_banner12"></a>
							</li>
						</ul>
					</div>
            <?php
							...
							<?php 
								...
								if(!empty($indexsku))
								{
									foreach ($indexsku as $key => $value) 
									{
			                        	...
			                        	$plink1 = Product::instance($proid1)->permalink();
										$k = $key + 1;
