        ...
        <div class="container">
            <div class="crumbs">
                <div class="fll">
                    ...
                    &gt;<span>Search : <strong><?php echo $keywords; ?></strong></span>
                </div>
            </div>
            <div class="list-main">
                    ...
                    <ul class="bar-r">
                        <li class=" item-r pick">
                            ...
                            if (!empty($gets1))
                            {
                                ...
                                $gets1[] = 'pick=1';
                            ?>
                            <a href="<?php echo '?' . Security::xss_clean(implode('&', $gets1)); ?>" class=""> Icon's Pick</a>
                        </li>
                ...
                <div class="pro-list">
                    ...
                    foreach ($products as $i => $product_id)
                    {
                        ...
                        $product_inf = Product::instance($product_id);
                        ...
                        ?>
                            <li class="pro-item col-xs-6 col-sm-3">
                                ...
                                <?php if ($product_inf->get('type') != 0): ?>
                                    <a href="#" id="<?php echo $product_id; ?>" class="quick_view btn-qv" attr-lang="<?php echo LANGUAGE; ?>" data-reveal-id="myModal">Quick View</a>
                                <?php endif; ?>
                                <div class="add-wish">
                                ...
                                {
                                    echo '<i class="icon-rshipped" id="mark_'.$product_id.'"></i>';
                                }
                                else
                                {
                ...
                <div class="notfound">
                    ...
                    <div class="searchon-wp">
                        <div class="searchon-404">
                            <p class="font24"><strong>Sorry!</strong> The item you are searching for has not been found,<br />
                                or your target page is updating at the moment...</p>
                            <p><a href="<?php echo LANGPATH; ?>/contact-us" class="bottom">Special Request? Contact Us!</a></p>
                        </div>
                    </div>
