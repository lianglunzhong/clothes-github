		...
		<section id="main">
			...
			<div class="container">
				<!-- crumbs -->
				<div class="crumbs">
						<a href="/">home</a> > singles day sale
				</div>
				<!-- -->
                <div class="sale-filter">
					<img src="/assets/images/11-11-en-2.jpg">
				</div>
				<div class="nov-box">
					...
					function acceptpc(obj){
						...
						$.post('/activity/singles_day_sale', {data_id:data_id}, function(re){
							var strVar = "";
							$.each(re,function(i,item){
								...
								strVar += "<span class=\"mr5\">Original Price: <del>"+item.orig_price+"<\/del><\/span>    <span style=\"display:none\">Sale Price: "+item.price+"<\/span>";
								strVar += "<\/div>";
						...
						<?php foreach ($data as $v){?>
							<li class="pro-item col-xs-6 col-sm-3">
								...
								<div class="original-sale mt5">
									 <span class="mr5">Original Price: <del><?php echo $v['orig_price'];?></del></span>    <span style="display:none">Sale Price: <?php echo $v['price'];?></span>
								</div>
