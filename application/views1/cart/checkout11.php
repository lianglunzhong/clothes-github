                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-8 col-md-8">
                            <a href="/<?php echo LANGPATH;?>" class="logo" style="margin-top:0px;"></a>
                            <h2 class="logo-checkout">Checkout</h2>
                        </div>
                        <div class="col-xs-4 col-md-4">
                            <a href="https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf/splash.fdf&amp;dn=www.choies.com&amp;lang=en" target="_blank"><img src="/assets/images/card-pay.png"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="main-container clearfix">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div  class="lay-one order-info pt5">
                                <div class="lay-title">
                                    <h2>
                                        <i class="on">1</i>Order Information<a href="<?php echo LANGPATH;?>/cart/view" class="flr a-back">Back To My Bag</a>
                                        <p class="hidden-xs">Order Total:
                                        ...
                                        <a class="flr JS_click drop-down-hd">Order Details<i class="fa fa-caret-down ml5"></i></a></p>
                                        <p class="col-xs-12 hidden-sm hidden-md hidden-lg">Order Total:<span class="red" style="font-size:16px;" id="totalsum1"><?php echo $cart['amount']['shipping'] ? Site::instance()->price($cart['amount']['total']+ $insurance, 'code_view') : Site::instance()->price($cart['amount']['total'] + $default_shipping + $insurance, 'code_view'); ?></span><a class="flr JS_click drop-down-hd">Order Details<i class="fa fa-caret-down ml5"></i></a></p>
                                    </h2>
                                                ...
                                                <td width="60%">
                                                    <div class="clearfix">
                                                        ...
                                                        <div class="right">
                                                            ...
                                                            <p class="hidden-sm hidden-md hidden-lg">Qty.: <?php echo $product['quantity']; ?></p>
                                                            <p class="hidden-sm hidden-md hidden-lg">Price:<?php echo Site::instance()->price($product['price'], 'code_view'); ?></p>
                                                            
                                                        </div>
                                                    </div>
                                                </td>
                                                <td width="20%" class="hidden-xs">
                                                    <label>Qty.: </label><?php echo $product['quantity']; ?>
                                                </td>
                                                <td width="20%" class="hidden-xs">
                        ...
                        ?> 
                                    ...
                                    <!-- pc coupon -->
                                        ...
                                        <label class="fll mt5">Use Promo Code :</label>
                                        <input class="form-control form-payment fll hidden-xs" type="text" id="coupon_code1" name="coupon_code">
                                        <input class="btn btn-sm btn-default fll ml10 hidden-xs fll" style="margin-top:2px;" type="submit" value="Apply">
                                        </form>
                                 <!-- end coupon -->
                                        ...
                                        <input class="btn btn-xs btn-default fll ml10" style="margin-top:2px;" type="submit" id="onclickcoupon" value="Apply"></span>
                                        
                                        <!-- end phone -->

                                        <p class="fll p p-second hidden-xs"> 
                                     <strong>Subtotal:</strong><?php echo Site::instance()->price($cart['amount']['items'], 'code_view'); ?>
                                         + Promo Code:<span class="red" id="coupon_save_pc">-<?php echo Site::instance()->price($cart['amount']['coupon_save'], 'code_view'); ?> </span> 
                                        ...
                                        <?php } ?>
                                          ...
                                          + Shipping Insurance:<span id="oi_insurance_pc"><?php if($_SESSION['insurance'] != -1){
                ...
                ?>
                            ...
                            <div id="shippingnew" class="lay-title <?php if($has_address){ echo 'hide'; }?>">
                                <h2><i class="off">2</i>Address Information</h2>
                            </div>
                            <!-- new user begin -->
                                            ...
                                            <h4>Shipping Address</h4>
                                                <div class="form-group form-name clearfix">
                                                    <div class=" is-empty form-name-div floatLabel">
                                                        ...
                                                        <div class="floatlabel-text">First Name</div>
                                                    </div>
    ...
    <div class="floatlabel-text">Address Line 2(Optional)</div>
                                        ...
                                        ?>
                                                    ...
                                                    <div class="is-empty form-name-div floatLabel second call1" id="all1_default" >
                                                        ...
                                                        <div class="floatlabel-text">Enter a State</div>
                                                ...
                                                <div class="form-group form-name clearfix">
                                                    <div class=" is-empty form-name-div floatLabel">
                                                        ...
                                                        <div class="floatlabel-text">City / Town </div>
                                                        <label class="error a4" style="display:none;" generated="true" id="guo_eon1">City / Town Name with digits? Please check the accuracy.</label>
                                                    </div>

                                                    <div class=" is-empty form-name-div floatLabel second">
                                                        <input type="text" class="form-control" name="zip" id="s_zip" style="width:100%;" onchange="ace()">
                                                        <div class="floatlabel-text">Zip Code</div>
                                                        <p class="phone_tips">Plz enter 0000 instead if there's no zip code.</p>
                                                ...
                                                <div class="form-group  is-empty floatLabel">
                                                    ...
                                                    <div class="floatlabel-text">Phone Number</div>
                                                </div>
                                        </div>
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                    <label style="font-weight:normal; display:block;"><input  type="checkbox" id="billaddress2" checked="checked" style="margin:4px 10px 0 0;">Save as my billing address.</label>
                                        ...
                                        <div calss="col-xs-12 ">
                                            <input id="spgInfoCountinue" type="submit" class="btn btn-primary btn-md flr " value="CONTINUE">
                                        </div>  
                                    </form>               
                                </div>
                            ...
                            <div class="lay-title">
                                <h2><i class="on">2</i>Address Information</h2>
                        <?php
                        $cart_shipping = !empty($cart['shipping']) ? $cart['shipping']['price'] : -1;
                        ...
                        ?>
                            ...
                            <div  class="lay-one <?php if(!$has_address){ echo 'hide'; }?>" id="shippingAddressAdd">
                                <div class="lay-title">
                                                ...
                                                <?php  if ($cart['shipping_address']['shipping_address_id'] == $value['id'])
                                                   ...
                                                   <?php   }else{  ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td width="10%"><a style="text-decoration:underline;" data-reveal-id="myModal6" onclick="delete_address(<?php echo $value['id']; ?>);" href="javascript:;"><i>Delete</i></a></td>
                                                    </tr>
                                                </table>
                                            </li>
                                    <?php
                                    ...
                                    ?>
                                            <li>
                                                <span><a class="a-underline js-add" href="javascript:;" id="add_new_address" data-reveal-id="myModal10-1" onclick="return new_address_show();"><strong>+  Add  New Address</strong></a></span>
                                            </li>
                                        </ul>
                                    ...
                                    ?>
                                            <li class="mb20"  id="m_address_li_<?php echo $value['id']; ?>">
                                                <table class="shopping-table address-option-list" width="100%">
                                                    ...
                                                    {
                                                        ?>
                                                            <a style="text-decoration:underline;"href="javascript:;" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);"><i>Set As Defalut</i></a>
                                                    <?php
                                                    }
                                                    ?>
                                                            <a style="text-decoration:underline;"data-reveal-id="myModal10-1" onclick="edit_address(<?php echo $value['id']; ?>, 1);" href="javascript:;"><i>Edit</i></a><a style="text-decoration:underline;"data-reveal-id="myModal6" onclick="delete_address(<?php echo $value['id']; ?>);" href="javascript:;"><i>Delete</i></a></p>
                                                        </td> 
                                                    </tr>
                                                </table>
                                            </li>
                                        ...
                                        <div calss="col-sm-12">
                                            <input type="submit" class="btn btn-primary btn-md flr mt20" value="CONTINUE" onclick="return showaddress()">
                                        </div>
                       ...
                       $default_shipping = 0;
                        ...
                        foreach ($site_shipping as $key => $price)
                        {
                            ...
                            if($key == 1 && $cart_shipping == 7){
                                ...
                                <h2 id="<?php echo $cart_shipping;?>"><i class="on" id="<?php echo $default_shipping;?>">3</i>Shipping Method</h2>
                ...
                { ?>
                        <span <?php if ($price['price'] != $default_shipping){
                            ...
                            <?php echo $price['name']; ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $price['days']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Site::instance()->price($price['price'], 'code_view'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </div>
                            <span id="click1" style="float:left;">Shipping Insurance&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Site::instance()->price(0.99, 'code_view'); ?></span>
                        </span>
                <?php
                    }
                    ?>
                ...
                { ?>
                            ...
                            echo 'class="hide"';
                                    ...
                                    <p id="shipping1"><?php echo $price['name']; ?></p><p id="shipping2"><?php echo $price['days']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Site::instance()->price($price['price'], 'code_view');?></p><p id="shipping3">Shipping Insurance&nbsp;&nbsp;&nbsp;&nbsp;$0.99</p>
                                </span>
                                  <?php
				}
                    ?>
                            ...
                            <input type="hidden" id="shipping_price" value="<?php echo $default_shipping; ?>" name="shipping_price" />
                                <h2><i class="off">3</i>Shipping Method</h2>
                                <div class="information-box primaryinfo-block clearfix">
                                    <ul>
                <?php
                foreach ($site_shipping as $key => $price)
                        ...
                        <?php
                          ...
                          /*  }*/
                            ?>
                                            ...
                                            <table class="shopping-table shipping-list" width="100%">
                                                <tr>
                                                    <td width="75%" class="method" style="color:#a9a9a9;"><input type="checkbox" value="1" name="insurance_pc" id="insurance_pc" <?php if($_SESSION['insurance'] != -1){ echo 'checked'; } ?>> 
                                                     Add Shipping insurance for Your Order                            
                                                       <div class="JS-show add-s-fa" id="showshipping">
                                                            ...
                                                            <div class="ins-info JS-showcon" id="hideshipping" style="display: none;" >
                                                                <b class="arrow-up"></b>
                                                                <div class="ins-tipscon">Shipping Insurance offers superior&nbsp;protection and safety for your valuable items during international delivery. We'll reship your parcel immediately at no extra charge if it's reported lost or damaged.
                                                                </div>
                                                            </div>
                                                        </div>
                                                     </td>
                                    ...
                                    <div calss="col-sm-12">
                                        <button type="button" class="btn btn-primary btn-md flr mb20" onclick="return edit_address3()">Continue</button>
                                    </div>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="lay-title">
                                    ...
                                    <div class="information-box payment-information primaryinfo-block clearfix">
                                        ...
                                        <div class="pay-paypal" id="paypaldiv">
                                            <p>PayPal is a secure and trusted payment method for online shopping.If you don’t have a Paypal account, you can also pay via Paypal with your credit card or bank debit card.</p>
                                        ...
                                        <div class="hide pay-credit">
                                            <div class="form-group">
                                                ...
                                                <div class="clearfix" >
                                                    <select name="card_type" class="form-control sm-width col-sm-12 col-md-6 mr10" id="card_select" onchange="select_ch()">
                                                         <option selected="selected" value="0">Please choose card type</option>
                                                ...
                                                <div class="error red hide" id="card_error1">Please choose your credit card type.</div> 
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="error red hide" id="card_error">The credit card number is incorrect.</div>
                                            </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="error hide red" id="expire_error">The month of expiry date is incorrect.</div>  
                                            </div>
                                            <div class="col-sm-12 col-md-9 form-group " >
                                                <label>* Security Code (CVV/CVC):<i class="fa fa-question-circle"></i></label>
                                                ...
                                                <div class="error red hide" id="cvv_error">Please enter a 3-digit CVV/CVC Code.</div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <input type="hidden" name="paytype" id="paytype" value="" />
                                        <div class="form-group mt20">
                                         <input type="submit" id="checkoutbtn" class="btn btn-primary btn-md" value="PROCEED TO CHECKOUT" onclick="return btn_loading();" />
                                            <input type="button" id="checkoutbtn1" class="btn btn-primary btn-md" value="PROCEED TO CHECKOUT" onclick="return btn_loading();"  style="display:none;"  />
                                            <button type="button" id="loadingbtn" disabled="disabled"  class="btn btn-primary btn-md" style="display:none;">PROCEED TO CHECKOUT</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div  class="lay-one lay-disable" id="type3disabled" style="display:bolck;">
                                <div class="lay-title">
                                    <h2><i class="disable">3</i>Shipping Method</h2>
                                </div>
                            </div>
                            <div  class="lay-one lay-disable mb20" id="type4disabled" style="display:bolck;">
                                <div class="lay-title">
                                    <h2><i class="disable">4</i>Payment</h2>
                                </div>
                            </div>
...
<div  id="myModal10-1" class="primaryinfo primaryinfo-block clearfix  reveal-modal large" style="padding:30px 10px">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <h4>Shipping Address</h4>
                                                <div class="form-group form-name clearfix">
                                                    <div class=" is-empty form-name-div floatLabel"><label>First Name</label>
                                                        <input type="text" class="form-control" name="firstname"  id="shipping_firstname" style="width:100%;" value="" kai="kai">
                                                    </div>
                                                    <div class=" is-empty form-name-div floatLabel second" ><label>Last Name</label>
                                                        <input type="text" class="form-control" name="lastname"  id="shipping_lastname" style="width:100%;" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group is-empty floatLabel"><label>Address</label>
                                        ...
                                        foreach ($stateArr as $country => $states)
                                        {
                                            ...
                                            ?>
                                            <div class="all2" id="all2_<?php echo $country; ?>" style="display:none;"><label>State</label>
                                        ...
                                        ?>
                                                   ...
                                                   <div class="is-empty form-name-div floatLabel second call2" id="all2_default" ><label id="ace">State</label>
...
/*                                                var ooo = $("#guo_con");
                                            ...
                                            $(function(){
                                                ...
                                                <div class="form-group form-name clearfix">
                                                    <div class=" is-empty form-name-div floatLabel"><label>City</label>
                                                        ...
                                                        <label class="error a4" style="display:none;"  generated="true" id="guo_eon">City / Town Name with digits? Please check the accuracy.</label>
                                                    </div>

                                                    <div class=" is-empty form-name-div floatLabel second"><label>Zip</label>
                                                        ...
                                                        <p class="phone_tips">Plz enter 0000 instead if there's no zip code.</p>
                                                        <label class="error" style="display:none;" generated="true" id="guo_fon520">It seems that there are no digits in your code, please check the accuracy.</label>
                                                    </div>
                                                </div>
                                                <div class="form-group  is-empty floatLabel"><label>Phone</label>
                                                ...
                                                <div class="form-group hide" value="0">
                                                    ...
                                                    <div class="floatlabel-text">o cadastro de pessoa Física</div>
                                                </div>
                                        </div>
                                        <div class="col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                    <label style="font-weight:normal; display:block;"><input name="" type="checkbox" value="" checked="checked" style="margin:4px 10px 0 0;">Make this my default shipping  address.</label>
                                                    <label style="font-weight:normal; display:block;"><input type="checkbox" style="margin:4px 10px 0 0;" value="" checked="checked" name="" id="billaddress1">Save as my billing address.</label>
                                        ...
                                        <div calss="col-xs-12 ">
                                            <input type="submit" class="btn btn-primary btn-md flr " value="Continue">
                                        </div>  
                                    </form>               
                                </div>
    <!-- JS-popwincon2 -->
            ...
            <div class="shipping-methods">
                <ul class="clearfix">
                    <li class="col-xs-12 col-md-6">
                        ...
                        <span>10-15 Working Day Shipping ( $0.00 )</span>
                    </li>
                    <li class="col-xs-12 col-md-6">
                        <input type="radio" name="" id="" class="radio"> 
                        <span>4-7 Working Day Shipping ( $15.00 )</span>
                    </li>
                    
                </ul>
                <p><input type="submit" value="Continue" class="btn btn-default"></p>
            </div>
        </form>
    </div>
    <!-- JS-popwincon3 -->
...
<div id="myModal6" class="reveal-modal medium" id="cart_delete">
    ...
    <div class="order-addtobag">
        <div class="prompt">Are you sure you want to delete this address?</div>
...
<div class="loading" id="payment_wrap2" style="display:none;">
    <div class="loading-box">
        ...
        <div class="loading-prompt">Loading, please wait for a moment!</div>
        </div>
    </div>
</div>
...
/*                 document.getElementById('totalPrice').innerHTML = res.total;
                 ...
                 document.getElementById('shipping3').innerHTML ="Shipping Insurance&nbsp;&nbsp;"+res.insurance;
...
/*            document.getElementById('shipping_price_list').innerHTML = '';
			...
			if(res.val==15){
				$("#shipping2").html("4-7&nbsp;&nbsp;working day &nbsp;&nbsp;&nbsp;&nbsp;"+ res.price);
				$("#totalsum").html(res.total);
				$("#totalsum1").html(res.total);
				
			}else{
				$("#shipping2").html("10-15&nbsp;&nbsp;working day &nbsp;&nbsp;&nbsp;&nbsp;"+ res.price);
				$("#totalsum1").html(res.total);
				$("#totalsum").html(res.total);
        ...
        $.ajax({
            ...
            success: function(result){
                if(result.success == 1){
                    ...
                    var shipping_address_list = '<dt>Shipping Address  <a data-reveal-id="myModal10-1" onclick="return edit_address('+result.address_id+');">Edit</a>'+change+'</dt>'+
...
function ace(){
    ...
    var reg = new RegExp("[\\u4E00-\\u9FFF]+","g");
        ...
        $("#guo_fon520").show();
        $("#guo_fon520").html("It seems that there are no digits in your code, please check the accuracy.");
    }else{
        $("#guo_fon520").hide();
    }
...
/*    $(".radio-option-list li").eq(1).click(function(){
   ...
   $("input[type='radio']").click(function(){
    ...
    if(id=='sprice_radios1'){
        $("#kai").html('Economic Shipping  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;10-15 Days&nbsp;&nbsp;&nbsp;&nbsp;$0.00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
    }else if(id=='sprice_radios2'){
        $("#kai").html('Express Shipping  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4-7 Days&nbsp;&nbsp;&nbsp;&nbsp;$15.00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
    }
   });
...
function checkFormData()
{
    ...
    if(card_select.value == 0){
        $popup_message = document.getElementById('card_error1');
        $popup_message.innerHTML = 'Please choose your credit card type.';
        $popup_message.style.display = 'block';
        error = 1;
    }   
    ...
    if(cardNo.length == 0)
    {
        ...
        $popup_message.innerHTML = 'Please enter card number.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(month == 0)
    {
        ...
        $popup_message.innerHTML = 'Please select expiration date.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    { 
        $popup_message = document.getElementById('expire_error');
        $popup_message.innerHTML = 'Expiration date is invalid.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(cvv2.length != 3 || reg.test(cvv2) != true)
    {
        ...
        $popup_message.innerHTML = 'Please enter a 3-digit CVV/CVC Code.';
        $popup_message.style.display = 'block';
        error = 1;
    }
