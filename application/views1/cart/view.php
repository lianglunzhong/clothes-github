            ...
            <div class="cart cart-view">
                ...
                if (!$count)
                {
                    ...
                    <?php if($save_show){ ?>
                        ...
                        <p>
                            View items already in your <a href="/customer/wishlist" class="a-underline">wishlist</a>&nbsp;or&nbsp;<a href="/ready-to-be-shipped-c-395" class="a-underline">continue shopping</a>.
                        </p>
                    <?php }else{ ?>
                        <p>There are no items in your shopping bag.</p>
                        <p>
                           If you have an account with us, please <a href="/customer/login?redirect=/cart/view" class="a-underline">SIGN IN</a> to see items you previously added.
                        </p>
                    <?php } ?>
                    </div>
                    ...
                    <?php if(count($cartcookie)>0){ ?>
                        <div class="saved-items">
                            <div class="title">
                                <strong>Your Saved Items</strong>
                            </div> 
                                        ...
                                        <td>
                                            <div class="clearfix">
                                                ...
                                                <div class="right">
                                                    ...
                                                    <p class="item">Item: #<?php echo $csku; ?></p>
                                                    <p class="delete"><!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a-underline">Save to Wishlist</a-->
                                                        <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $value['id'].'_'.$value['attributes']['Size_value'];?>" class="a-underline fll"  onclick="if(!confirm('Are you sure you want to delete this item?')){return false;}">Delete</a><span style="margin:3px 10px;float:left">|</span>
                                                        <a href="<?php echo LANGPATH; ?>/cart/cookie2cart/<?php echo $value['id'].'_'.$value['attributes']['Size_value'];?>" class="a-underline fll green">Add To Cart</a>
                                                    </p>
                                                </div> 
                                            </div>
                                        </td>
                                      ...
                                      <td>
                                        <div class="clearfix">
                                          ...
                                          <div class="right">
                                            ...
                                            <p class="gray">Item: #<?php echo $csku; ?><span class="red font11 ml5">out of stock</span></p>
                                            <p class="bottom"><!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a-underline">Save to Wishlist</a-->
                                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $value['id'].'_'.$value['attributes']['Size_value'];?>" class="a-underline">Delete</a></p>
                                          </div>
                                        </div>
                                      </td>
                                      <td>
                                        ...
                                        <td>
                                            <div class="clearfix">
                                                ...
                                                <div class="right">
                                                    ...
                                                    <p class="item">
                                                        Item: #<?php echo $psave['sku']; ?> <?php if(!$psave['stock']): ?><span class="red">out of stock</span><?php endif; ?>
                                                    </p>
                                                    <p>
                                                        <b>
                                                    ...
                                                    <p></p>
                                                    <p class="delete">
                                                        <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $psave['id'].'_'.$psave['size'];?>" class="a-underline fll">Delete</a>
                                                        ...
                                                        if($psave['stock'])
                                                        {
                                                            ...
                                                            <a href="<?php echo LANGPATH; ?>/cart/cookie2cart/<?php echo $psave['id'].'_'.$psave['size'];?>" class="a-underline fll green">Add To Cart</a>
                                                            <?php
                                                        }
                                                        ?>
                                                    </p>
                ...
                else
                {
                    ...
                    <div class="clearfix cart-accept">
                        <div class="fll">
                            <strong>SHOPPING BAG</strong>
                            <span class="show">We accept:<img src="<?php echo STATICURL; ?>/assets/images/shopping-bag-accept-0509.png" usemap="#Shopping"></span>
                        ...
                        <a href="/cart/checkout" class="flr btn btn-primary btn-lg">
                            Proceed to checkout
                        </a>
                    </div>
                    <div class="phone-tb">
                    ...
                    <div class="shopping-bag">
                        <table class="shopping-table pc-tb" width="100%" id="shopping_bag">
                                ...
                                <tr>
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="right">
                                                ...
                                                <p class="item">Item: #<?php echo $sku; ?></p>
                                                <p class="delete">
                                                    <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $product['id'].'_'.$product['attributes']['Size_value'];?>" class="a-underline fll"  onclick="if(!confirm('Are you sure you want to delete this item?')){return false;}">Delete</a><span style="margin:3px 10px;float:left">|</span>
                                                    <?php if($save_show){
                                                    if(1){ ?>
                                                    <a href="/cart/cookie2later/<?php echo $product['id'].'_'.$product['attributes']['Size_value'];?>" class="a-underline fll green">Save for Later</a>
                                                    <?php
                                                    } }else{ ?>
                                                    <a id="sign_in" class="a-underline fll green" href="/customer/login?redirect=/cart/view">Save for Later</a>
                                                    <?php } ?>
                                                </p>
                                                <div style="clear:both"></div>
                                                <?php if(0){?>
                                                <div style="color:red">
                                                    Shop now! The gift will stay here for only 24 hours!
                                                </div> 
                                                <?php }?>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        ...
                                        <ul class="cart-option">
                                            ...
                                            <?php if(1){?>
                                            <li>
                                                <a class="btn btn-default btn-xs change_detail">Change Details</a>
                                            </li>
                                            <?php } ?>
                                        </ul>
                                    </td>
                            ...
                            if (isset($cart['largesses']) AND !$celebrity_avoid)
                            {
                                ...
                                {
                                    $l_link = Product::instance($largess['id'])->permalink();
                                    $l_name = Product::instance($largess['id'])->get('name');
                                            ...
                                            <?php        }
                                                ...
                                                <form action="/cart/product_edit" method="post" class="hide">
                                                    ...
                                                    <ul class="cart-option">
                                                        ...
                                                        {
                                                            ?>
                                                            <li class="red">only <span><?php echo $phone['stock']; ?></span> left</li>
                                                            <?php
                                                        }
                                                        ?>
                                                        <li>
                                                ...
                                                <p></p>
                                                <p class="delete">
                                                    <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $phone['id'].'_'.$phone['size_value'];?>" class="a-underline fll"  onclick="if(!confirm('Are you sure you want to delete this item?')){return false;}">Delete</a><span style="margin:3px 10px;float:left">|</span>
                                                    <?php if($save_show){ if(1){ ?>
                                                    <a href="/cart/cookie2later/<?php echo $phone['id'].'_'.$phone['size_value'];?>" class="a-underline fll green">Save for Later</a>
                                                    <?php } }else{ ?>
                                                    <a id="sign_in" class="a-underline fll green" href="/customer/login?redirect=/cart/view">Save for Later</a>
                                                    <?php } ?>
                                                </p>
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <?php        }
                                                ...
                                                <p></p>
                                                <p class="delete"><a href="<?php echo LANGPATH; ?>/cart/largess_delete/<?php echo $phone['key']; ?>" class="a-underline">Delete</a></p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        if (!empty($cart['largesses_for_choosing']) AND !$celebrity_avoid)
                        {
                                    ...
                                    foreach ($largesses_for_choosing['largesses'] as $key => $largesses_for_choosing_product)
                                    {
                                        ...
                                        <form method="POST" action="<?php echo LANGPATH; ?>/cart/largess_add">
                                            <tr>
                                                <td width="50%">
                                                    <div class="clearfix">
                                                        ...
                                                        <div class="right">
                                                            ...
                                                            <p class="item">Item: #<?php echo Product::instance($key)->get('sku'); ?></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td width="15%">
                                                ...
                                                <td width="15%"><input type="submit" value="Take This Offer" class="btn btn-default btn-xs" /></td>
                                            </tr>
                                        </form>
                                        <?php
                                    }
                            ...
                            <table class="shopping-table phone-tb" width="100%" style="background:#fafafa;">
                                    <tr >
                                        <td style="padding:0 0 0 15px;font-weight:bold;">Special Offers</td>
                                    </tr>
                                    <tr >
                                        ...
                                        <td style="padding: 10px 0px">
                                            <div class="clearfix">
                                                ...
                                                <ul class="cart-option">
                                                    ...
                                                    <p class="delete">
                                                        <input type="submit" class="btn btn-default btn-xs" value="Take This Offer">
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <ul class="shopping-total">
                            <li class="first" style="padding-left:10px;">
                                ...
                                <?php }elseif((int)$cart['amount']['items'] == 0){ ?>
                                    <p style="color:black"><b>Add "Free Shipping" item to enjoy free shipping.<b></p>
                                <?php }?>


                                <a href="<?php echo $catalog_link; ?>" class="a-underline"><< Continue Shopping</a>
                            </li>
                            ...
                            ?>
                                <p class="hidden-xs">Add <span><?php echo Site::instance()->price($add_price,'code_view');?></span> of items to enjoy <span>FREE STANDARD SHIPPING</span><b></b>. </p>
                            <?php
                            }
                            elseif($cart['amount']['items'] >=15 && $cart['amount']['items'] < 79 && $customer_id)
                            {
                                $country = Customer::instance($customer_id)->get('country');
                                $no_express_countries = kohana::config('shipment.no-express');
                                $add_price=79-$cart['amount']['items'];
                                if(!in_array($country,$no_express_countries) && !empty($country))
                                {
                                    $islarge = 1;
                            ?>
                                <p class="hidden-xs">Add <span><?php echo Site::instance()->price($add_price,'code_view');?></span> of items to enjoy <span>FREE EXPRESS SHIPPING</span><b></b>. </p>
                            <?php
                                }
                            }
                            ?>
							...
							<li class="cart-phone-tip hidden-sm hidden-md hidden-lg">
					            	<p>Add <span class="red"><?php echo Site::instance()->price($add_price,'code_view');?></span> of items to enjoy <span class="red">free</span> standard shipping.</p>
							</li>
							<?php
                            }
                            elseif(isset($islarge) && $cart['amount']['items'] >=15 && $cart['amount']['items'] < 79)
                            {
                                $add_price=79-$cart['amount']['items'];
                            ?> 
                            <li class="cart-phone-tip hidden-sm hidden-md hidden-lg"> 
                                <p>Add <span class="red"><?php echo Site::instance()->price($add_price,'code_view');?></span> of items to enjoy <span class="red">FREE EXPRESS SHIPPING</span><b></b>. </p>
                            </li>
                            <?php
                            }
                            ?>
                        ...
                        <?php    if((int)$cart['amount']['items'] == 0){ ?>
                                    <div class="visible-xs-block  mb10 mr20 ml20">
                                        <em>Add "Free Shipping" item to enjoy free shipping.</em>
                                    </div>
                        <?php } ?>
                                <a href="<?php echo LANGPATH; ?>/cart/checkout" class="btn btn-primary btn-lg">Proceed to checkout</a>
                            </li>
                        ...
                        <?php if($customer_id = Customer::logged_in()){ ?>
                                <div><b class="red">TIP!</b> Just Checkout to Use Your Points & Coupons.</div>
                        <?php }else{ ?>
                                <div><b class="red">TIP!</b> Sign In to Use Your Points & Coupons.</div>
                        <?php } ?>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="clearfix">
                                  ...
                                  <div class="right">
                                    ...
                                    <p class="delete">
                                        ...
                                        <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $value['id'].'_'.$value['attributes']['Size_value'];?>" onclick="if(!confirm('Are you sure you want to delete this item?')){return false;}" class="a-underline fll" >Delete</a>
                            ...
                            <tr class="stock">
                              <td>
                                <div class="clearfix">
                                  ...
                                  <div class="right">
                                    <a href="<?php echo $cookie_link; ?>" class="name"><?php echo $cname; ?></a>
                                    <p class="item">Item: #<?php echo $csku; ?><span class="red font11 ml5">out of stock</span></p>
                                    <p class="delete">
                                        <!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a-underline">Save to Wishlist</a-->
                                        <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $value['id'].'_'.$value['attributes']['Size_value'];?>" class="a-underline fll">Delete</a>
                                    </p>
                                  </div>
                                </div>
                              </td>
                        ...
                        <table class="shopping-table phone-tb" width="100%">
                            ...
                            ?>
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="right">
                                                ...
                                                <p></p>
                                                <p class="delete">
                                                    <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $psave['id'].'_'.$psave['size_value'];?>" class="a-underline fll">Delete</a>
                                                    <?php
                                if ($psave['visibility'] AND $psave['status'] AND $psave['stock'])
                                {
                                                        ...
                                                        ?>
                                                        <span class="v-line">|</span>
                                                        <a href="<?php echo LANGPATH; ?>/cart/cookie2cart/<?php echo $psave['id'].'_'.$psave['size_value'];?>" class="a-underline fll green">Add To Cart</a>
                                                        <?php
                                                    }
                                                    ?>
                                                </p>
        ...
        <div class="right col-sm-6 col-xs-12">
            ...
            <form action="#" method="post" class="signup-form sign-form form" id="form_register">
                <ul>
                    ...
                    <li><input type="submit" value="Sign Up" name="submit" class="btn btn-primary btn-lg mr10" /></li>
                </ul>
            </form>
        </div>
    </div>
