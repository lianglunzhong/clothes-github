        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="step-nav">
                        <ul class="clearfix">
                            <li class="current">Place Order<em></em><i></i></li>
                            <li>Pay<em></em><i></i></li>
...
<div class="JS-popwincon2 popwincon popwincon-user  hide">
    ...
    <form action="<?php echo LANGPATH; ?>/cart/edit_shipping" method="post" class="form payment-form" onsubmit="return setShipping(this);">
        ...
        <div class="shipping-methods s_price_list">
            ...
            <p><input type="submit" value="COUNTINUE" class="btn btn-default"></p>
        </div>
    </form>
</div>
                    ...
                    <div class="shipping-information">
                        ...
                        <div id="shippingAddressInfo" <?php if (!$show_address) echo 'style="display:none;"'; ?>>
                            <div class="information-con">
                                ...
                                ?>
                                    <dt>
                                        Shipping Address  <a href="javascript:;" class="red" data-reveal-id="myModal10" onclick="return edit_address(<?php echo $cart['shipping_address']['shipping_address_id']; ?>, 1);">Edit</a>
                                        <?php
                                        if($count_address > 1)
                                        {
                                        ?>
                                            <a href="javascript:;" class="red" onclick="return change_address_show();">Change</a>
                                        <?php
                                        }
                                        ?>
                                    </dt>
                                    <dd><label>Name:</label><span><?php echo $cart['shipping_address']['shipping_firstname'] . ' ' . $cart['shipping_address']['shipping_lastname']; ?></span></dd>
                                    <dd><label>Tel:</label><span><?php echo $cart['shipping_address']['shipping_phone']; ?></span></dd>
                                    <dd><label>Address:</label><span><?php echo $cart['shipping_address']['shipping_address'] . ' ' . $cart['shipping_address']['shipping_city'] . ', ' . $cart['shipping_address']['shipping_state'] . ' ' . $shipping_country . ' ' . $cart['shipping_address']['shipping_zip']; ?></span></dd>
                                <?php
                                }
                                ?>
                                </dl>
                                <dl class="col-xs-12 col-md-6">
                                    <dt>Shipping Method <!--  <a href="javacript:;" class="red JS-popwinbtn2" id="ship_edit" <?php //if(in_array($cart['shipping_address']['shipping_country'], $no_express_countries)) echo 'style="display:none;"'; ?>>Edit</a>--></dt>
                ...
                { ?>
                                ...
                                <form action="" method="post" name="shipping_address_radio">
                                        ...
                                        <li id="address_li_<?php echo $value['id']; ?>">
                                            <div class="clearfix">
                                                ...
                                                <label for="radio<?php echo $key; ?>">
                                                    ...
                                                    {
                                                        ?>
                                                            <span class="b address-detault" id="detault_<?php echo $value['id']; ?>">Default</span>
                                                    ...
                                                    {
                                                        ?>
                                                            <span class="b address-detault" id="detault_<?php echo $value['id']; ?>" style="display:none;">Default</span>
                                                            <a href="javascript:;" class="a-underline address-detault-a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);">Set Default</a>
                                                            <a class="btn btn-primary btn-sm" data-reveal-id="myModal10" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Edit</a>
                                                            <a href="javascript:;" class="btn btn-default btn-sm" data-reveal-id="myModal6" onclick="delete_address(<?php echo $value['id']; ?>);">Delete</a>
                                                        <?php
                                                    }
                                                    ?>
                                    ...
                                    <ul class="shipping-address">
                                        <li class="clearfix last">
                                            <a href="javascript:;" class="a-underline" id="add_new_address" data-reveal-id="myModal10" onclick="return new_address_show();">+Add a New Address</a>
                                        </li>
                                    </ul>
                                    </form>
                                </dd>
                        ...
                        <div class="address-fill" id="shippingAddressFill" <?php if($has_address) echo 'style="display:none;";' ?>>
                            ...
                            <form action="" method="post" class="form payment-form form2" onsubmit="return update_address(this);">
                                   ...
                                   <p class="me-wt"><?php echo $price['name']; ?> </p> 
                                    ...
                                    <li class="col-xs-12">
                                                    <div class="method">
                                                        ...
                                                        <p class="me-wt">Add Shipping Insurance for Your Order</p> 
                                ...
                                <p><input id="spgInfoCountinue" type="submit" value="COUNTINUE" class="btn btn-primary btn-lg"></p>
                            </form>
                        </div>
                    </div>
...
Please be attention for customers using TWD: <br /> According to the provisions of Taiwan Government, Your issuing banks will charge additional fees from 1% to 1.5%, when the receiving bank is not from Taiwan.We feel sorry for the inconvenience.
                                 ...
                                 <h2 class="visible-xs-block hidden-sm hidden-md hidden-lg">COUPON AND POINTS</h2>
                                    <div class="promo-choies visible-xs-block hidden-sm hidden-md hidden-lg" style="background:none;">
                                    <ul>
                                        <li class="promo-code">
                                            <div class="pc-apply">
                                                <div class="ml10">
                                                    <span class="fll" style="font-weight:bold;">Use Promo Code&nbsp;&nbsp;</span> 
        ...
        <i>
            2. Please enter the coupon code with no space.
                                        ...
                                        <li class="promo-code">
                                            <div class="pc-apply">
                                                <div class="ml10">
                                                    <span style="font-weight:bold;">Use Choies Points</span>
                                                    <span>(10 Points=$0.1)</span>
<!--                                                     <em class="icon-tips cs-show hidden-xs">
    <span class=" icon-tipscon cs-list">
                                               ...
                                               <?php
                                                if ($points_avail >= 0){
                                                    ?>
                                                        ...
                                                        points can be used for this time.
                                                   <?php
                                               }else{
...
<span id="save_total"><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span>
                        ...
                        <span id="cart_saving"><?php                           
                            if(isset($savearray['cart_save']))
                           {
                            ...
                            <p class="mt20">
                                <input type="submit" class="btn btn-primary btn-lg" id="checkoutbtn" value="Confirm and pay" onclick="return btn_loading();">
                                <div id="loadingbtn" style="display:none;">
                                    <button type="button" class="btn btn-primary btn-lg" disabled="disabled">Confirm and pay</button>
                ...
                <div class="col-xs-12 col-sm-4 col-sm-offset-1 hidden-xs">
                    <div class="order-summary">
                        ...
                        <ul class="total">
                            ...
                            <li><label>Estimated Shipping: </label><span id="shipping_total_pc"><?php echo $cart_shipping == -1 ? Site::instance()->price($site_shipping[2]['price'], 'code_view') : Site::instance()->price($cart_shipping, 'code_view'); ?></span></li>
                        <li class="last" id="oii_insurance_pc" <?php  if($session_insurance == -1) echo 'style="display:none;"'; ?>>
                            ...
                            <li id="coupon_points_save_pc" <?php if(!$coupon_points_save) echo 'style="display:none;"'; ?>>
                                <label>Pay with Coupons & Points: </label><span id="save_total_pc"><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span>
                            </li>
                            <?php
                        ...
                        <li class="last"  <?php  if(!$cart['amount']['checkoutsave']) echo 'style="display:none;"'; ?>>
                            ...
                            <li class="last red"><label>Saving: </label><span id="cart_saving_pc"><?php echo Site::instance()->price($saving + $cart['amount']['checkoutsave'], 'code_view'); ?></span></li>
        ...
        <i>2. Please enter the coupon code with no space.</i>
                                        ...
                                        <div class="pc-ibutton">
                                            <form method="post" action="<?php echo LANGPATH; ?>/cart/set_coupon" onsubmit="return setCoupon();">
                                                ...
                                                <button type="submit" class="btn btn-default btn-xs fll">Apply</button>
                                            </form>
    ...
    <span class="icon-tipscon cs-list" >You may apply Points equaling up to only 10% of your order value. <br>Complete your profile, you will be awarded 500 points to redeem your first order.</span>
                                        ...
                                        <div class="pc-ibutton">
                                            <form method="post" action="<?php echo LANGPATH; ?>/cart/point" class="form" id="point_form" onsubmit="return setPoints();">
                                                ...
                                                <button type="submit" class="btn btn-default btn-xs fll" onclick="return point_redeem();">Redeem</button>
                                            </form>
                                            <div class="clearfix"></div>
                                            <div class="points-info" style="font-size:11px;">
                                            <!-- Save: <span class="red">$ <span id="dollar">0</span></span><br> -->
                                              <!--   (10 Points=$0.1)   -->
                                                ...
                                                if ($points_avail >= 0):
                                                    ?>
                                                    <span style="font-weight:bold;"><?php echo $points_avail; ?></span> points can be used for this time.
                                                    <?php
                                                else:
                                                    echo 'To use your points, please shop at least $10+.';
                                                endif;
                        ...
                        <div class="additional-payment mt20">
                            <form action="<?php echo LANGPATH; ?>/cart/set_message" method="post" class="form user-message" onsubmit="return setMessage();">
                                ...
                                <div class="pinMessageBox mb20" style="display:none">
                                    ...
                                    onfocus="if(this.value=='Leave any message regarding order placement, product change or delivery options. All messages will be responded within 24 hours.') 
                                    ...
                                    <button class="btn btn-default btn-xs mt10" type="submit" id="message_submit" <?php if($cart_message) echo 'style="display:none;"'; ?>>Submit</button>
                                </div>
                            </form>
                            <p class="mt10">
                                Additional payment security with:
                            </p>
...
<div id="myModal10" class="reveal-modal large">
    ...
    <div class="address-fill">
        ...
        <form onsubmit="return update_address(this);" method="post" class="form payment-form form1">
            ...
            <ul>
                ...
                <li class="states2">
                    ...
                    <div id="all2_default">
                        ...
                        <div class="errorInfo"></div>
                        <label class="error a3" style="display:none;"  generated="true" id="guo_don">County / Province Name with digits? Please check the accuracy.</label>
                    </div>
                    <script>
                ...
                <li>
                    ...
                    <label class="error" style="display:none;" generated="true" id="guo_fon">It seems that there are no digits in your code, please check the accuracy.</label>
                ...
                <li>
                    ...
                    <p class="mt5 col-md-offset-3 col-xs-12 col-md-9 phone_tips">Please leave correct and complete phone number for accurate delivery by postman</p>
                </li>
                <li class="hide" value="0">
                    <label class="col-xs-12 col-md-3"><span>*</span>o cadastro de pessoa Física:</label>
            ...
            <p class="col-md-offset-3 col-xs-12 col-md-9"><input type="submit" value="COUNTINUE" class="btn btn-default"></p>
        </form>
    </div>
</div>
<!-- JS-popwincon3 -->
        ...
        $.ajax({
            ...
            success: function(result){
                if(result.success == 1){
                    ...
                    var shipping_address_list = '<dt>Shipping Address  <a class="red" data-reveal-id="myModal10" onclick="return edit_address('+result.address_id+');">Edit</a>'+change+'</dt>'+
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.count_address > 1)
                change = '<a href="javascript:;" class="red" onclick="change_address_show();">Change</a>';
            var shipping_address_list = '<dt>Shipping Address  <a class="red" data-reveal-id="myModal10" onclick="return edit_address('+res.shipping_address_id+');">Edit</a>'+change+'</dt>'+
