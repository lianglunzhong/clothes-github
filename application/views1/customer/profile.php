	...
	<div class="container">
		<div class="crumbs">
			<div>
				...
				<a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > my account</a> > account setting
			</div>
					...
					<form action="#" method="post" class="user-form form col-sm-8" id="accountSettings">
						<ul>
							...
							<li>
								...
								<div class="col-sm-9 col-xs-12">
									<span class="w-radio"><input type="radio" name="gender" value="1" id="radio1" <?php if ($customer['gender'] == 1) echo 'checked'; ?> /> Female</span>
									<span class="w-radio"><input type="radio" name="gender" value="0" id="radio2" <?php if ($customer['gender'] == 0) echo 'checked'; ?> /> Male</span>
									<span class="w-radio"><input type="radio" name="gender" value="2" id="radio3" <?php if ($customer['gender'] == 2) echo 'checked'; ?> /> Other</span>
								</div>
							</li>
							<li>								

								<label class="col-sm-3 col-xs-12">Birthday:</label>
								<div class="col-sm-9 col-xs-12">
