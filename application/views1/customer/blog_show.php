	...
	<div class="container">
		<div class="crumbs">
			<div>
				...
				<a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > my account</a> > my blog show
			</div>
									...
									<tr>
										...
										<td>
											<div class="pr-info fix">
												...
												<input class="copy-link btn btn-primary btn-xs" type="button" value="Copy Item Link" style="padding:0 5px;" name="<?php echo Product::instance($product_id)->permalink() . '?cid=' . $cele_id . $admin_name; ?>">
											</div>
										</td>
										<td>
                                        ...
                                        <input type="hidden" name="sku" value="<?php echo $data['sku']; ?>" />
													...
													<a class="addMoreLink a-red">add one more link</a>
													<input class="link-btn btn btn-primary btn-xs" style="margin-top:5px;" type="submit" value="Submit">
												</form>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="pr-info fix">
												...
												<input class="copy-link btn btn-primary btn-xs" style="padding:0 5px;" type="button"  name="<?php echo Product::instance($product_id)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Copy Item Link" />
											</div>
										</td>
										<td>
											<div class="show-link">
                                        ...
                                        ?>
                                                ...
                                                ?>
															...
															<a class="addMoreLink a-red">add one more link</a>
															<br>
															<input type="submit" style="margin-top:5px;" value="Submit" class="btn btn-primary btn-xs">
															<a style="text-decoration:underline;margin-left:10px;" class="link-cancel" href="#">Cancel</a>
															<br>
															<br>
														</form>
													</div>
													<input type="button" value="Edit" class="btn btn-default btn-xs link-edit" name="">
											</div>
										</td>
									</tr>
								<?php
										...
										<tr>
											...
											<td>
												<div class="pr-info fix">
													...
													<input class="copy-link btn btn-primary btn-xs" type="button" style="padding:0 5px;" value="Copy Item Link" name="<?php echo Product::instance($product_id)->permalink() . '?cid=' . $cele_id . $admin_name; ?>">
													</div>
												</div>
											</td>
											<td>
									...
									<tr>
										...
										<td>
											<div class="pr-info fix">
												...
												<input class="copy-link btn btn-primary btn-xs" type="button"  style="padding:0 5px;" value="Copy Item Link" name="<?php echo Product::instance($product_id)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Copy Item Link">
												</div>
											</div>
										</td>
										<td>
