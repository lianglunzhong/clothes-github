                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <article class="user col-sm-9 col-xs-12">
                            <h1 class="paysuccess-h">Thank You!</h1>
                            <ul class="paysuccess-t">
                                <li>Your have completed your payment successfully. </li>
                                <li>Click Your Order Number: <a class="success" href="<?php echo LANGPATH; ?>/order/view/<?php echo $order['ordernum']; ?>"><?php echo $order['ordernum']; ?></a> to view more details.</li>
                                ...
                                <li>please <a class="success" href="<?php echo LANGPATH; ?>/contact-us">contact us</a>.</li>
                                <li><a href="<?php echo LANGPATH; ?>/" class="btn btn-primary btn-sm">Continue Shopping</a></li>
                                <?php
...
elseif(strtolower(Kohana_Cookie::get("clickid")) != '')
{
