		        ...
		        <div class="lookbook-list">
		        	<div class="lookbook-box row">
                        ...
                        foreach($lookbooks as $i =>$v)
                        {
                            ...
                            {
                                $product_ins = Product::instance($v['product_id']);
		        			...
		        			<li class="lookbook-item col-xs-6 col-sm-3">
					        	<div class="outfit">
					            	<div class="viewport pro-four-dp" id="">
					            	...
					            	<div class="meta-bar">
					                    ...
					                    <div class="meta-pro-botton">
					                    	...
					                    	<a  class="btn btn-primary btn-xs flr" target="_blank" href="<?php echo LANGPATH; ?>/lookbook/<?php echo $lookbook['id']; ?>">VIEW DETAILS</a>
					                    </div>
					            	</div>
					            </div>
				            </li>
