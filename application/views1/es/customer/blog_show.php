			...
			<div class="container">
				<div class="crumbs">
					<div>
						...
						<a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > RESUMEN DE CUENTA</a> > Mi show del blog
					</div>
        ...
        <?php echo View::factory(LANGPATH . '/customer/left'); ?>
			<?php echo View::factory(LANGPATH . '/customer/left_1'); ?>
					<article class="user col-sm-9 col-xs-12">
						<div class="tit">
							<h2>Mi show del blog</h2>
						</div>
						<ul class="JS_tab1 detail_tab detail-tab hidden-xs">
                    <li <?php if (!$onshowed) echo 'class="on"'; ?>>PARA MOSTRAR</li>
                    <li <?php if ($onshowed) echo 'class="on"'; ?>>MOSTRÓ</li>
						</ul>
						<div class="JS_tabcon1 detail-tabcon hidden-xs">
							<div <?php echo $onshowed ? 'style="display:none;"' : 'style="display:block;"'; ?>>
								<p>¿Cómo llenar un show?</p>
								<p>
		                            <span>1. Copie el Enlace de Artículo y pégalo en tu Blog Mostrar Imagen.</span>
		                            <span>2. Escriba el url de su espectáculo en la columna de la derecha y haga clic en "Enviar".</span>
		                        </p>
								<div class=" table-responsive">
									<table class="user-table">
										<tbody>
											<tr>
												<th width="20%">Show No.</th>
												<th width="40%">La Información De Producto.</th>
												<th width="40%">Enlace De Show</th>
											</tr>
							<?php
											...
											<tr>
												...
												<td>
													<div class="pr-info fix">
														...
														<div class="right">
														<p>artículo# : <?php echo $data['sku']; ?></p>
														<p><?php echo Product::instance($product_id, LANGUAGE)->get('name'); ?></p>
														<p>
															Pedido NO.:
															<a><?php echo $data['ordernum']; ?></a>
														</p>
														<input class="copy-link btn btn-primary btn-xs" type="button" value="Copiar El Enlace" name="<?php echo Product::instance($product_id ,LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>">
													</div>
												</td>
												<td>
													<div class="show-link left" style="width:50%;">
                                                ...
                                                <input type="hidden" name="sku" value="<?php echo $data['sku']; ?>" />
															...
															<a class="addMoreLink a-red">Añadir uno mas enlace</a>
															<input class="link-btn btn btn-primary btn-xs" type="PRESENTAR" value="PRESENTAR">
														</form>
													</div>
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													<div class="pr-info fix">
														...
														<input class="copy-link btn btn-primary btn-xs" type="button"  name="<?php echo Product::instance($product_id ,LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Copiar El Enlace" />
													</div>
												</td>
												<td>
													<div class="show-link">
                                                ...
                                                ?>
                                                        ...
                                                        ?>
																	...
																	<a class="addMoreLink a-red">Añadir uno mas enlace</a>
																	<br>
																	<input type="PRESENTAR" value="PRESENTAR" class="btn btn-primary btn-xs">
																	<a style="text-decoration:underline;margin-left:10px;" class="link-cancel" href="#">Cancelar</a>
																	<br>
																	<br>
																</form>
															</div>
															<input type="button" value="EDITAR" class="btn btn-default btn-xs link-edit" name="">
													</div>
												</td>
											</tr>
											<?php
											...
											<tr>
												...
												<td>
													<div class="pr-info fix">
														...
														<input class="copy-link btn btn-primary btn-xs" type="button" value="Copiar El Enlace" name="<?php echo Product::instance($product_id ,LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Copiar El Enlace">
														</div>
													</div>
												</td>
												<td>
    ...
    <div id="cboxWrapper" style="height: 168px; width: 472px;"><div>
        ...
        <div style="clear: left;"><div id="cboxMiddleLeft" style="float: left; height: 118px;"></div>
            <div id="cboxContent" style="float: left; width: 422px; height: 118px;">
                ...
                <div class="closebtn" style="top: 125px;">Cerca</div>
            </div>
