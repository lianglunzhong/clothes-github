...
<div class="site-content">
    <div class="main-container clearfix">
        <div class="container">
            ...
            ?>
                ...
                <div class="font18 mt20 ml20 hide" id="no_result">Lo siento, no se encuentra ningún resultado.</div>
                    ...
                    for ($i = 0; $i < $_limit; $i++)
                    {
                        ...
                        <li class="pro-item col-xs-6 col-sm-3">
                            ...
                            <?php if ($product_inf['type'] != 0): ?>
                                <a href="#" id="<?php echo $product_id; ?>" attr-lang="<?php echo LANGUAGE; ?>" class="btn-qv quick_view"  data-reveal-id="myModal">VISTA RÁPIDA</a>
                            <?php endif; ?>
                            <div class="add-wish">
    ...
    /*                        if ($secondhalf):
                            ...
                            else
                            {
                                ...
                                elseif(in_array($product_id, $flash_sales)){
                ...
                {
                    ?>
                    <div class="font18 mt20">Lo siento, no se encuentra ningún resultado.</div>
                    <?php
                }
            }
            ?>
