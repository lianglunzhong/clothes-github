...
<section id="main">
    ...
    <div class="w_index_free">
        <div class="layout index_free">
            <img src="<?php echo STATICURL; ?>/ximg/index_free.png" border="0" usemap="#Map" />
            <map name="Map" id="Map">
                        ...
                        foreach ($products as $key => $product_id):
                            ...
                            <li class="JS_shows_btn1">
                                ...
                                ?>
                                    <div class="pic">
                                        <a href="<?php echo Product::instance($product_id)->permalink(); ?>">
                                            <div class="pic1"><img data-original="<?php echo Image::link($images[0], 1); ?>" src="/assets/images/loading.gif" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                            <?php
                                            if (isset($images[1]))
                                            {
                                                ?>
                                                <div class="pic2" style="display:none;"><img data-original="<?php echo Image::link($images[1], 1); ?>" src="/assets/images/loading.gif" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                                <?php
                                            }
                                            ?>
                                        </a>
                                ...
                                <?php if ($product_inf['type'] != 0): ?>
                                    <a href="#" id="<?php echo $product_id; ?>" class="quick_view JS_shows1 hide" attr-lang="<?php echo LANGUAGE; ?>">Quick View</a>
                                <?php endif; ?>
