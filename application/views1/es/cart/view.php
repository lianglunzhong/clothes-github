                        ...
                        <ul class="shopping-total">
                            ...
                            elseif($cart['amount']['items'] >=15 && $cart['amount']['items'] < 79 && $customer_id)
                            {
                                ...
                                if(!in_array($country,$no_express_countries) && !empty($country))
                                {
                                    $islarge = 1;
                            ?>
                                <p class="hidden-xs">Añadir  <span><?php echo Site::instance()->price($add_price,'code_view');?></span> de productos para disfrutar<span>ENVÍO ESTÁNDAR GRATIS</span><b></b>. </p>
                            <?php
                                }
                            }
                            ?>
                            ...
                            ?> 
                            <li class="cart-phone-tip hidden-sm hidden-md hidden-lg"> 
                                <p>Añadir <span class="red"><?php echo Site::instance()->price($add_price,'code_view');?></span> de productos para disfrutar<span class="red">ENVÍO ESTÁNDAR GRATIS</span><b></b>. </p>
                            </li>
                            <?php
                            }
                            ?>
