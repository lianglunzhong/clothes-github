...
<!--                             <a href="--><?php //echo LANGPATH;?><!--/christmas-sale-c-490"><img src="--><?php //echo STATICURL;?><!--/assets/images/es/1611/christmas_sale_es.gif" class="--><?php //echo LANGUAGE;?><!--_top_banner"></a>-->
<!--                             </div>-->
<!--                         -->
<!--                         </div>-->
<!--                         -->
                                            ...
                                            <div class="nav-box">
                                                <div class="nav-list01 fll">
                                                    <dl class="nav-ul">
                                                        ...
                                                        <dl class="col-xs-6">
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/92">Vestidos</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/621">Tops</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/953">Abrigos</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/961">Prendas de punto</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/53">Zapatos</a></dd>
                                                            <dd><a href="<?php echo LANGPATH;?>/daily-new/52">Accesorios</a></dd>
                                                        </dl>
                                                    </dl>
                                                </div>
                                                    <?php
...
<!--                                         <li class="cs-show">
                                  ...
                                  <div class="nav-list cs-list" style="margin-left:-400%;">
                                        ...
                                        <div class="nav-list cs-list" style="margin-left:-569%;">
                                            <span class="downicon tpn006"></span>
                                                <div class="nav-box">
                                                    <div class="nav-list01 fll">
                                                        <dl class="nav-ul01">
                                                            <dd><a href="/es/only-9-c-1170">Sólo $9.90</a></dd>
                                                            <dd><a href="/es/activity/flash_sale">Flash sale</a></dd>
                                                            <dd><a href="/es/only-19-c-1171">Sólo $19.90</a></dd>
                                                            <dd><a href="/es/summer-clearance-c-451">Liquidación Verano</a>
                                                            <dd><a href="/es/only-29-c-1172">Sólo $29.90</a></dd>
                                                            <dd><a href="/es/biggest-deal-c-1174">Gran Suceso</a></dd>
                                                            <dd><a href="/es/outlet-c-101">Outlet</a></dd>
                                                    ...
                                                    <div class="nav-list02 fll">
                                                            <!-- <a href="/es/biggest-deal-c-1174">
                                                            <img src="<?php echo STATICURL;?>/assets/images/es/1610/biggest_deal.jpg" class="navigation_banner6"></a> -->
                                                            <?php
                                                  if(array_key_exists(4, $newindex_banners))
                                                  {
                                                  ?>
                                    ...
                                    <li class="cs-show" style="width:13%">
                                        <a href="<?php echo LANGPATH; ?>/choies-top-sellers-c-1188">MEJORES VENDIDOS</a>
                                        <div class="nav-list cs-list" style="margin-left:-669%;">
                                            <span class="downicon tpn07"></span>
                                                <div class="nav-box">
                                                    <div class="nav-list01 fll">
                                                        <dl class="nav-ul">
                                                            <dd><a href="<?php echo LANGPATH; ?>/top-seller-dresses-c-1189">Mejor Vendido: Vestidos</a></dd>
                                                            <dd><a href="<?php echo LANGPATH; ?>/top-seller-blouses-and-shirts-c-1190">Mejor Vendido: Blusas  & Camisas</a></dd>
                                                            <dd><a href="<?php echo LANGPATH; ?>/top-seller-coats-and-jackets-c-1191">Mejor Vendido: Abrigos & Chaquetas</a></dd>
                                                            <dd><a href="<?php echo LANGPATH; ?>/top-seller-sweater-and-knits-c-1192">Mejor Vendido: Suéter & Tejidos </a></dd>
                                                            <dd><a href="<?php echo LANGPATH; ?>/top-seller-skirts-c-1193">Mejor Vendido: Faldas</a></dd>  
                                                        </dl>
                                                    </div>
                                                    <div class="nav-list02 fll">
                                                           <!--  <a href="<?php echo LANGPATH; ?>/choies-top-sellers-c-1188">
                                                            <img src="<?php echo STATICURL;?>/assets/images/es/1610/top_seller.jpg" class="navigation_banner6"></a> -->
                                                            <?php
