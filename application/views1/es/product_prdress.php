            ...
            <div class="pro_left fll">
                <div class="top">
                    <div class="myImages JS_myImages JS_zoom">
                        <a href="#" class="picbox"><img src="<?php echo Image::link($product->cover_image(), 2); ?>" big="<?php echo Image::link($product->cover_image(), 5); ?>" width="480px" alt="" /></a>
                        <?php
                        foreach ($product->images() as $key => $image):
                            if (!$key)
                                continue;
                            ?>
                            <a href="#"><img src="<?php echo Image::link($image, 2); ?>" big="<?php echo Image::link($image, 5); ?>" alt="" width="480px" /></a>
                            <?php
                        endforeach;
                        ?>
                    </div>
                    <div class="scrollable">
                        <div class="items">
                            <ul class="scrollableDiv JS_scrollableDiv fix">
                                ...
                                <?php endforeach; ?>
<!--                                <li class="last"><img src="<?php echo STATICURL; ?>/ximg/pro_video_75.jpg" alt="" /></li>-->
                            </ul>
...
<!--                            <p>Presale  Pattern:</p>-->
                        ...
                        <div class="flr"><a href="#"><img src="<?php echo STATICURL; ?>/ximg/codetext.gif" /></a></div>
                    </dd>
                    <dd class="last">
                        <?php
                                        ...
                                        foreach ($fabric as $colorname => $background):
                                            ...
                                            <li title="<?php echo $colorname; ?>">
                                                ...
                                                <div class="colorBox hide">
                                                    <p class="img"><img src="<?php echo STATICURL; ?>/ximg/color/<?php echo $fabriclink . '/' . $colorlink; ?>.jpg" /></p>
        ...
        <article class="product_recommend fix">
            ...
            <div class="right JS_tabcon3">
                ...
                foreach ($recommend_sorts as $val):
                    ...
                    $products = array();
                    $products = DB::query(DATABASE::SELECT, 'SELECT id, name, link, price, has_pick, MATCH(filter_attributes) AGAINST (' . "'" . '"' . $val . '"' . "'" . ') AS sorts FROM `products`
                        WHERE set_id=' . $set_id . ' AND visibility = 1 AND status = 1 AND status <> 0 AND  
                        MATCH(filter_attributes) AGAINST (' . "'" . '"' . $val . '"' . "'" . ') AND id <> ' . $product_id . ' 
                        ORDER BY sorts DESC, display_date DESC LIMIT 0, 4')
                            ->execute()->as_array();
                    ?>
        ...
        <!--                                    <span class="outstock">out of stock</span>-->
                            ...
                            {
                                $products = DB::query(DATABASE::SELECT, 'SELECT id, name, link, price, has_pick FROM `products` 
                                WHERE set_id=' . $set_id . ' AND visibility = 1 AND status = 1 AND status <> 0 AND  
                                !MATCH(filter_attributes) AGAINST (' . "'" . '"' . $filter_sorts1['COLOR'] . '"' . "'" . ') AND id <> ' . $product->get('id') . ' 
                                ORDER BY hits DESC LIMIT 0, 4')
                                        ->execute()->as_array();
                            }
                            foreach ($products as $p):
                                ?>
        ...
        <!--        <article class="pro_lookwith">
                    ...
                    <div class="fix">
                        <div class="left"><img src="<?php echo STATICURL; ?>/ximg/pr370_350.jpg" /></div>
                        <div class="right">
                            <div class="JS_carousel1 pro_listcon">
                                <ul class="fix">
                                    <li>
                                        <a href="#"><img src="<?php echo STATICURL; ?>/ximg/pr190.jpg" /></a>
        ...
        <div class="left">
            ...
            <form action="<?php echo LANGPATH; ?>/customer/login?redirect=/product/<?php echo $product->get('link'); ?>" method="post" class="signin_form sign_form form">
                ...
                <div class="form_bottom">
                    <p><a href="<?php echo LANGPATH; ?>/customer/forgot_password" class="text_upper">¿Olvidaste tu contraseña?</a></p>
        ...
        <div class="right">
            ...
            <form action="<?php echo LANGPATH; ?>/customer/register?redirect=/product/<?php echo $product->get('link'); ?>" method="post" class="signup_form sign_form form">
                <ul>
                    ...
                    <li><input type="submit" value="REGISTRARTE" name="submit" class="btn" /></li>
                </ul>
            </form>
        </div>
    </div>
...
<div class="JS_popwincon2 popwincon w_p30 hide">
    ...
    <div class="JS_tabcon2 detail_tabcon">
        <div class="bd"><img src="<?php echo STATICURL; ?>/ximg/tab1_img.jpg" /></div>
        <div class="bd hide">
            <img src="<?php echo STATICURL; ?>/ximg/stain.jpg" />
            <img src="<?php echo STATICURL; ?>/ximg/chiffon.jpg" />
            <img src="<?php echo STATICURL; ?>/ximg/taffeta.jpg" />
            <img src="<?php echo STATICURL; ?>/ximg/organza.jpg" />
            <img src="<?php echo STATICURL; ?>/ximg/elastic.jpg" />
        </div>
        <div class="bd size_mesurements hide fix">
            <div class="fll"><img src="<?php echo STATICURL; ?>/ximg/tab3_img.jpg" /></div>
            <div class="right fll">
                <h4>BUST</h4>
