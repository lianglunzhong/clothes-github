...
<meta property="og:PRECIO:amount" content="<?php echo $pprice; ?>" />
<meta property="og:PRECIO:currency" content="USD" />
                ...
                <div class="pro-right" style="margin-left:0px;">
                            ...
                            <div class="row">
                                <dl class="col-xs-12 col-md-9">
                                    <div class="pro-stock">
                                        artículo# : <span id="product_sku"><?php echo $product->get('sku'); ?></span>
                                        <?php
                                        if(!empty($brands))
                                        {
                                            ?>
                                        ...
                                        {
                                            ?>
                                            <a target="_blank" href="<?php echo LANGPATH; ?>/brand/list/220">by Zonewetwo</a>
                                        <?php
                                        }
                        ...
                        <dd>
                            <div id="action_form" class="JS-popwincon">
                                <p class="product-note-title" style="display:none;">Seleccione la talla
                                ...
                                <form action="<?php echo LANGPATH; ?>/cart/add" method="post" id="formAdd" class="product-pl">
                                    ...
                                    if (!empty($attributes['size']))
                                    {
                                        ?>
                                            ...
                                            <?php
                                                ...
                                                {
                                                ?>
                                                <span class="size-charts JS-popwinbtn2 ml10 hidden-xs"><a data-reveal-id="myModal3">Tabla de tallas</a></span>
                                                <?php
                                                }
                                                ?>
                                                         </div>
                                    ...
                                    <div class="total" style=" margin-top:15px;">
                                        ...
                                        if($instock)
                                        {
                                            ...
                                            {
                                        ?>
                                            <input class="btn btn-primary btn-lg" id="addCart" value="AÑADIR A BOLSA" type="submit" style="text-transform: none;">
                                        <?php
                                            }
                                        }
                                        else
                                        {
                                            ?>
                                            <button class="btn btn-primary btn-lg" disabled="disabled">Fuera De Stock</button>
                                            <?php
                                        }
                                        ?>    
                                            ...
                                            <span class="fa fa-heart" style="display:none;"></span>LISTA DE DESEOS
                                            <?php
                                            if($wishlists)
                                            {
                                            ?>
                            ...
                            <div class="col-md-3 hidden-xs">
                                <a href="#" style="cursor: default;"><img src="<?php echo STATICURL; ?>/assets/images/es/1611/free_standard_shipping.jpg"></a>
                            </div>
                            </div>
                            <div>
                                ...
                                <div class="JS-tabcon detail-tabcon">
                                    ...
                                    {
                                    ?> 
                                        <a class="fix" style="cursor:pointer;margin-top:3px;text-decoration: underline;font-weight: bold;" data-reveal-id="myModal3">Tabla de tallas</a>
                                    <?php
                                    }
                                    ?>
                                    </div>
                                    ...
                                    <p>Para <span class="red">traje de baño y ropa interior</span>, si no hay un problema de calidad, no ofrecemos servicio de devolución o cambio,  esperamos su comprehensión, ver más en <a class="red" href="<?php echo LANGPATH; ?>/returns-exchange" title="la política de devolución">la política de devolución</a>.</p>
                ...
                <div class="phone-product-info col-sm-12">
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle " href="javascript:void(0);">Detalles
                        ...
                        <div class="accordion-group visible-phone">
                            <div class="accordion-heading JS-toggle">
                                <a class="accordion-toggle " href="javascript:void(0);">MODELO
                                    <i class="fa flr fa-caret-down"></i>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group visible-phone">
                            ...
                            <div class="accordion-heading JS-toggle">
                                <a class="accordion-toggle " href="javascript:void(0);">Envío
                                    <i class="fa flr fa-caret-down"></i>
                                </a>
                            </div>
                            <div class="accordion-body JS-toggle-box hide">
                        ...
                        <div class="accordion-group visible-phone">
                            <div class="accordion-heading JS-toggle">
                                <a class="accordion-toggle " href="javascript:void(0);">Contacto
                                    <i class="fa flr fa-caret-down"></i>
                                </a>
                            </div>
                            <div class="accordion-body JS-toggle-box hide">
                ...
                if (isset($videos) AND !empty($videos))
                {
                    ...
                    <div class="other-customers">
                        ...
                        <div class="product-carousel">
                            ...
                            if($count > 8)
                            {
                                ...
                                <div class="clearfix"></div>
                                <div class="bt-view"><p>Ver Más+</p></div>
                            <?php
                            }
                            ?>
                            </div>  
                            ...
                            foreach ($link_images as $key => $link_img)
                            {
                                ...
                                <ul <?php if($key > 0) echo 'class="more-view mt10 hide"'; ?>>
                                    ...
                                    <li style="width:65%;">
                                        ...
                                        <a class="btn btn-primary btn-sm flr" data-reveal-id="myModal5<?php echo $key; ?>" title="<?php echo $key; ?>" >CONSEGUIR EL LOOK</a>
                                    </li>
                    <?php
                                    ...
                                    <div class="clearfix items<?php echo $key; ?>">
                                        ...
                                        foreach ($skus as $sku)
                                        {
                                            ...
                                            <li>
                                                ...
                                                <?php
                                                if (!$instock)
                                                    echo '<span class="outstock red">Fuera De Stock</span>';
                                                ?>
                                            </li>
                                        <?php
                                        }
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            {
                                ?>
                                <div class="bt-view a-underline mt10"><p>Ver Más+</p></div>
                                <?php
                            }
                            ?>
                            </div>  
            ...
            <div class="four-lay">
                <div class="box-title">
                    <ul>
                        ...
                        <li class="" id="recent_li">VISITADO RECIENTEMENTE</li>
                        <p style="left:120px;">
                            <b></b>
                        </p>
                    </ul>                           
...
<div id="myModal3" class="reveal-modal xlarge">
    ...
    <ul class="JS-tab-size size-tab two-bor">
        <?php if ($set_id != 2): ?>
            <li class="dt-s2 current">ROPA</li>
            <li class="dt-s2 pc-size" style="width:250px;">TABLA DE CONVERSIÓN</li>
        <?php endif; ?>
        <?php if ($set_id == 2): ?>
            <li class="dt-s2 current">ZAPATOS</li>
<!--         <?php // else: ?>
    <li class="dt-s2 two-bor">ZAPATOS</li> -->
        <?php endif; ?>
        <?php if (Product::instance($product_id)->get('set_id') != 2 AND !empty($celebrity_lists)): ?>
            <li class="dt-s2 pc-size">INFORME DE PRUEBE</li>
        <?php endif; ?>
        <li class="dt-s2 pc-size">MEDIDAS</li>
        ...
        <div class="bd size-mesurements hide">
            ...
            <div class="clearfix">
                ...
                <p>
                    ...
                    <br> *No se refiere a la talla de sujetador 
                    <br> *Utilice un sujetador sin relleno (el vestido tendrá un sujetador incorporado)
                    <br> *Brazos relajados a los lados
                    <br> *Mida la parte más ancha del busto 
                </p>
                <p>
                    <strong>b) Cintura</strong>
                    <br> *Busque la cintura natural 
                    <br> *Será la parte más estrecha de la cintura
                    <br> *Se encuentra aproximadamente 1 pulg. por encima del ombligo
                    <br> *Mantenga la cinta un poco floja para mayor comodidad 
                </p>
                <p>
                    <strong>c) Cadera</strong>
                    <br> *Encuentre la parte más ancha de la cadera
                    <br> *Normalmente alrededor de 8 pulg. debajo de la cintura natural
                    <br> *La cinta debe rodear ambos huesos de la cadera
                </p>
                    </div>
            </div>
            <h3>ZAPATOS</h3>
            <div class="clearfix">
                ...
                <div class="right flr" style="padding-left:25px;">
                    <h4>LONGITUD DE PIES</h4>
                    <p>Mídete el pie colocando una regla pegada al suelo a lo largo de la parte interior del pie desde el talón hasta los dedos.</p>
                    <h4>ALTURA DE ZAPATOS</h4>
                    <p>Medir la parte posterior de los zapatos desde la parte superior hasta la parte inferior de los talones que descansan sobre la superficie plana.</p>
                    <h4>ALTURA DE TALÓN </h4>
                    <p>Medir la parte posterior del talón. Inicio en la parte inferior del talón y llegan hasta el punto del talón cumple con la suela del zapato.</p>
                    <h4>ALTURA DE TUBO</h4>
                    <p>ALTURA DE ZAPATOS - ALTURA DE TALÓN</p>
                </div>
            </div>
        </div>
    </div>
...
?>
<script type="text/javascript">
window._fbq.push(["track", "ViewContent", { content_type: 'product', content_ids: ['<?php echo $product_id; ?>'], product_catalog_id: '1255791657780769' }]);
