		...
		<section id="main">
			...
			<div class="container">
				<div class="crumbs">
					...
					<div class="back visible-xs-inline hidden-sm hidden-md hidden-lg">&lt;&lt;&nbsp;<a class="back" href="window.history.back()">back</a>
					</div>
				</div>
			</div>
			<!-- main begin -->
								...
								<div class="pro-items">
                                    ...
                                    foreach ($product->images() as $image):
										...
										<li class="col-xs-3 <?php if ($key == 1) echo 'current'; ?>">
											<a href="/"><img src="<?php echo Image::link($image, 3); ?>" imgb="<?php echo Image::link($image, 2); ?>"/></a>
										</li>
                                        <?php
                                    endforeach;
                                    ?>
