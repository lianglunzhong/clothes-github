	...
	public function action_programme()
        {
                ...
                $this->template->content = View::factory(LANGPATH . '/fashion_blogger/programme');
        }
        
        public function action_read_policy()
        {
                $this->template->content = View::factory(LANGPATH . '/fashion_blogger/read_policy');
        }
        ...
        public function action_submit_information()
        {
                ...
                $this->template->content = View::factory(LANGPATH . '/fashion_blogger/submit_information');
        }
        ...
        public function action_get_banner()
        {
			...
			foreach($result as $val)
			{
                ...
                $this->template->content = View::factory(LANGPATH . '/fashion_blogger/get_banner')->set('index_banners', $index_banners);
        }
