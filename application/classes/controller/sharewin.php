...
class Controller_Sharewin extends Controller_Webpage
{
        ...
        public function action_add()
        {
                ...
                $reports = DB::select()->from('share_win_reports')
                                ...
                                ->limit(3)
                                ->execute()->as_array();
                $this->template->content = View::factory(LANGPATH . '/freebie/freetrial')
        ...
        public function action_index()
        {
            $this->request->redirect(LANGPATH . '/freetrial/add');
                ...
                $this->template->content = View::factory(LANGPATH . '/sharewin/share_and_win')
                    ->set('products', $products)
                        ...
                        else
                        {
                                ...
                                else
                                {
                                        $attachment = array(
                                            ...
                                            'link' => 'http://www.choies.com/sharewin/index',
                                            'description' => 'Complete 2 tasks and then have a chance to get the free',
                                            'picture' => 'http://www.choies.com/images/share_01.jpg',
                                        );
        ...
        public function action_reports()
        {
                ...
                if($id)
                {
                        ...
                        $this->template->content = View::factory(LANGPATH . '/freebie/reports_detail')->set('report', $report);
                }
                else
                {
                        ...
                        $reports = DB::select()->from('share_win_reports')
                                        ...
                                        ->execute()->as_array();
                        $this->template->content = View::factory(LANGPATH . '/share_win/reports_list')
                                ->set('reports', $reports)
                                ->set('pagination', $pagination->render());
                }
        }
