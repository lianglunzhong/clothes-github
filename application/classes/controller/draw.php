...
class Controller_Draw extends Controller_Webpage
{
    ...
    public function action_luck_draw()
    {
        ...
        echo View::factory(LANGPATH . '/luck_draw')->set('draw', $draw_from);exit;
    }   
    ...
    public function action_senddraw()
    {
        ...
        if($upstate){
            ...
            if($draw_name){
                ...
                DB::query(Database::INSERT, 'insert into customer_coupons(customer_id,coupon_id,site_id)values("'.$customer_id.'","'.$coupon_id.'",1)')->execute();
