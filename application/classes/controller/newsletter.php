...
class Controller_Newsletter extends Controller_Webpage
{
        ...
        public function action_view()
        {
                ...
                $this->request->response = View::factory(LANGPATH . '/newsletter')
                    ->set('country', $country)
                    ->render();
        }
        ...
        public function action_add()
        {
                        ...
                        if( ! Newsletter::instance()->is_email($data['email']))
                        {
                                ...
                                if($flag)
                                {
                                        ...
                                        $array = array(
                                                ...
                                                array('name'=>'firstname','value'=>$mail_params['firstname'])
                                            );
                                        $mail_lang = 'active';
                                        $postarr[]['fields'] = $array;
                                        $send = Mail::Sendcustomer($postarr,$mail_lang,'NEWSLETTER');
                ...
                $this->template->content = View::factory(LANGPATH . '/newsletter/newsletter')
        ...
        public function action_single_add()
        {
                if($_POST)
                {
                        ...
                        $this->request->response = View::factory(LANGPATH . '/newsletter_fail')->render();
                }
        }
                                ...
                                else
                                {
                                        ...
                                        if ($flag)
                                        {
                                                ...
                                                $array = array(
                                                        ...
                                                        array('name'=>'firstname','value'=>'Customer')
                                                    );
                                                $mail_lang = 'active';
                                                $postarr[]['fields'] = $array;
                                                $send = Mail::Sendcustomer($postarr,$mail_lang,'NEWSLETTER');
        ...
        {
                $this->template->content = View::factory(LANGPATH . '/newsletter/success');
        }
