...
class Controller_tags extends Controller_Webpage
{
	public function action_index()
	{
		...
		if($link!='')
		{
			...
			if($label->loaded())
			{
				...
				$this->request->response =  View::factory(LANGPATH . '/tags_display')
													->set('label', $label)
		...
		else
		{
			...
			$this->set_meta('list');
			$this->request->response =  View::factory(LANGPATH . '/tags_list')
								->set('data', $data)
								->set('labels', $labels)
								->render();	
		}
	...
	public function action_catalog()
	{
		...
		if($cat->loaded())
		{
			...
			$this->request->response =  View::factory(LANGPATH . '/tags_catalog')
