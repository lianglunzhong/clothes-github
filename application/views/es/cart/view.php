        ...
        <section class="cart cart_view">
            ...
            if (!$count)
            {
                ...
                <div class="cart_empty">
                    ...
                    <p>
                        Ver artículos que ya están en su <a href="<?php echo LANGPATH; ?>/customer/wishlist" class="a_underline">Lista de deseos</a> 
                        <?php
                        if(!empty($cartcookie))
                        {
                            ?>
                            , <a href="#saved_items" class="a_underline">Lista de artículos guardados</a>
                            <?php
                        }
                        ?>
                        o <a href="<?php echo LANGPATH; ?>/" class="a_underline">seguir comprando</a>.
                    </p>
                </div>
                <div id="saved_items"></div>
                <?php if(count($cartcookie)>0){ ?>
                <div class="fix mt30">
                    <strong class="fll font18">Sus Artículos Guardados</strong>
                </div> 
                        ...
                        <td>
                            <div class="fix">
                                ...
                                <div class="right">
                                    ...
                                    <p class="color666">Artículo: #<?php echo $cookie_product->get('sku'); ?></p>
                                    <p class="bottom"><!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Guarda a Lista Deseos</a-->
                                        <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline fll"  onclick="if(!confirm('¿ Estás seguro de que quieres borrar esto? No se puede deshacer.')){return false;}">Eliminar</a><span style="margin:3px 10px;float:left">|</span>
                                        <a href="<?php echo LANGPATH; ?>/cart/cookie2cart/<?php echo $key;?>" class="a_underline fll green">Añadir a bolsa</a>
                                    </p>
                                </div>
                            </div>
                        </td>
                      ...
                      <td>
                       <ul class="cart_option" style="display: block;">
                          <li>
                              ...
                              <?php echo str_replace('one size', 'talla única', $value['attributes']['Size']); ?>
                              </span>
                          </li>
                          <li>
                      ...
                      <td>
                        <div class="fix">
                          ...
                          <div class="right">
                            ...
                            <p class="gray">Artículo: #<?php echo $cookie_product->get('sku'); ?><span class="red font11 ml5">out of stock</span></p>
                            <p class="bottom"><!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Guarda a Lista Deseos</a-->
                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline">Eliminar</a></p>
                          </div>
                        </div>
                      </td>
                      <td>
            ...
            <?php }else{
                ...
                <div class="fix">
                    <div class="fll">
                        <h2>MI BOLSA</h2>
                        <span class="show" >Aceptamos:<img class="ml10" style="vertical-align:middle" src="/images/shopping-bag-accept.png" usemap="#Shopping" /></span>
                ...
                <!--<p class="mb25"><span class="special_offers">Stock reservado por 30 minutos solamente</span></p>-->
                <div class="shopping_bag mb25">
                                ...
                                <td>
                                    <div class="fix">
                                        ...
                                        <div class="right">
                                            ...
                                            <p class="color666">Artículo: #<?php echo Product::instance($product['id'])->get('sku'); ?></p>
                                            <p class="bottom">
                                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline fll" onclick="if(!confirm('¿ Estás seguro de que quieres borrar esto? No se puede deshacer.')){return false;}">Eliminar</a><span style="margin:3px 10px;float:left">|</span>
                                                <?php if($save_show){ ?>
                                                <a href="/cart/cookie2later/<?php echo $key;?>" class="a_underline fll green">Guardar para después</a>
                                                <?php }else{ ?>
                                                <a id="sign_in" class="pro_sign JS_popwinbtn1" href="<?php echo LANGPATH; ?>/customer/login?redirect=<?php echo LANGPATH; ?>/cart/view">Guardar para después</a>
                                                <?php } ?>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="cart_option">
                                            <li>
                                                ...
                                                <select name="attribute">
                                                    ...
                                                    {
                                                        $attr = str_replace('one size', 'talla única', $a);
                                            ...
                                            if(Product::instance($product['id'])->get('stock') == -1)
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <li class="red">Sólo queda <span><?php echo $stocks; ?></span></li>
                                                    <?php
                                                }
                                            }
                                            ?>
                                            <li>
                                                <input type="reset" value="Cancelar" class="btn22_black change_cancel" />
                                                <input type="submit" value="Actualizar" class="btn22_black" />
                                            </li>
                                        </ul>
                                    </form>
                                    <ul class="cart_option">
                                        <li>
                                            <label>Talla:  </label>
                                            <span class="cart_size"><?php echo str_replace('one size', 'talla única', $product['attributes']['Size']); ?></span>
                                        </li>
                                        <li>
                                            <label>Candidad: </label>
                                        ...
                                        ?>
                                        <li>
                                            <a class="btn22_black change_detail">Cambiar Detalles</a>
                                        </li>
                                    </ul>
                                </td>
                                    ...
                                    <td>
                                        <div class="fix">
                                            ...
                                            <div class="right">
                                                ...
                                                <p>Artículo: #<?php echo Product::instance($largess['id'])->get('sku'); ?></p>
                                                <a href="<?php echo LANGPATH; ?>/cart/largess_delete/<?php echo $key; ?>" class="a_underline">Eliminar</a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                foreach ($largesses_for_choosing['largesses'] as $key => $largesses_for_choosing_product)
                                {
                                    ...
                                    <form method="POST" action="<?php echo LANGPATH; ?>/cart/largess_add">
                                        <tr>
                                            <td width="35%">
                                                <div class="fix">
                                                    ...
                                                    <div class="right">
                                                        ...
                                                        <p class="color666">Artículo: #<?php echo Product::instance($key)->get('sku'); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td width="25%">
                                            ...
                                            <td width="15%"><input type="submit" value="TOMAR LA OFERTA" class="btn22_black" /></td>
                                        </tr>
                                    </form>
                                    <?php
                                }
                    ...
                    <ul class="shopping_total">
                        <li class="first">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo $catalog_link; ?>" class="a_underline"><< Seguir comprando</a>
                        </li>
                        ...
                        <li class="bottom">
                            <a href="<?php echo LANGPATH; ?>/cart/checkout" class="btn40_16_red">VOY A PAGAR</a>
                        </li>
                        <li class="bottom last">
                            <em class="color666"><b class="red">TIP!</b> Utilice Sus Puntos Y Cupónes al pagar.</em>
                        </li>
                    </ul>
                </div>
                <article class="product_reviews" id="alsoview" style="display:none">
                <div class="w_tit layout" ><h2>PRODUCTOS RECOMENDADOS</h2></div>
                <div class="box-dibu1">
                    ...
                    <tr>
                      <td>
                        <div class="fix">
                          ...
                          <div class="right">
                            ...
                            <p class="color666">Artículo: #<?php echo $cookie_product->get('sku'); ?></p>
                            <p class="bottom">
                                <!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Guarda a Lista Deseos</a-->
                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" onclick="if(!confirm('¿ Estás seguro de que quieres borrar esto? No se puede deshacer.')){return false;}" class="a_underline fll">Eliminar</a><span style="margin:3px 10px;float:left">|</span>
                                <a href="<?php echo LANGPATH; ?>/cart/cookie2cart/<?php echo $key;?>" class="a_underline fll green">Añadir a bolsa</a>
                            </p>
                          </div>
                        </div>
                      ...
                      <td>
                        ...
                        <ul class="cart_option" style="display: block;">
                            <li>
                                <label>Talla:  </label>
                                <span class="cart_size"><?php
                                echo str_replace('one size', 'talla única', $value['attributes']['Size']); 
                                ?></span>
                            </li>
                            <li>
                                <label>Candidad: </label>
                    ...
                    <tr class="bggy">
                      <td>
                        <div class="fix">
                          ...
                          <div class="right">
                            ...
                            <p class="bottom">
                                <!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Guarda a Lista Deseos</a-->
                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline">Eliminar</a>
                            </p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <ul class="cart_option gray" style="display: block;">
                          <li>
                              <label>Talla:  </label>
                              <span class="cart_size"><?php echo str_replace('one size', 'talla única', $value['attributes']['Size']); ?></span>
                          </li>
                          <li>
                              <label>Candidad: </label>
                              <span class="cart_size"><?php echo $value['quantity']; ?></span>
                ...
                <p class="mb20"><a href="<?php echo LANGPATH; ?>/cart/cartcookie_invalid">Eliminar Los Artículos No Válidos</a></p>
                <P class="mb20">El precio y la disponibilidad de los artículos en choies están sujetos a cambios. La Bolsa es un lugar temporal para guardar una lista de sus artículos y refleja el precio más reciente.</P>
                <?php } ?>
                <div class="cartbag_bottom">
                    <a target="_blank" class="s1" href="<?php echo LANGPATH; ?>/privacy-security">Pago Seguro Garantizado</a>
...
<script type="text/javascript">
    ...
    function ppecPay()
    {
        if(product_price <= 0)
        {
            alert('Ningún artículo en la bolsa de la compra');
            return false;
        }
