...
<section id="main">
    ...
    <div class="w_index_free">
        <div class="layout index_free">
            ...
            <a href="<?php echo LANGPATH; ?>/customer/login" class="a2">15% MENOS DE EL PRIMERO PEDIDO</a>
            <a href="<?php echo LANGPATH; ?>/daily-new" class="a3">10% MENOS DE NOVEDADES</a>
        </div>
    </div>
            ...
            <div id="productInfo">
                <dl>
                    <dd>
                        ...
                        <div class="infoText">artículo# : <span id="product_sku"></span></div>
                        <div class="stock" id="stock">
                            <span>En Stock</span>
                        </div>
                        <div class="hide" id="outstock">
                            <span class="red">Fuera De Stock</span>
                        </div>
                        <div class="detils" style="width:190px;"><a id="product_link" href="#" title="Ver Detalles Completos">Ver Detalles Completos</a></div>
                        <div class="clear"></div>
                    </dd>
                    <dd>
                        <div class="price">
                    ...
                    <dd class="fix">
                        <div class="charge_fix" id="action-form">
                            <form action="#" method="post" id="formAdd">
                                ...
                                <div class="btnadd"> 
                                    <button class="btn btn40_16_red" id="addCart">AÑADIR A BOLSA</button>
                                    <a id="addWishList" class="btn40_1 view_btn btn" href="#">LISTA DE DESEOS</a>
                                </div>
                            </form>
                        </div>
                    </dd>
                        ...
                        <div id="tab5">
                            ...
                            <div id="tab5-con-1">
                                ...
                                <div class="description hide" id="tab5-2-con">
                                    ...
                                    <div class="LiveChat2 mt10 pl10"><a href="mailto:<?php echo Site::instance()->get('email'); ?>"><img src="/images/livemessage.png" alt="Eine Nachricht hinterlassen" /> Dejar Un Mensaje</a></div>
...
<script type="text/javascript">
    $('.quick_view').live("click",function(){
        ...
        function(product)
        {
            ...
            {
                $(".btn_size").html('');
                $(".btn_size").append('<input type="hidden" name="attributes[Size]" value="" class="s-size" /><div id="select_size" class="mb10">Seleccionar Talla:</div>');
                var attribute = product['attributeSize'].replace('value="one size"', 'value="talla única"');
            ...
            {
                $(".btn_color").html('');
                $(".btn_color").append('<input type="hidden" name="attributes[Color]" value="" class="s-color" /><div id="select_color" class="mb10">Seleccionar Color:</div>');
            ...
            {
                $(".btn_type").html('');
                $(".btn_type").append('<input type="hidden" name="attributes[Type]" value="" class="s-type" /><div id="select_type" class="mb10">Seleccionar Tipo:</div>');
            ...
            {
                $("#outofstock").html('( ¡Sólo queda ' + product['stock'] + '! )');
            }
