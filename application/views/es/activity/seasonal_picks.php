...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  Seasonal Picks</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            <div class="croptops_nav">
                <a onclick="goto(1);"><img src="/images/activity/croptops_nav1.png" /></a>
                <a onclick="goto(2);"><img src="/images/activity/croptops_nav2.png" /></a>
                <a onclick="goto(3);"><img src="/images/activity/croptops_nav3.png" /></a>
                <a onclick="goto(4);"><img src="/images/activity/croptops_nav4.png" /></a>
            </div>
            <!-- banner805 -->
            <div class="banner" id="banner">
                <div class="ibanner">
                    <ul class="bannerPic">
                        <li><a href="#" title=""><img src="/images/es/activity_croptops_banner1.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/es/activity_croptops_banner2.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/es/activity_croptops_banner3.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/es/activity_croptops_banner4.jpg" alt="" /></a></li>
                    </ul>
                    <div class="banner_lr">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit1 fix mb25">
                    <h4 id="d1"><img src="/images/activity/croptop_tit1.png" />TOPS CORTOS</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VER MAS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
                        <?php
                        $products = Catalog::instance($catalogs[0], LANGUAGE)->products();
                        for($i = 0;$i < 4;$i ++)
                        {
                            ...
                            ?>
                            <li>
                                <a href="<?php echo Product::instance($product_id, LANGUAGE)->permalink(); ?>"><img src="<?php echo Image::link(Product::instance($product_id)->cover_image(), 1); ?>" /></a>
                                <?php if ($product_inf['type'] != 0): ?>
                                    <a href="#" id="<?php echo $product_id; ?>" class="quick_view JS_shows1">VISTA RÁPIDA</a>
                                <?php endif; ?>
                                <a href="<?php echo Product::instance($product_id, LANGUAGE)->permalink(); ?>" class="name"><?php echo $product_inf['name']; ?></a>
                                <p class="price fix">
                                    <?php
                                    ...
                                    if ($orig_price > $price)
                                    {
                                        ...
                                        <span class="off"><?php echo $off; ?>% MENOS</span>
                                        <?php
                                    }
                                    else
                                    {
                                ...
                                if ($onsale == 0)
                                {
                                    echo '<span class="outstock">VISTA RÁPIDA</span>';
                                }
                                else
                                {
                    ...
                    for($i = 4;$i < count($products);$i ++)
                    {
                        $product_id = $products[$i];
                            ...
                            <li>
                                ...
                                if ($onsale == 0)
                                {
                                    echo '<span class="outstock">VISTA RÁPIDAt</span>';
                                }
                                else
                                {
                                    $is_sale = round($product_inf['price'], 2) > Product::instance($product_id)->price() ? 1 : 0;
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit2 fix mb25">
                    <h4 id="d2"><img src="/images/activity/croptop_tit2.png" />FALDAS</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VER MAS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit3 fix mb25">
                    <h4 id="d3"><img src="/images/activity/croptop_tit3.png" />CAMISETAS</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VER MAS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit4 fix mb25">
                    <h4 id="d4"><img src="/images/activity/croptop_tit4.png" />PANTALONES CORTOS</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VER MAS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
...
<script>
$(function(){
    //De View more/View less
    $('.scroll_list .De_JS_view_morebtn').click(function(){
        var _this = $(this);
        _this.parents(".scroll_list").children(".view_morecon").slideToggle();
//        _this.parents(".scroll_list").siblings().children(".view_morecon").slideUp();
        if(_this.html()=="VER MENOS"){
            _this.html("VER MAS");
            _this.parents(".scroll_list").siblings().find(".De_JS_view_morebtn").html("VER MENOS");
        }
        else{
    ...
    $('.dress_list .De_JS_view_morebtn').click(function(){
        var _this = $(this);
...
//        _this.parents(".dress_list").siblings().children(".view_morecon").slideUp();
        if(_this.html()=="VER MENOS"){
            _this.html("VER MAS");
            _this.parents(".dress_list").siblings().find(".De_JS_view_morebtn").html("VER MENOS");
        }
        else{
            _this.html("VER MENOS");
        }
