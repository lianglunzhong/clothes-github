    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll">
                ...
                &gt;<span>BUSCAR : <strong><?php echo $keywords; ?></strong>
            </div>
        </div>
    </div>
    <div class="grid">
        <article class="filter_page">
            <ul class="filter-bar cf">
                <li style="float:left;"><div>Ordenar por:&nbsp;</div></li>
                <li class="item-l choice" style="width:160px;">
                    <div class="choice-hd">
                        <?php
                        $ens = array("Default", "What's New", 'Best Seller', 'Price: Low To High', 'Price: High To Low');
                        $trns = array('Defecto', 'Novedades', 'Mejor Vendido', 'Precio De Mayor A Menor', 'Precio De Menor A Mayor');
                        if(isset($_GET['sort']))
                        {
                    ...
                    <ul class="choice-list" style="width: 180px;">
                    <?php
                ...
                <?php
                    ...
                    ?>
                    <a href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . Security::xss_clean(implode('&', $gets1)); ?>" class=""> <i class="icon icon-pick"></i> Elección de Celebridad</a>
                </li>
                ...
                foreach ($products as $i => $product_id)
                {
                    ...
                    <li class="pro-item">
                        ...
                        <?php if ($product_inf->get('type') != 0): ?>
                            <a href="#" id="<?php echo $product_id; ?>" class="quick_view JS_shows1"><span class="btn-qv">VISTA RÁPIDA</span></a>
                        <?php endif; ?>
                        <?php
                        $onsale = 1;
        ...
        else
        {
            ...
            <div class="notfound">
                    ...
                    <div class="searchon_box">
                        <p class="top"><strong>¡Lo siento!</strong> El artículo que usted está buscando no se ha encontrado,<br />
