...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  BUYERS SHOW</div>
        </div>
                ...
                <div class="top">
                    <div class="fix">
                        ...
                        <div class="fll con">
                            ...
                            <p><a href="<?php echo $link; ?>" id="<?php echo $c_images['product_id']; ?>" class="btn40_16_black btn mb20 quick_view JS_shows1"> COMPRAR AHORA</a></p>
                            <?php
                            if ($c_images['type'] != 1 && $c_images['link_sku'] && strlen($c_images['link_sku']) > 0)
                            {
                                ?>
                                <p><a class="btn40_16_red btn mb50 JS_popwinbtn4">CONSEGUIR EL LOOK</a></p>
                                <?php
                            }
                            ?>
            ...
            <div id="productInfo">
                <dl>
                    <dd>
                        ...
                        <div class="detils" style="width:190px;"><a id="product_link" href="#" title="VER COMPLETO DETALLES">VER COMPLETO DETALLES</a></div>
                        <div class="clear"></div>
                    </dd>
                    <dd>
                        <div class="price">
