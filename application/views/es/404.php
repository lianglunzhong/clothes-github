...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  404</div>
        </div>
    </div>
            ...
            <section class="pro_list">
                ...
                <div class="searchon_wp">
                    <div class="searchon_404 center">
                        ...
                        <!-- 英语站 -->
                        <p class="font24 mt50">Pedimos disculpas por cualquier inconveniente.</p>
                        <p class="font24">Aquí está su código exclusivo de <b class="red">20% MENOS</b> : </p>
                        <p class="b"><b class="red font18"><?php echo $code; ?></b> (Expirará en 30 días)</p>
                        <p class="text_upper mb20"><b>EL CÓDIGO PUEDE SER UTILIZADO SOLAMENTE UNA VEZ.</b></p>
                        <p><a href="http://www.choies.com/<?php echo LANGUAGE; ?>/choies-highlights" class="b">COMPRAR AHORA >></a></p>
                    </div>
                    <div class="banner_404 fix">
                        <div class="left">
                            <p class="mb10"><b>ENVIAR EL CÓDIGO A MI CORREO >></b></p>
                            <form action="<?php echo LANGPATH; ?>/site/404_mail" method="post" class="form">
                                <input type="hidden" name="code" value="<?php echo $code; ?>" />
                                <input type="text" name="email" value="Introduzca La Dirección De Email" class="text" />
                                <input type="submit" value="ENVIAR" class="btn" />
                            </form>
                        </div>
                        <div class="right">
                            <p>¿UNA SOLICITUD ESPECIA?</p> 
                            <b><a href="http://www.choies.com/<?php echo LANGUAGE; ?>/contact-us">¡CONTACTO CON NOSOTROS!</a></b>
                        </div>
                    </div>
                </div>
                <div class=" font18 mb25">O usted puede tener un vistazo a nuestros productos más vendidos:</div>
                <!-- pro_listcon -->
                        ...
                        foreach ($top_seller as $product):
                            ...
                            <li>
                                ...
                                <?php if (Product::instance($product['product_id'])->get('type') != 0): ?>
                                    <a href="#" id="<?php echo $product['product_id']; ?>" class="quick_view">VISTA RÁPIDA</a>
                                <?php endif; ?>
                                ...
                                <p class="price fix">
                                    ...
                                    if ($retail > $now)
                                    {
                                        ...
                                        ?>
                                        <b><?php echo Site::instance()->price($now, 'code_view'); ?></b>    <del><?php echo Site::instance()->price($retail, 'code_view'); ?></del> <span class="off"><?php echo (int) $off; ?>% MENOS</span>
                                        <?php
                                    }
                                    else
                                    {
                                ...
                                <?php if (!Product::instance($product['product_id'])->get('status')): ?>
                                    <span class="outstock">Fuera De Stock</span>
                                <?php endif; ?>
                            </li>
                            <?php
                            $key++;
