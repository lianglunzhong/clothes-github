...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  Mi show del blog</div>
        </div>
                ...
                <ul class="tab-con">
                    <li <?php echo $onshowed ? 'style="display:none;"' : 'style="display:block;"'; ?>>
                        ...
                        <table class="orderTable">
                            <tr>
                                <th>Show No.</th>
                                <th>La Información De Producto.</th>
                                <th>Enlace De Show</th>
                            </tr>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td width="306">
                                        <dl class="pr-info fix">
                                            ...
                                            <dd>artículo# : <?php echo $data['sku']; ?></dd>
                                            <dd><?php echo Product::instance($product_id, LANGUAGE)->get('name'); ?></dd>
                                            <dd>Pedido NO.: <a><?php echo $data['ordernum']; ?></a></dd>
                                            <dd><input type="button" class="copy-link view_btn btn26 btn40" style="width: 150px;" name="<?php echo Product::instance($product_id)->permalink() . '?cid=' . $cele_id; ?>" value="Copiar El Enlace" /></dd>
                                        </dl>
                                    </td>
                                    <td width="310">
                                        <dl class="show-link">
                                            <form action="<?php echo LANGPATH; ?>/customer/add_url?<?php echo http_build_query($_GET); ?>" method="post">
                                                ...
                                                <dd><a class="addMoreLink">Añadir uno mas enlace</a></dd>
                                                <dd><input type="submit" class="view_btn btn26 btn40" value="PRESENTAR" /></dd>
                                            </form>
                                        </dl>
                                    </td>
                                </tr>
                                            ...
                                            <dd>
                                                <div class="edit-url" style="display:none;">
                                                    <form action="<?php echo LANGPATH; ?>/customer/edit_url?<?php echo http_build_query($_GET); ?>" method="post">
                                                        ...
                                                        <br/>
                                                        <div class="more"></div>
                                                        <a class="addMoreLink">Añadir uno mas enlace</a>
                                                        <br/>
                                                        <input type="submit" class="view_btn btn26 btn40" style="width: 85px;margin-right: 20px;height: 20px;line-height: 20px;" value="PRESENTAR">
                                                        <a href="#" class="link-cancel" style="text-decoration:underline;margin-left:10px;">Cancelar</a>
                                                        <br/><br/>
                                                    </form>
                                                </div>
                                                <input type="button" name="" class="link-edit view_btn btn26 btn40" value="EDITAR" />
                                            </dd>
                                        </dl>
                                    </td>
                                </tr>
