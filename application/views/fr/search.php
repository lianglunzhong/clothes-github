    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll">
                ...
                &gt;<span>Rechercher : <strong><?php echo $keywords; ?></strong>
            </div>
        </div>
    </div>
    <div class="grid">
        <article class="filter_page">
            <ul class="filter-bar cf">
                <li style="float:left;"><div>Trier par:&nbsp;</div></li>
                ...
                <?php
                    ...
                    ?>
                    <a href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . Security::xss_clean(implode('&', $gets1)); ?>" class=""> <i class="icon icon-pick"></i> Choix de l'icône</a>
                </li>
        ...
        else
        {
            ...
            <div class="notfound">
                ...
                <div class="searchon_box">
                    <p class="top"><strong>Désolé!</strong> L'article que vous recherchez n'a pas été trouvé,<br/>
                    ou votre page cible est mise à jour pour le moment...
                    </p>
                    <p><a href="<?php echo LANGPATH; ?>/contact-us" class="bottom">Demande spéciale ? Contacter- nous!</a></p>
                </div>
                <div class=" font18 mb25">Ou vous pouvez jeter un œil à nos meilleures ventes</div>
