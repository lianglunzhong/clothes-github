<ul class="filter-bar cf">
    ...
    {
        $childrens = array(
            array('Robes', LANGPATH . '/dresses-c-92'),
            array('Robes Noires', LANGPATH . '/dresses-c-92/all/all/color_8'),
            array('Robes En Dentelle', LANGPATH . '/dresses-c-92/all/all/Detail_124'),
            array('Robes Moulantes', LANGPATH . '/dresses-c-92/all/all/Silhouette_62'),
            array('Maxi Robes', LANGPATH . '/dresses-c-92/all/all/dresses-c-92-Length_73'),
            array('Robes Patineuse', LANGPATH . '/dresses-c-92/all/all/Silhouette_69'),
            array('Robes Floral', LANGPATH . '/dresses-c-92/all/all/Pattern-Type_82'),
            array('Robes Mousseline', LANGPATH . '/dresses-c-92/all/all/Material_19'),
            array('Robes à Manches Longues', LANGPATH . '/dresses-c-92/all/all/Sleeve-Length_56'),
            array('Robes Soirée', LANGPATH . '/dresses-c-92/all/all/Shop-Looks_35'),
            array('Robes de Bal', LANGPATH . '/homecoming-dress-c-454'),
        );
    }
    else
    {
    ...
    <li class="item-l choice" style="width:110px;">
        <div class="choice-hd">
            <?php
...
?>
    <li class="item-r choice">
        <div class="choice-hd">
            Catégorie <i class="fa fa-caret-down"></i>
        </div>
...
?>
    <li id="JS_filterAll" class="item-r filter-all">
        Tous les filtres <i class="fa fa-caret-down"></i>
    </li>
</ul>
                    ...
                    foreach ($children as $catalog)
                    {
                        ...
                        <li class="choice-option">
                            <a href="<?php echo LANGPATH; ?>/<?php echo $catalog['link'] . '-c-' . $catalog['id'] . '/' . $links[1] . '/' . $links[2] . '/' . $links[3]; ?>">
                                <label><?php echo ucfirst($catalog['name']); ?></label>
                            </a>
                        </li>
                        <?php
                    }
...
if (!empty($custom_filter['filter_attirbutes']) OR !empty($custom_filter['price_range']) OR $has_size):
    ...
    <div class="filter-selected">
        ...
        if($has_size)
        {
            ...
            ?>
            <span class="item">
                <a href="<?php echo $href . $limit_link; ?>"><i class="fa fa-times-circle fa-lg"></i><?php echo 'Taille:'.$size_filter[$links[1]]; ?></a>
            </span>
            <?php
        }
        if (isset($custom_filter['price_range']))
        {
            ...
            ?>
            <span class="item">
                <a href="<?php echo $href . $limit_link; ?>"><i class="fa fa-times-circle fa-lg"></i><?php echo 'Prix:$' . $custom_filter['price_range'][0] . ' ~ $' . $custom_filter['price_range'][1]; ?></a>
            </span>
            <?php
        }
        ...
        ?>
        <span class="item">
            <a href="<?php echo LANGPATH . $uris[0] . '/' . $uris[1]; ?>"><span class="clearall">Effacer tout</span></a>
        </span>
    </div>
    <?php
endif;
