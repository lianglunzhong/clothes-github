...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">ACCUEIL</a>  >  CHOIX SAISONNIERS</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="banner" id="banner">
                <div class="ibanner">
                    <ul class="bannerPic">
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/activity_croptops_banner1.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/activity_croptops_banner2.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/activity_croptops_banner3.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/activity_croptops_banner4.jpg" alt="" /></a></li>
                    </ul>
                    <div class="banner_lr">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit1 fix mb25">
                    <h4 id="d1"><img src="/images/activity/croptop_tit1.png" />TOPS COURTS</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VOIR PLUS</a>
                </div>
                        ...
                        for($i = 0;$i < 4;$i ++)
                        {
                            ...
                            <li>
                                ...
                                <?php if ($product_inf['type'] != 0): ?>
                                    <a href="#" id="<?php echo $product_id; ?>" class="quick_view JS_shows1">VUE RAPIDE</a>
                                <?php endif; ?>
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit2 fix mb25">
                    <h4 id="d2"><img src="/images/activity/croptop_tit2.png" />JUPES</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VOIR PLUS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit3 fix mb25">
                    <h4 id="d3"><img src="/images/activity/croptop_tit3.png" />T-shirts</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VOIR PLUS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit4 fix mb25">
                    <h4 id="d4"><img src="/images/activity/croptop_tit4.png" />Shorts</h4>
                    <a class="view_morebtn De_JS_view_morebtn">VOIR PLUS</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
...
//        _this.parents(".scroll_list").siblings().children(".view_morecon").slideUp();
        if(_this.html()=="VOIR PLUS"){
            _this.html("VOIR MOINS");
            _this.parents(".scroll_list").siblings().find(".De_JS_view_morebtn").html("VOIR PLUS");
        }
        else{
            _this.html("VOIR PLUS");
        }
    }) 
...
//        _this.parents(".dress_list").siblings().children(".view_morecon").slideUp();
        if(_this.html()=="VOIR PLUS"){
            _this.html("VOIR MOINS");
            _this.parents(".dress_list").siblings().find(".De_JS_view_morebtn").html("VOIR PLUS");
        }
        else{
            _this.html("VOIR PLUS");
        }
