                ...
                if (!empty($children))
                {
                    ...
                    <ul class="menu JS_menu <?php echo!$on ? ' hide' : ''; ?>">
                        <?php if ($catalog->link != 'occasion-dresses'): ?>
                            <li><a <?php if ($on AND isset($links[1]) AND $links[1] == 'new') echo 'style="color:#F66;"' ?> href="<?php echo LANGPATH; ?>/<?php echo $catalog->link; ?>/new">NOUVEAUTÉ</a></li>
                        <?php endif; ?>
