        ...
        <div class="lookbook_details_rows1 fix">
            ...
            <div class="right fll">
                <div class="top">
                    <div class="fix">
                        ...
                        <div class="fll con">
                            ...
                            <p><a href="<?php echo $link; ?>" id="<?php echo $c_images['product_id']; ?>" class="btn40_16_black btn mb20 quick_view JS_shows1">ACHETER MAINTENANT</a></p>
                            <?php
                            if ($c_images['type'] != 1 && $c_images['link_sku'] && strlen($c_images['link_sku']) > 0)
                            {
                                ?>
                                <p><a class="btn40_16_red btn mb50 JS_popwinbtn4">OBTENIR LE LOOK</a></p>
                                <?php
                            }
                            ?>
                ...
                if ($c_images['type'] != 1 && $c_images['link_sku'] && strlen($c_images['link_sku']) > 0)
                {
                    ?>
                    <div class="bottom">
                        <h2>Équiper cet article avec</h2>
                ...
                <div class="review-form">
                    ...
                    else
                    {
                        ...
                        <form action="<?php echo LANGPATH; ?>/customer/login" method="post" class="form form1 user_form" id="loginForm">
                            <input type="hidden" value="<?php echo 'http://' . Site::instance()->get('domain') .LANGPATH.'/lookbook/' . $c_images['id'] . '-1#pagefocus'; ?>" name="referer">
                            <b>Veuillez vous connecter d'abord</b>
                            <ul class="mtb10">
                                <li class="fix">
                                    <label for="email"><span>*</span> Votre e-mail :</label>
                                ...
                                <li class="fix">
                                    <label for="submit">&nbsp;</label>
                                    <div class="right_box"><input type="submit" value="SE CONNECTER" class="view_btn btn26 btn40" /></div>
                                </li>
                            </ul>
                        </form>
                        <script>
            ...
            <div id="productInfo">
                <dl>
                    <dd>
                        ...
                        <div class="infoText">Article# : <span id="product_sku">CPDL1959</span></div>
        ...
        <div class="look_pro">
            ...
            <form action="<?php echo LANGPATH; ?>/cart/add_more" method="post" class="form3" id="form<?php echo $key; ?>">
                                            ...
                                            <li>
                                                ...
                                                <p class="select">taille: 
                                                    <select name="size[<?php echo $n; ?>]" class="size_select">
                                                        ...
                                                        if(!empty($pro_stocks))
                                                        {
                                                            echo '<option>Choisir Taille</option>';
                                                            ...
                                                            ?>
                                                            <option value="<?php echo str_replace('EUR', '', $sizeval); ?>" ><?php echo $sizeval; ?> <span class="red">(Seulement <?php echo $p; ?> restant!)</span></option>
                                                            <?php
                                                            }
                                                        }
                                                        else
                                                ...
                                                <p class="select">QTÉ: <input type="text" class="text" name="qty[<?php echo $n; ?>]" value="1" /></p>
                                                <?php
                                                }
                                                ?>
                                                <p class="center"><a href="<?php echo $sku_link; ?>" class="btn22_gray" target="_blank">VOIR LES DÉTAILS</a></p>
                                                <?php
                                                if (!$instock)
                                                    echo '<span class="outstock">EN RUPTURE DE</span>';
                                                ?>
                                            </li>
                                            <?php
                                        }
                                ...
                                <div class="center mt50">
                                    <input type="submit" value="Ajouter au Panier" class="btn40_16_red" /><a href="<?php echo LANGPATH; ?>/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a_underline add_wishlist">LISTE DE SOUHAITS</a>
                                </div>
