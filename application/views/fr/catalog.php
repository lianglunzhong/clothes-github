        ...
        <section id="container" class="flr">
            ...
            if ($show)
            {
                ...
                <ul class="JS_tab3 detail_tab hotnew_box fix" style="margin-top:0;">
                    <?php
                    if ($show == 1)
                        echo '<li class="on">choix chauds</li>';
                    elseif ($show == 2)
                        echo '<li class="on">New Arrivals</li>';
                    elseif ($show == 3)
                        echo '<li class="on">choix chauds</li><li>New Arrivals</li>';
                    ?>
                </ul>
                ...
                <article class="filter_page">
                    <ul class="select fix">
                        <li class="wdrop">
                            <select class="select_style" id="filter" onchange="tolink();">
                                ...
                                foreach ($sorts as $key => $sort):
                                    ...
                                    $trns = array('Par Défaut','Nouveauté', 'Best-seller', 'Prix croisant', 'Prix décroissant');
                        ...
                        if (!empty($gets1))
                        {
                            ...
                            $gets1[] = 'pick=1';
                        ?>
                        <span><a class="icon_pick" href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . implode('&', $gets1); ?>" title="Choix de l'idole"></a></span>
                        <li class="last">
                            <?php
                            echo $pagination;
                            ?>
                    ...
                    <div class="results_box fix">
                        ...
                        if (!empty($custom_filter)):
                            ...
                            <a href="<?php echo LANGPATH . $uris[0] . '/' . $uris[1] . '/' . $uris[2]; ?>"><span class="clearall flr">Effacer Tout</span></a>
                            <?php
                        endif;
                        ?>
                    </div>
                            ...
                            <?php
                                ...
                                ?>
                                    <div class="pic">
                                        <a href="<?php echo Product::instance($product_id, LANGUAGE)->permalink(); ?>">
                                            ...
                                            {
                                                ?>
                                                <div class="pic2" style="display:none;"><img data-original="http://img1.choies.com/pimg/192/<?php echo $images[1]['id'].'.'.$images[1]['suffix']; ?>" src="/images/loading.gif" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                                <?php
                                            }
                                            ?>
                                        </a>
                                ...
                                <p class="price fix">
                                    ...
                                    if ($orig_price > $price)
                                    {
                                        ...
                                        <br/><span class="off"><?php echo $off; ?>% de réduction</span>
                                        <?php
                                    }
                                    else
                                    {
            ...
            <article class="filter_page">
                <ul class="select fix">
                    <li><a class="icon_pick" href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . implode('&', $gets); ?>">Choix de l'idole</a></li>
                    <li class="last">
                        <?php
                        echo $pagination;
                        ?>
