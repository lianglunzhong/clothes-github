...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Accueil</a>
                <?php
            ...
            <div class="flr"><a href="<?php echo $crumbs[0]['link'] ?>">Revenir à <?php echo $crumbs[0]['name'] ?></a></div>
        </div>
    </div>
    ...
    <section class="layout fix">
            ...
            <div class="pro_left fll" >
                ...
                <div style="width:480px;">
                    <div id="JS_thumbnail" class="thumbnail clearfix">
                        <span id="JS_thumbnailPrev" class="trigger prev">précédent</span>
                        ...
                        <span id="JS_thumbnailNext" class="trigger next">suivant</span>
                    </div>
            ...
            <div class="pro_right flr">
                <dl>
                    <dd>
                        ...
                        <div class="fix">
                            <p style="padding-bottom:12px;color:#999;">
                                ...
                                ?>
                            <span id="product_status" style="margin-right:15px;color:#000;"><?php echo $instock ? 'Disponible' : '<strong class="red">En rupture de Stock</strong>'; ?></span>
                            Article#: <?php echo $product->get('sku'); ?>
                            <?php
                            if(!empty($brands))
                            {
                                ?>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/brand/list/<?php echo $brands['id']; ?>" class="ml10"><i>par <?php echo $brands['name']; ?></i></a>
                                <?php
                            }
                            ?>
                            </p>
                            <?php if ($product->get('presell') > time()): ?>
                            <p>Pré-vente: <b class="red"><?php echo $product->get('presell_message'); ?></b></p>
                            <?php endif; ?>
                        </div>
                    </dd>
                    <dd class="fix info jiage" style="margin-top:15px;">
                        ...
                        if ($vip_level)
                        {
                            if($vip_promotion_price AND $vip_level >= 2)
                            {
                                if ($p_price > $price)
                                {
                                    ...
                                    ?>
                                        ...
                                        <i><?php if($rate > 0) echo $rate; ?>% DE RÉDUCTION</i>
                                    <?php
                                }
                            }
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    ?>
                                    prix VIP. <?php echo $currency_change; ?><?php echo Site::instance()->price($vip_price, 'code_view'); ?>
                                    <?php
                                }
                            }
                        }
                        else
                        {
                            ...
                            else
                            {
                                ?>
                                    ...
                                    PRIX: <span style="font-Tallas:24px;"><?php echo $currency_change; ?><span class="product_price"><?php echo Site::instance()->price($price, 'code_view'); ?></span></span>
                                <?php
                            }
                        }
                        ?>
                        ...
                        {
                            ?>
                            <a href="<?php echo LANGPATH; ?>/customer/login?redirect=/product/<?php echo $product->get('link'); ?>_p<?php echo $product_id; ?>" style="text-decoration:underline;font:Arial, Helvetica, sans-serif;font-Tallas:11px;" class="pro_sign JS_popwinbtn1" id="sign_in">Se connecter</a> pour les privilèges VIP<br>
                            <?php
                        }
                        ?>
                        <?php
                        ...
                        if($vip_promotion_price)
                        {
                            if($customer_id)
                            {
                                ...
                                {
                                    ?>
                                        <strong style="color:#FF5200;">prix de VIP. <span style="font-size: 16px;"><?php echo $currency_change; ?><?php echo Site::instance()->price($vip_promotion_price, 'code_view'); ?></span></strong>
                                    <?php
                                }
                            }
                            else
                    ...
                    <dd>
                        ...
                        <div class="timeleft_box mb10">
                            <div class="JS_daoend hide">C'est fini!</div>
                            <div class="JS_dao">Promo se termine dans: <strong class="JS_RemainD"></strong>d <strong class="JS_RemainH"></strong>h <strong class="JS_RemainM"></strong>m <strong class="JS_RemainS"></strong>s</div>
                        </div>
                        <?php
                        }
                        ?>
                    ...
                    <dd class="last" style="margin-top:25px;">
                        ...
                        <div  class="fix">   
                            ...
                            {
                            ?>
                                <a target="_blank" href="#" class="text_underline JS_popwinbtn1" id="write_review" style="margin-left:10px;font-weight:bold;" >Écrire un commentaire</a>
                            <?php
                            }
                            else
                            {
                                ?>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" class="text_underline" style="margin-left:10px;font-weight:bold;" >Écrire un commentaire</a>
                                <?php
                            }
                            ?>
                        </div>
                        ...
                        <form action="/cart/add" method="POST" id="formAdd">
                            ...
                            <div class="size">
                                <div class="selected_box fix">
                                    <p class="left" style="font-weight:bold;">
                                        <span id="select_size">Sélectionner la taille:</span> <span class="selected"></span>
                                ...
                                {
                                ?>
                                    <span class="JS_popwinbtn2 fix" style="cursor:pointer;float:right;margin-top:3px;text-decoration: underline;font-weight: bold;">Guide des tailles</span>
                                <?php
                                }
                                ?>
                                </div>
                                <script type="text/javascript">
                                    $(function(){
                                        $(".size_list li").live("click",function(){
                                            ...
                                            $(this).addClass('on');
                                            $("#select_size").html('TAILLE: '+$(this).text());
                                            if(qty)
                                                $("#only_left").html('seulement '+qty+' restants!');
                                        })
                            ...
                            if (!empty($attributes['color']))
                            {
                                ...
                                <div class="color">
                                    ...
                                    <p class="selected_box"><span class="selected" id="select_color">sélectionner la couleur:</span></p>
                                        ...
                                        foreach ($attributes['color'] as $attribute)
                                        {
                                            ...
                                            <li>
                                                ...
                                                <div class="colorBox hide">
                                                    ...
                                                    <p class="colorBoxcon">
                                                        <strong class="btn_size_normal" id="<?php echo $attribute; ?>"><?php echo $attribute; ?></strong> (Mousseline)
                                                    </p>
                                                </div>
                                            </li>
                                            <?php
                                ...
                                <script type="text/javascript">
                                    $(function(){
                                        $(".color_list .colorBoxcon strong").live("click",function(){
                                            ...
                                            $("#select_color").html('couleur: '+$(this).val());
                                        })
                                        ...
                                        $('#addCart').live("click",function(){
                                            ...
                                            if(!size)
                                            {
                                                alert('Veuillez ' + $('#select_color').html());
                                                return false;
                                            }
                                        })
                                    })
                            ...
                            {
                                ?>
                                <div id="select_type" class="mb10">Sélectionner le type:</div>
                                <div class="btn_type">
                                ...
                                <script type="text/javascript">
                                    $(function(){
                                        ...
                                        $('#addCart').live("click",function(){
                                            ...
                                            if(!size)
                                            {
                                                alert('Veuillez ' + $('#select_type').html());
                                                return false;
                                            }
                                        })
                                    })
                            ...
                            <div class="total">
                                ...
                                <span class="font14" style="margin-left:8px;display:inline-block;">Qté:</span><br />
                                ...
                                <br>
                                <input type="submit" value="Ajouter au panier" id="addCart" class="btn40_16_red" style="font-Tallas:18px;<?php if(!$instock) echo 'display:none;'; ?>" />
                                <span class="btn40_16_gray" id="outofstock" style="font-Tallas:18px;<?php if($instock) echo 'display:none;'; ?>" />En rupture de Stock</span>
                                ...
                                $wishlists = DB::select(DB::expr('COUNT(id) AS count'))
                                        ...
                                        ->execute()->get('count');
                                ?>
                                Liste d’envies <?php echo $wishlists ? '(' . $wishlists . ' ajoutés)' : ''; ?>
                                </a>
                                <div class="same-paragraph same-paragraph1">
                                    <label>AUTRES COULEURS:</label>
              ...
              $(".swrp").hover(function(){
                   ...
                   $(this).hide();
                        ...
                        <ul class="JS_tab detail_tab fix">
                            ...
                            {
                                $models .= 'Modèle porte: ' . $product->get('model_size') . '<br><br>';
                            }
                            ...
                            if($model_id)
                            {
                                ...
                                $models .= 'Hauteur: ' . $height_ft .' | Poitrine: ' . $bust_in . ' | Taille: ' . $waist_in . ' | Hanche: ' . $hip_in . '<br>';
                                $models .= 'Hauteur: ' . $modelArr['height'] . ' cm | Poitrine: ' . $modelArr['bust'] . ' cm | Taille: ' . $modelArr['waist'] . ' cm | Hanche: ' . $modelArr['hip'] . ' cm' . '<br>';
                            }
                            if($models)
                            {
                                ?>
                        ...
                        <div class="JS_tabcon detail_tabcon">
                            <div class="bd">
                                ...
                                $brief = str_replace(array('One size', 'one size', 'One Size'), array('taille unique'), $brief);
                                echo $brief; ?>
								 <span class="JS_popwinbtn2 fix" style="cursor:pointer;margin-top:3px;text-decoration: underline;font-weight: bold;">Guide des tailles</span>
								 <?php
								 echo '<br><br>';
								if($has == 0){
									$description = $prodes;
                            ...
                            <div class="bd hide">
                                ...
                                <h4>Livraison:</h4>
                                <p>(1)  Livraison gratuite dans le monde entier (15-20 jours ouvrables)</p>
        ...
        <article class="buyshow_box layout fix">
            <div class="w_tit layout">
                <ul class="fix dingbu" style="float:left;">
                    ...
                    <li class="current">SHOW DES ACHETEURS</li>
                    <?php endif; ?>
                    <?php if ($product->get('has_link') == 1 AND !empty($link_images)): ?>
                    <li <?php if(empty($celebrity_images)) echo 'class="current"'; ?>>STYLES ET CONSEILS</li>
                    <?php endif; ?>
                    <?php if (isset($videos) AND !empty($videos)): ?>
                    <li <?php if ($product->get('has_link') == 0 AND empty($link_images) AND empty($celebrity_images)) echo 'class="current"'; ?>>VIDEO DU CLIENT</li>
                    <?php endif; ?>
                    <p><b></b></p>
                </ul>
            </div>
            ...
            <div class="product_carousel fix ts">
                ...
                if($count > 8)
                {
                    ...
                    <?php
                    echo '<div class="view1 fix"><p>Voir Plus+</p></div>';
                }
                ?>
            </div>
            <?php
            ...
            ?>
                <div class="pro_lookwith fix ts <?php if(!empty($celebrity_images)) echo 'hide'; ?>" style="width:1024px;height:auto;margin:0 auto;overflow: hidden;">
                    <div style="float:left;">
                        <?php foreach ($link_images as $key => $link_img) : ?>
                            <ul class="fix" style="height:493px;<?php if($key > 0) echo 'display:none;'; ?>">
                                ...
                                <li style="overflow: hidden; float: left; width: 613px; height: 510px;">
                                    ...
                                    <p class="fix"><a class="btn40_16_red flr JS_popwinbtn4" title="<?php echo $key; ?>">STYLES ET CONSEILS</a></p>
                                </li>
                            </ul>
                        <?php endforeach; ?>
                        <?php
                        ...
                        {
                            ?>
                            <a class="view_more flr mr15" onclick="$('.pro_lookwith .fix').show();$(this).hide();">Voir Plus+</a>
                            <?php
                        }
                        ?>
                    </div>
                        ...
                        <ul class="JS_pro_small">
                            ...
                            foreach ($videos as $key => $video):
                                ...
                                <li class="fix current" title="video<?php echo $key; ?>">
                                    ...
                                    <div class="con">
                                        ...
                                        <p class="name">par: <?php echo $author; ?></p>
                                    </div>
                                </li>
                                <?php
                            endforeach;
                            ...
                            <li class="less">
                                <a href="<?php echo LANGPATH; ?>/blogger/programme">
                                    Possédez-vous un blog de mode? REJOIGNEZ CHOIES!<br />
                                    Le Programme De Blogueur De Mode Maintenant >>
                                </a>
                            </li>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $(".view1 p").click(function() {
                        ...
                        if(text == 'Voir Plus+')
                        {
                            $(".view1 p").text("Voir Moins-");
                        }
                        else if(text == 'Ver Menos-')
                        {
                            $(".view1 p").text("Voir Plus+");
                        }
                    })
                });
            </script>
                        ...
                        if (!empty($skus))
                        {
                            ...
                            <form action="<?php echo LANGPATH; ?>/cart/add_more" method="post" class="form3" id="form<?php echo $key; ?>">
                                ...
                                <div class="items<?php echo $key; ?>">
                                    <ul class="scrollableDiv1 scrollableDivs<?php echo $key; ?> fix">
                                        ...
                                        foreach ($skus as $sku)
                                        {
                                            ...
                                            ?>
                                            <li>
                                                <input type="checkbox" name="check[<?php echo $n; ?>]" title="size<?php echo $n; ?>" class="checkbox" checked="checked" id="checkout<?php echo $pro_id . $key; ?>" /> <label for="checkout<?php echo $pro_id . $key; ?>">Ajouter au panier</label>
                                                ...
                                                <p class="select">TAILLE: 
                                                    <select name="size[<?php echo $n; ?>]" class="size_select" <?php if(!$instock) echo 'disabled="disabled"'; ?>>
                                                        ...
                                                        if(!empty($pro_stocks))
                                                        {
                                                            echo '<option>Sélectionner la taille</option>';
                                                            ...
                                                            ?>
                                                            <option value="<?php echo str_replace('EUR', '', $sizeval); ?>" ><?php echo $sizeval; ?> <span class="red">(seulement <?php echo $p; ?>)</span></option>
                                                            <?php
                                                            }
                                                        }
                                                        else
                                                        ...
                                                        if (isset($attributes['Size']))
                                                        {
                                                            if(count($attributes['Size']) == 1)
                                                                ...
                                                                echo '<option>Sélectionner une taille</option>';
                                                        ...
                                                        else
                                                        {
                                                            $is_onesize = 1;
                                                            ?>
                                                            <option value="one size" <?php if (isset($pro_stocks['one size'])) echo 'title="' . $pro_stocks['one size'] . '"' ?>>taille unique</option>
                                                            <?php
                                                        }
                                                        }
                                                        ?>
                                                ...
                                                <p class="select">Qté: <input type="text" class="text" name="qty[<?php echo $n; ?>]" value="1" <?php if(!$instock) echo 'disabled="disabled"'; ?> /></p>
                                                <p class="center"><a href="<?php echo $sku_link; ?>" class="btn22_gray" target="_blank">Voir Détails</a></p>
                                                <?php
                                                if (!$instock)
                                ...
                                <div class="center mt50">
                                    <input type="submit" value="Ajouter au panier" class="btn40_16_red" /><a href="<?php echo LANGPATH; ?>/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a_underline add_wishlist">Ajouter à la liste d'envies</a>
                                </div>
        ...
        <div class="w_tit layout"><h2>D'autres Clients Ont Également Consulté</h2></div>
        <div class="box-dibu1">
        ...
        <article class="wufeng layout">
            <div class="box-title">
                <ul>
                    <li class="current">VENTE FLASH</li>
                    <li class="">Nouveautés</li>
                    <li class="">Meilleures Ventes</li>
                    <li class="">Consultés récemment</li>
                </ul>
                <p style="left: 180px;">
        ...
        <article class="product_reviews" style="margin-top:30px;">
            <div class="w_tit layout" style="margin-bottom:30px"><h2>COMMENTAIRES CLENTS</h2></div>
            <?php
            if(empty($reviews))
            {
            ?>
                <div style="text-align:center; margin-bottom:-40px;">
                    <img src="/images/product-detail_hongxin.jpg" /><span style="font-weight:bold; margin-left:10px;font-Tallas:16px;">0</span><span style=" margin-left:5px;font-Tallas:16px;">Commentaires</span>
                    <p style="margin-top:15px;font-Tallas:14px;">SOYEZ LE PREMIER À ÉCRIRE UN COMMENTAIRE</p>
                    <?php
                    if(!$customer_id)
                    {
                    ?>
                        <a class="JS_popwinbtn1 btn40_16_red" id="write_review1" href="javascript:void(0)" style="margin-top:18px;margin-bottom:100px; cursor:pointer;">Écrire un commentaire</a>
                    <?php
                    }
                    else
                    {
                        ?>
                        <a target="_blank" class="btn40_16_red" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" style="margin-top:18px;margin-bottom:100px; cursor:pointer;">Écrire un commentaire</a>
                        <?php
                    }
                    ?>
                </div>
                ...
                <div style="margin:0 0 20px 0;padding:10px 0 ; background-color:#fafafa;border:1px solid #CCC">
                    <div class="rating" style="margin:10px 0 0 0;">
                        <span class="s1" style="margin-left:30px;font-weight:bold;">
                            <strong class="<?php echo $star_class; ?>"></strong>Moyenne des commentaires
                        </span>
                        <span class="s1" style="margin-left:20px;font-weight:bold;">Note de la Qualité: <div class="outbt"><div style="width:<?php echo round($reviews_data['quality'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                        <span class="s1" style="margin-left:20px;font-weight:bold;">Note du Prix: <div class="outbt"><div style="width:<?php echo round($reviews_data['price'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></strong></span>
                        <span class="s1" style="margin-left:20px;font-weight:bold;">Note de la Forme: </span><span> <?php echo $review_title['fitness'][ceil($reviews_data['fitness'])]; ?></span>
                    </div>
                    <div style="margin:0 0 15px 0;">
                        <span class="s2" style="margin-left:139px;font-weight:bold;"><?php echo $reviews_data['overall']; ?> SUR 5(<?php echo $count_reviews; ?> Commentaires)</span>
                        <span class="s2" style="margin-left:148px;color:##727272;">
                            <?php
                        ...
                        <span class="s2" style="margin-left:156px;color:##727272;">
                            <?php echo $review_title['price'][ceil($reviews_data['price'])]; ?>
                        </span>
                    </div>
                    <div>
                        <span class="s2" style="margin:0 0 15px 30px;"><?php echo $count_reviews; ?> COMMENTAIRE<?php if($count_reviews > 1) echo 'S'; ?>  &nbsp; | &nbsp;   
                        <?php
                        if(!$customer_id)
                        {
                            ?>
                            <a href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" class="JS_popwinbtn1" id="write_review2" style="text-decoration:underline;">Écrire un commentaire</a>
                            <?php
                        }
                        else
                        {
                            ?>
                            <a target="_blank" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" style="text-decoration:underline;">Écrire un commentaire</a>
                            <?php
                        }
                        ?>
                        </span>
                ...
                ?>
                    ...
                    ?>
                        <li class="fix bgg">
                            <div class="left">
                                <dl>
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Nom:</span><span><?php echo $firstname; ?></span></dd>      
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">TAILLE:</span><span><?php echo $size ? $size : $attributes['size'][0]; ?></span></dd> 
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Forme:</span><span><?php echo $review_title['fitness'][$r['fitness']]; ?></span></dd>     
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Hauteur:</span><span><?php echo $r['height']; ?> CM</span></dd> 
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Poids:</span><span><?php echo $r['weight']; ?> KG</span></dd> 
                                </dl>
                            </div>
                            <div class="right">
                                <div class="rating1">
                                    <span class="s1" style="font-weight:bold;">
                                    Note Globale: <strong class="rating_show1 <?php echo 'star' . $r['overall']; ?>"></strong> (<?php echo $review_title['overall'][$r['overall']]; ?>)
                                    </span>
                                    <span class="s1" style="margin-left:20px;font-weight:bold;">Note de la Qualité: <div class="outbt"><div style="width:<?php echo round($r['quality'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                                    <span class="s1" style="margin-left:20px;font-weight:bold;">Note du Prix: <div class="outbt"><div style="width:<?php echo round($r['price'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                                </div>
                                <div class="reviews_boxcon" style="margin-top:20px;">
                                    ...
                                    ?>
                                        <div>
                                            ...
                                            <a onclick="$('#review_remain_<?php echo $r['id']; ?>').show();$(this).hide();" class="red">Voir Plus</a>
                                        </div>
                                    <?php
                                    }
                                    else
...
<div class="JS_popwincon2 popwincon w_p30 hide">
    ...
    <ul class="JS_tab4 detail_tab fix">
        <?php if ($set_id != 2): ?>
            <li class="current">VETEMENTS</li>
            <li>TABLEAU DE CONVERSION</li>
        <?php endif; ?>
        <?php if ($set_id == 2): ?>
            <li class="current">CHAUSSURES</li>
        <?php else: ?>
            <li>CHAUSSURES</li>
        <?php endif; ?>
        <?php if (Product::instance($product_id)->get('set_id') != 2 AND !empty($celebrity_lists)): ?>
            <li>Rapport D'essai</li>
        <?php endif; ?>
        <li>MESURES</li>
    </ul>
        ...
        if ($set_id != 2)
        {
            ...
            <div class="bd">
                ...
                <table class="user_table">
                    <tr>
                        <th width="10%" rowspan="2">Taille de Top</th>
                        <?php
                        if (!empty($us_sizes))
                        {
                            ?>
                            <th width="5%" rowspan="2">US Taille</th>
                            <th width="5%" rowspan="2">UK Taille</th>
                            <th width="5%" rowspan="2">EU Taille</th>
                            <?php
                        }
                        ?>
                        <th width="15%" colspan="2">Épaules</th>
                        <th width="15%" colspan="2">Poitrine</th>
                        <th width="15%" colspan="2">Taille</th>
                        <th width="15%" colspan="2">Hanche</th>
                        <th width="15%" colspan="2">Longueur</th>
                        <th width="15%" colspan="2">Longueur De Manche</th>
                    </tr>
                    <tr>
                        <th>pouce</th>
                        <th>cm</th>
            ...
            <div class="bd hide">
                ...
                if (array_key_exists($set_id, $hides))
                {
                    $hide = $hides[$set_id];
                    ?>
                    <h3>Vêtements-Tableau De Conversion De Taille Internationale</h3>
                    <table width="100%" class="user_table">
                        <tr>
                            <th width="5%" rowspan="2">US Taille</th>
                            <th width="5%" rowspan="2">UK Taille</th>
                            <th width="5%" rowspan="2">EU Taille</th>
                            <th width="15%" colspan="2" class="bust">Poitrine</th>
                            <th width="15%" colspan="2" class="waist">Taille</th>
                            <th width="15%" colspan="2" class="hip">Hanche</th>
                        </tr>
                        <tr>
                            <th class="bust">pouce</th>
                            <th class="bust">cm</th>
                            <th class="waist">pouce</th>
                            <th class="waist">cm</th>
                            <th class="hip">pouce</th>
                            <th class="hip">cm</th>
                        </tr>
                        <tr>
                            <td>2</td>
                ...
                <table width="100%" class="user_table">
                    ...
                    <tr>
                        <td class="b" bgcolor="f4f4f0">France/Espagne</td>
                        <td>30</td>
                        <td>32</td>
                        <td>34</td>
                        <td>36</td>
                    ...
                    <tr>
                        <td class="b" bgcolor="f4f4f0">Allemagne</td>
                        <td>32</td>
                        <td>34</td>
                        <td>36</td>
                        <td>38</td>
                    ...
                    <tr>
                        <td class="b" bgcolor="f4f4f0">Italie</td>
                        <td>34</td>
                        <td>36</td>
                        <td>38</td>
                        <td>40</td>
...
?>
        <div class="bd <?php if ($set_id != 2) echo 'hide'; ?>">
            ...
            <p>Veuillez utiliser ces tableaux des tailles pour aider à déterminer votre tailles. Comme les tailles sur notre site sont mesurées manuellement, il peut exister quelques nuances. Si vous avez une condition de dimensionnement spécifique ou vous souhaitez en savoir plus d'information, veuillez communiquer avec notre Service à la clientèle: <a href="mailto:service_<?php echo LANGUAGE; ?>@choies.com">service_<?php echo LANGUAGE; ?>@choies.com</a>. </p>
        </div>
        <?php
        if (Product::instance($product_id)->get('set_id') != 2 AND !empty($celebrity_lists))
        {
            ?>
            <div class="bd hide">
                <h3 class="center">Rapport D'essai</h3>
                <table width="100%" class="user_table">
                    <tr>
                        <th width="5%" rowspan="2">Nom</th>
                        <th width="5%" rowspan="2">Taille</th>
                        <th width="15%" colspan="2">Hauteur</th>
                        <th width="15%" colspan="2">Poids</th>
                        <th width="15%" colspan="2">Poitrine</th>
                        <th width="15%" colspan="2">Taille</th>
                        <th width="15%" colspan="2">Hanche</th>
                    </tr>
        ...
        <div class="bd size_mesurements hide">
            ...
            <div class="fix">
                ...
                <div class="right fll">
                    <h4>POITRINE</h4>
                    <p>Taille du tour de poitrine à l'endroit le plus fort, à travers les omoplates, et assurez-vous de passer sous votre bras, pas autour d'eux, N'oubliez pas de donner une mesure exacte, en faisant attention de ne pas ajouter de longueur supplémentaire à la mesure.</p>
                    <h4>TAILLE</h4>
                    <p>Mesurer autour de votre taille, juste au-dessus de votre hanche. la bande doit être proche de l'abdomen, mais ne devrait pas exercer de pression sur votre peau.</p>
                    <h4>HANCHES</h4>
                    <p>Prendre la bande lâche et enrouler autour de votre hanche, la bande doit être fixée à la plus grande partie de la hanche, celle qui est presque toujours sur les fesses.</p>
                    <h4>LONGUEUR DE ROBE</h4>
                    <p>Se tenir tout droit avec votre talon. Mesurer du point haut de votre épaules à votre arrière.  Veuillez choisir votre longueur appropriée selon la situation concrète.</p>
                </div>
            </div>
            <h3>CHAUSSURES</h3>
            <div class="fix">
                ...
                <div class="right fll">
                    <h4>Longueur des chaussures</h4>
                    <p>Mesurer les chaussures de chaque face de la partie de l'orteil à l'arrière du talon.</p>
                    <h4>Hauteur des chaussures</h4>
                    <p>Mesurer le dos des chaussures du haut des chaussure au bas des talons reposant sur une surface plane.</p>
                    <h4>Hauteur du talon</h4>
                    <p>Mesurer l'arrière de talon du point où elle se raccorde à la chaussure, appelée le côté sordide, vers le bas des talons reposant sur une surface plane.</p>
                    <h4>Hauteur de la plate-forme</h4>
                    <p>Mesurer du bas de la chaussure à où elle se raccorde à la chaussure en haut de la plate-forme.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    $(function(){
        $.ajax({
            ...
            success: function(product){
                if(product['status'] == 0)
                {
                    $("#product_status").html('<strong class="red">En rupture de Stock</strong>');
                    $("#addCart").hide();
                    $("#outofstock").show();
                }
                else
                ...
                var attributes = product['attributeSize'].replace('<span>one size</span>', '<span>taille unique</span>');
                <?php
                if($crumbs[0]['id'] == 53)
                {
                    ?>
                ...
                $("#select_size").html('Taille: '+$(".size_list li").text());
                <?php } ?>
            }
        });
    })
