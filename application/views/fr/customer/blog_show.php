...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Accueil</a>  >  MON BLOG SHOW</div>
        </div>
            ...
            <div class="blogshow" style="padding-bottom:20px;">
                ...
                <ul class="tab-con">
                    <li <?php echo $onshowed ? 'style="display:none;"' : 'style="display:block;"'; ?>>
                                ...
                                <tr>
                                    ...
                                    <td width="306">
                                        <dl class="pr-info fix">
                                            ...
                                            <dd>Article# : <?php echo $data['sku']; ?></dd>
                                            <dd><?php echo Product::instance($product_id, LANGUAGE)->get('name'); ?></dd>
                                            <dd>N°de Commande: <a><?php echo $data['ordernum']; ?></a></dd>
                                            <dd><input type="button" class="copy-link view_btn btn26 btn40" style="width: 195px;" name="<?php echo Product::instance($product_id, LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Copiez le lien de l'article" /></dd>
                                        </dl>
                                    </td>
                                    <td width="310">
                                        <dl class="show-link">
                                            <form action="<?php echo LANGPATH; ?>/customer/add_url?<?php echo http_build_query($_GET); ?>" method="post">
                                                ...
                                                <dd><a class="addMoreLink">ajoutez un nouveau lien</a></dd>
                                                <dd><input type="submit" class="view_btn btn26 btn40" value="SOUMETTRE" /></dd>
                                            </form>
                                        </dl>
                                    </td>
                                </tr>
                        ...
                        <?php
                        $pagination1 = str_replace(array('PAGE', 'NEXT', 'PRE', 'Records Found'), array('SEITE', 'Suivant', 'Précédent', 'Rekord Gefunden'), $pagination1);
                        echo $pagination1; 
                        ?>
                    </li>
                    <li <?php echo $onshowed ? 'style="display:block;"' : 'style="display:none;"'; ?>>
                                            ...
                                            <dd>
                                                <div class="edit-url" style="display:none;">
                                                    <form action="<?php echo LANGPATH; ?>/customer/edit_url?<?php echo http_build_query($_GET); ?>" method="post">
                                                        ...
                                                        <br/>
                                                        <div class="more"></div>
                                                        <a class="addMoreLink">ajoutez un nouveau lien</a>
                                                        <br/>
                                                        <input type="submit" class="view_btn btn26 btn40" style="width: 85px;margin-right: 20px;height: 20px;line-height: 20px;" value="SOUMETTRE">
                                                        <a href="#" class="link-cancel" style="text-decoration:underline;margin-left:10px;">Annuler</a>
                                                        <br/><br/>
                                                    </form>
                                                </div>
                                                <input type="button" name="" class="link-edit view_btn btn26 btn40" value="RÉDIGER" />
                                            </dd>
                                        </dl>
                                    </td>
                                </tr>
                        ...
                        <?php
                        $pagination2 = str_replace(array('PAGE', 'NEXT', 'PRE', 'Records Found'), array('SEITE', 'Suivant', 'Précédent', 'Rekord Gefunden'), $pagination2);
                        echo $pagination2; 
                        ?>
                    </li>
                </ul>
