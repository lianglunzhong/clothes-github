                ...
                if (!empty($children))
                {
                    ...
                    <ul class="menu JS_menu <?php echo!$on ? ' hide' : ''; ?>">
                        ...
                        <?php foreach ($children as $sub_catalog): ?>
                            <li><a <?php if ($on AND $catalog_link == Catalog::instance($sub_catalog)->get('link')) echo 'style="color:#F66;"' ?> href="<?php echo Catalog::instance($sub_catalog)->permalink(); ?>"><?php echo Catalog::instance($sub_catalog)->get('name'); ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                    <?php
                }
        ...
        <div class="leftlist JS_leftlist">
            ...
            foreach ($brands as $catalog):
                ...
                else
                {
                    ?>
                    <ul class="icategory_box font14">
                        <li><a <?php echo $on ? 'class="on"' : ''; ?> href="<?php echo Catalog::instance($catalog->id)->permalink(); ?>"><?php echo $catalog->name; ?></a></li>
                    </ul>
                    <?php
                }
            endforeach;
...
<!--    <div class="category_box">
        ...
        <ul class="icategory_box">
            ...
            if (!empty($children))
            {
                foreach ($children as $sub_catalog):
                    ?>
                    <li <?php echo $on ? 'class="on"' : ''; ?>><a <?php if ($on AND $catalog_link == Catalog::instance($sub_catalog)->get('link')) echo 'style="color:#F66;"' ?> href="<?php echo Catalog::instance($sub_catalog)->permalink(); ?>"><?php echo Catalog::instance($sub_catalog)->get('name'); ?></a></li>
                    <?php
                endforeach;
            }
            ?>
    ...
    <div class="category_box">
        ...
        <ul class="icategory_box">
            ...
            {
                ?>
                <li class="on"><a style="color:#F66;" href="/activity/activities_list">List</a></li>
                <?php
            }
            else
            {
