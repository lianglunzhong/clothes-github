...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            ...
            <div class="flr"><a href="<?php echo $crumbs[0]['link'] ?>">Zurück Zu <?php echo $crumbs[0]['name'] ?></a></div>
        </div>
    </div>
    ...
    <section class="layout fix">
            ...
            <div class="pro_right flr">
                <dl>
                    <dd>
                        ...
                        <div class="fix">
                            <p style="padding-bottom:12px;color:#999;">
                                ...
                                ?>
                            <span id="product_status" style="margin-right:15px;color:#000;"><?php echo $instock ? 'Auf Lager' : '<strong class="red">Ausverkauft</strong>'; ?></span>
                            Artikel#: <?php echo $product->get('sku'); ?>
                            <?php
                            if(!empty($brands))
                            {
                                ?>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/brand/list/<?php echo $brands['id']; ?>" class="ml10"><i>von <?php echo $brands['name']; ?></i></a>
                                <?php
                            }
                            ?>
                            </p>
                    ...
                    <dd class="fix info jiage" style="margin-top:15px;">
                        ...
                        if ($vip_level)
                        {
                            if($vip_promotion_price AND $vip_level >= 2)
                            {
                                if ($p_price > $price)
                                {
                                    ...
                                    ?>
                                        ...
                                        <i><?php if($rate > 0) echo $rate; ?>% Rabatt</i>
                                    <?php
                                }
                            }
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    ?>
                                    VIP. Preis <?php echo $currency_change; ?><?php echo Site::instance()->price($vip_price, 'code_view'); ?>
                                    <?php
                                }
                            }
                        }
                        ...
                        {
                            ?>
                            <a href="<?php echo LANGPATH; ?>/customer/login?redirect=/product/<?php echo $product->get('link'); ?>_p<?php echo $product_id; ?>" style="text-decoration:underline;font:Arial, Helvetica, sans-serif;font-size:11px;" class="pro_sign JS_popwinbtn1" id="sign_in">ANMELDEN</a> FÜR VIP PRIVILEG
                            <?php
                        }
                        ?>
                        <?php
                        ...
                        if($vip_promotion_price)
                        {
                            if($customer_id)
                            {
                                ...
                                {
                                    ?>
                                        <strong style="color:#FF5200;">VIP. Preis <span style="font-size: 16px;"><?php echo $currency_change; ?><?php echo Site::instance()->price($vip_promotion_price, 'code_view'); ?></span></strong>
                                    <?php
                                }
                            }
                            else
                    ...
                    <dd>
                        <?php
                        $flash_sale = DB::select('expired')->from('spromotions')->where('product_id', '=', $product_id)->where('type', '=', 6)->where('expired', '>', time())->execute()->get('expired');
                        if($flash_sale)
                        {
                        ?>
                        <!-- time left -->
                        <div class="timeleft_box mt10">
                            <div class="JS_daoend hide">Zeit Über!</div>
                            <div class="JS_dao">Übrige Zeit : <strong class="JS_RemainD"></strong>d <strong class="JS_RemainH"></strong>h <strong class="JS_RemainM"></strong>m <strong class="JS_RemainS"></strong>s</div>
                        </div>
                        <?php
                        }
                        ?>
                    ...
                    <dd class="last" style="margin-top:25px;">
                        ...
                        <div  class="fix">   
                            ...
                            {
                            ?>
                                <a target="_blank" href="#" class="text_underline JS_popwinbtn1" id="write_review" style="margin-left:10px;font-weight:bold;" >Kundenrezensionen Verfassen</a>
                            <?php
                            }
                            else
                            {
                                ?>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" class="text_underline" style="margin-left:10px;font-weight:bold;" >Kundenrezensionen Verfassen</a>
                                <?php
                            }
                            ?>
                        </div>
                        ...
                        <form action="/cart/add" method="POST" id="formAdd">
                            ...
                            <div class="size">
                                <div class="selected_box fix">
                                    <p class="left" style="font-weight:bold;">
                                        <span id="select_size">Größe Wählen:</span> <span class="selected"></span>
                                ...
                                {
                                ?>
                                    <span class="JS_popwinbtn2 fix" style="cursor:pointer;float:right;margin-top:3px;text-decoration: underline;font-weight: bold;">Größentabelle</span>
                                <?php
                                }
                                ?>
                                </div>
                                <script type="text/javascript">
                                    $(function(){
                                        $(".size_list li").live("click",function(){
                                            ...
                                            $(this).addClass('on');
                                            $("#select_size").html('Größe: '+$(this).text());
                                            if(qty)
                            ...
                            if (!empty($attributes['color']))
                            {
                                ...
                                <div class="color">
                                    ...
                                    <p class="selected_box"><span class="selected" id="select_color">Farbe Wählen:</span></p>
                            ...
                            {
                                ?>
                                <div id="select_type" class="mb10">Typ wählen:</div>
                                <div class="btn_type">
                            ...
                            <div class="total">
                                ...
                                <span class="font14" style="margin-left:8px;display:inline-block;">Menge:</span><br />
                                ...
                                <br>
                                <input type="submit" value="IN DEN WARENKORB" id="addCart" class="btn40_16_red" style="font-size:18px;<?php if(!$instock) echo 'display:none;'; ?>" />
                                <span class="btn40_16_gray" id="outofstock" style="font-size:18px;<?php if($instock) echo 'display:none;'; ?>" />Ausverkauft</span>
                                ...
                                $wishlists = DB::select(DB::expr('COUNT(id) AS count'))
                                        ...
                                        ->execute()->get('count');
                                ?>
                                WUNSCHLISTE <?php echo $wishlists ? '(' . $wishlists . ' ADDIEREN)' : ''; ?>
                                </a>
                                <div class="same-paragraph same-paragraph1">
                                    <label>MEHR FARBEN:</label>
              ...
              $(".swrp").hover(function(){
                   ...
                   $(this).hide();
                        ...
                        <ul class="JS_tab detail_tab fix">
                            ...
                            {
                                $models .= 'Modell Tragen: ' . $product->get('model_size') . '<br><br>';
                            }
                            ...
                            if($model_id)
                            {
                                ...
                                $models .= 'Höhe: ' . $height_ft .' | Büste: ' . $bust_in . ' | Taille: ' . $waist_in . ' | Hüfte: ' . $hip_in . '<br>';
                                $models .= 'Höhe: ' . $modelArr['height'] . ' cm | Büste: ' . $modelArr['bust'] . ' cm | Taille: ' . $modelArr['waist'] . ' cm | Hüfte: ' . $modelArr['hip'] . ' cm' . '<br>';
                            }
                            if($models)
                            {
                                ?>
                                <li class="ss2" style="width: 90px;margin: 0 0 -1px 0;">MODELL</li>
                                <?php
                            }
                            ?>
                            <li class="ss3" style="width: 90px;margin: 0 0 -1px 0;">Lieferung</li>
                            <li class="ss4" style="width: 90px;margin: 0 0 -1px 0;">Kontakt</li>
                            <p><b></b></p>
                        </ul>
                        <div class="JS_tabcon detail_tabcon">
                            <div class="bd">
                                ...
                                if (!empty($filter_sorts))
                                {
                                    ...
                                    foreach ($filter_sorts as $name => $sort)
                                    {
                                        ...
                                        if(in_array($en_name, $sortArr_en))
                                        {
                                            ...
                                            $small_name = $name;
                                        echo '<tr><td width="40%"><p><strong>' . strtoupper($small_name) . '</strong>:</p></td><td width="60%"><p>' . ucfirst($small_filter[strtolower($sort)]) . '</p></td></tr>';
                                    }
                                    echo '</table>';
                                    echo '<br>';
                                }  
                                ...
                                echo $brief; ?>  
								<span class="JS_popwinbtn2 fix" style="cursor:pointer;margin-top:3px;text-decoration: underline;font-weight: bold;">Größentabelle</span>
                              <?php
								echo '<br><br>';
								if($has == 0){
									$description = $prodes;
        ...
        <article class="buyshow_box layout fix">
            <div class="w_tit layout">
                <ul class="fix dingbu" style="float:left;">
                    ...
                    <li class="current">SCHAU DER KÄUFER</li>
                    <?php endif; ?>
                    <?php if ($product->get('has_link') == 1 AND !empty($link_images)): ?>
                    <li <?php if(empty($celebrity_images)) echo 'class="current"'; ?>>SEHEN SIE HIER</li>
                    <?php endif; ?>
                    <?php if (isset($videos) AND !empty($videos)): ?>
                    <li <?php if ($product->get('has_link') == 0 AND empty($link_images) AND empty($celebrity_images)) echo 'class="current"'; ?>>Video der Kunden</li>
                    <?php endif; ?>
                    <p><b></b></p>
                </ul>
            </div>
            ...
            <div class="product_carousel fix ts">
                ...
                if($count > 8)
                {
                    ...
                    <?php
                    echo '<div class="view1 fix"><p>Mehr Sehen+</p></div>';
                }
                ?>
            </div>
            <?php
            ...
            ?>
                <div class="pro_lookwith fix ts <?php if(!empty($celebrity_images)) echo 'hide'; ?>" style="width:1024px;height:auto;margin:0 auto;overflow: hidden;">
                    <div style="float:left;">
                        <?php foreach ($link_images as $key => $link_img) : ?>
                            <ul class="fix" style="height:493px;<?php if($key > 0) echo 'display:none;'; ?>">
                                ...
                                <li style="overflow: hidden; float: left; width: 613px; height: 510px;">
                                    ...
                                    <p class="fix"><a class="btn40_16_red flr JS_popwinbtn4" title="<?php echo $key; ?>">SEHEN SIE HIER</a></p>
                                </li>
                            </ul>
                        <?php endforeach; ?>
                        <?php
                        ...
                        {
                            ?>
                            <a class="view_more flr mr15" onclick="$('.pro_lookwith .fix').show();$(this).hide();">Mehr Sehen+</a>
                            <?php
                        }
                        ?>
                    </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $(".view1 p").click(function() {
                        ...
                        if(text == 'Mehr Sehen+')
                        {
                            $(".view1 p").text("Wenig Sehen-");
                        }
                        else if(text == 'Wenig Sehen-')
                        {
                            $(".view1 p").text("Mehr Sehen+");
                        }
                    })
                });
            </script>
                        ...
                        if (!empty($skus))
                        {
                            ...
                            <form action="<?php echo LANGPATH; ?>/cart/add_more" method="post" class="form3" id="form<?php echo $key; ?>">
                                ...
                                <div class="center mt50">
                                    <input type="submit" value="IN DEN WARENKORB" class="btn40_16_red" /><a href="<?php echo LANGPATH; ?>/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a_underline add_wishlist">MEINE WUNSCHLISTE</a>
                                </div>
        ...
        <div class="w_tit layout"><h2>Andere Kunden sehen auch</h2></div>
        <div class="box-dibu1">
        ...
        <div class="box-title">
                    <ul>
                        ...
                        <li class="">Kürzlich Rezensiert</li>
                    </ul>
                    <p style="left: 180px;">
        ...
        <article class="product_reviews" style="margin-top:30px;">
            <div class="w_tit layout" style="margin-bottom:30px"><h2>REZENSIONEN DER KUNDEN</h2></div>
            <?php
            if(empty($reviews))
            {
            ?>
                <div style="text-align:center; margin-bottom:-40px;">
                    <img src="/images/product-detail_hongxin.jpg" /><span style="font-weight:bold; margin-left:10px;font-size:16px;">0</span><span style=" margin-left:5px;font-size:16px;">REZENSIONEN</span>
                    <p style="margin-top:15px;font-size:14px;">ERSTE SEIN, UM IHRE REZENSIONEN ZU TEILEN</p>
                    <?php
                    if(!$customer_id)
                    {
                    ?>
                        <a class="JS_popwinbtn1 btn40_16_red" id="write_review1" href="javascript:void(0)" style="margin-top:18px;margin-bottom:100px; cursor:pointer;">Kundenrezensionen Verfassen</a>
                    <?php
                    }
                    else
                    {
                        ?>
                        <a target="_blank" class="btn40_16_red" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" style="margin-top:18px;margin-bottom:100px; cursor:pointer;">Kundenrezensionen Verfassen</a>
                        <?php
                    }
                    ?>
                </div>
                ...
                <div style="margin:0 0 20px 0;padding:10px 0 ; background-color:#fafafa;border:1px solid #CCC">
                    <div class="rating" style="margin:10px 0 0 0;">
                        <span class="s1" style="margin-left:30px;font-weight:bold;">
                            <strong class="<?php echo $star_class; ?>"></strong>Durchschnittliche Bewertung
                        </span>
                        <span class="s1" style="margin-left:57px;font-weight:bold;">Qualität: <div class="outbt"><div style="width:<?php echo round($reviews_data['quality'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                        <span class="s1" style="margin-left:20px;font-weight:bold;">Preis: <div class="outbt"><div style="width:<?php echo round($reviews_data['price'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></strong></span>
                        <span class="s1" style="margin-left:20px;font-weight:bold;">Fitness: </span><span> <?php echo $review_title['fitness'][ceil($reviews_data['fitness'])]; ?></span>
                    </div>
                    <div style="margin:0 0 15px 0;">
                        <span class="s2" style="margin-left:139px;font-weight:bold;"><?php echo $reviews_data['overall']; ?> VON 5(<?php echo $count_reviews; ?> Bewertungen)</span>
                        ...
                        <span class="s2" style="margin-left:104px;color:##727272;">
                            <?php echo $review_title['price'][ceil($reviews_data['price'])]; ?>
                        </span>
                    </div>
                    <div>
                        <span class="s2" style="margin:0 0 15px 30px;"><?php echo $count_reviews; ?> Kundenrezension<?php if($count_reviews > 1) echo 'en'; ?>  &nbsp; | &nbsp;   
                        <?php
                        if(!$customer_id)
                        {
                            ?>
                            <a href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" class="JS_popwinbtn1" id="write_review2" style="text-decoration:underline;">Kundenrezensionen Verfassen</a>
                            <?php
                        }
                        else
                        {
                            ?>
                            <a target="_blank" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" style="text-decoration:underline;">Kundenrezensionen Verfassen</a>
                            <?php
                        }
                        ?>
                        </span>
                        ...
                        <li class="fix bgg">
                            <div class="left">
                                <dl>
                                    ...
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Größe:</span><span><?php echo $size ? $size : $attributes['size'][0]; ?></span></dd> 
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Passform:</span><span><?php echo $review_title['fitness'][$r['fitness']]; ?></span></dd>     
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Höhe:</span><span><?php echo $r['height']; ?> CM</span></dd> 
                                    <dd><span style="color:#000;width:60px;display:block;float:left;">Gewicht:</span><span><?php echo $r['weight']; ?> KG</span></dd> 
                                </dl>
                            </div>
                            <div class="right">
                                <div class="rating1">
                                    <span class="s1" style="font-weight:bold;">
                                    Gesamtbewertung: <strong class="rating_show1 <?php echo 'star' . $r['overall']; ?>"></strong> (<?php echo $review_title['overall'][$r['overall']]; ?>)
                                    </span>
                                    <span class="s1" style="margin-left:20px;font-weight:bold;">Qualität: <div class="outbt"><div style="width:<?php echo round($r['quality'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                                    <span class="s1" style="margin-left:20px;font-weight:bold;">Preis: <div class="outbt"><div style="width:<?php echo round($r['price'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                                </div>
                                <div class="reviews_boxcon" style="margin-top:20px;">
                                    ...
                                    ?>
                                        <div>
                                            ...
                                            <a onclick="$('#review_remain_<?php echo $r['id']; ?>').show();$(this).hide();" class="red">Mehr Sehen</a>
                                        </div>
                                    <?php
                                    }
                                    else
                                    ...
                                    {
                                    ?>
                                        <span style="font-weight:bold;width:20px;height:10px;"> Antworten von Choies:</span>
...
<div class="JS_popwincon2 popwincon w_p30 hide">
    ...
    <ul class="JS_tab4 detail_tab fix">
        <?php if ($set_id != 2): ?>
            <li class="current">KLEIDUNG</li>
            <li>UMRECHNUNGSTABELLE</li>
        <?php endif; ?>
        <?php if ($set_id == 2): ?>
            <li class="current">SCHUHE</li>
        <?php else: ?>
            <li>SCHUHE</li>
        <?php endif; ?>
        <?php if (Product::instance($product_id)->get('set_id') != 2 AND !empty($celebrity_lists)): ?>
            <li>Probieren Bericht</li>
        <?php endif; ?>
        <li>MESSUNGEN</li>
    </ul>
        ...
        if ($set_id != 2)
        {
            ...
            <div class="bd hide">
                ...
                if (array_key_exists($set_id, $hides))
                {
                    $hide = $hides[$set_id];
                    ?>
                    <h3> Kleidung - Internationale Größentabelle</h3>
...
?>
        ...
        <div class="bd size_mesurements hide">
            ...
            <div class="fix">
                ...
                <div class="right fll">
                    <h4>BRUST</h4>
                    <p>Messen Sie am größten Umfang der Brust, über den Schulterblättern und stellen Sie sicher, dass es unter Ihren Armen, nicht um sie herum, geht. Achten Sie darauf, eine exakte Messung zu geben und keine zusätzliche Länge der Messung hinzuzufügen.</p>
                    <h4>TAILLE</h4>
                    <p>Messen Sie um Ihre Taille, knapp über Ihre Hüftknochen. Das Band sollte in der Nähe der Bauch sein, sollte aber keinen Druck auf Ihre Haut ausüben.</p>
                    <h4>HÜFTEN</h4>
                    <p>Nehmen Sie das locker Band und wickeln Sie es um Ihren Hüftbereich. Das Band sollte an der breitesten Stelle der Hüfte Bereich gesichert werden, dies ist fast immer über das Gesäß.</p>
                    <h4>Kleidlänge</h4>
                    <p>Stehen Sie gerade mit Ihren Fersen zusammen. Messen Sie von der hohen Punkt Ihrer Schultern entlang der Länge Ihres Rückens. Bitte wählen Sie Ihre passende Länge nach der praktischen Situation.</p>
                </div>
            </div>
            <h3>SCHUHE</h3>
            <div class="fix">
                ...
                <div class="right fll">
                    <h4>SCHUHE LÄNGE</h4>
                    <p>Messen Sie die Schuhe vom ganz vorne Zehenteil bis zu der Rückseite der Fersen.</p>
                    <h4>SCHUHHÖHE</h4>
                    <p>Messen Sie die Rückseite der Schuhe von Top der Schuhe bis zu der Unterseite der Fersen flach auf dem Untergrund.</p>
                    <h4>ABSATZHÖHE</h4>
                    <p>Messen Sie die Rückseite der Fersen von dem Punkt, wo es mit dem Schuh verbindet(Naht bezeichnet), bis zu der Unterseite der Fersen flach auf dem Untergrund.</p>
                    <h4>PLATTFORMHÖHE</h4>
                    <p>Messen Sie dies von der Unterseite der Sohle bis zu dort, wo es mit dem Schuh verbindet, an der Oberseite der Plattform.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    $(function(){
        $.ajax({
            ...
            success: function(product){
                ...
                var attributes = product['attributeSize'].replace('<span>one size</span>', '<span>Eine Größe</span>');
                <?php
                if($crumbs[0]['id'] == 53)
                {
                    ?>
                ...
                $("#select_size").html('Größe: '+$(".size_list li").text());
                <?php } ?>
            }
        });
    })
