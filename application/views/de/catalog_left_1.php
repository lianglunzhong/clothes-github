<ul class="filter-bar cf">
    ...
    {
        $childrens = array(
            array('Kleider', LANGPATH . '/dresses-c-92'),
            array('Schwarze Kleider', LANGPATH . '/dresses-c-92/all/all/color_8'),
            array('Spitzen Kleider', LANGPATH . '/dresses-c-92/all/all/Detail_124'),
            array('Bodycon Kleider', LANGPATH . '/dresses-c-92/all/all/Silhouette_62'),
            array('Maxi Kleider', LANGPATH . '/dresses-c-92/all/all/dresses-c-92-Length_73'),
            array('Skater Kleider', LANGPATH . '/dresses-c-92/all/all/Silhouette_69'),
            array('Blumen Kleider', LANGPATH . '/dresses-c-92/all/all/Pattern-Type_82'),
            array('Chiffon Kleider', LANGPATH . '/dresses-c-92/all/all/Material_19'),
            array('Lange Ärmel Kleider', LANGPATH . '/dresses-c-92/all/all/Sleeve-Length_56'),
            array('Party Kleider', LANGPATH . '/dresses-c-92/all/all/Shop-Looks_35'),
            array('Heimkehr Kleider', LANGPATH . '/homecoming-dress-c-454'),
        );
    }
    else
    {
    ...
    $scroll = 1;
    ?>
    <li style="float:left;margin-top: 5px;"><div>Sortieren nach:&nbsp;</div></li>
    ...
    <li class="item-l pick" style="width:auto;">
        ...
        if (!empty($gets1))
        {
            ...
            $gets1[] = 'pick=1';
        ?>
        <a href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . implode('&', $gets1); ?>" class=""> <i class="icon icon-pick"></i> Wahl der Berühmtheit</a>
    </li>
...
if(!empty($size_filter))
{
    ...
    <li class="item-r choice">
        <div class="choice-hd">
            Größe <i class="fa fa-caret-down"></i>
        </div>
...
?>
    <li id="JS_filterAll" class="item-r filter-all">
        Alle Filter <i class="fa fa-caret-down"></i>
    </li>
</ul>
...
<div class="filter-list" style="display:none;">
    ...
    if(!empty($size_filter))
    {
        ...
        <div class="item choice">
            <div class="choice-hd">
                Größe <i class="fa fa-chevron-down"></i>
            </div>
    ...
    <div class="item choice">
        <div class="choice-hd">
            Farbe <i class="fa fa-chevron-down"></i>
        </div>
    ...
    <div class="item choice">
        <div class="choice-hd">
            Preis <i class="fa fa-chevron-down"></i>
        </div>
...
if (!empty($custom_filter['filter_attirbutes']) OR !empty($custom_filter['price_range']) OR $has_size):
    ...
    <div class="filter-selected">
        ...
        if($has_size)
        {
            ...
            ?>
            <span class="item">
                <a href="<?php echo $href . $limit_link; ?>"><i class="fa fa-times-circle fa-lg"></i><?php echo 'Größe:'.$size_filter[$links[1]]; ?></a>
            </span>
            <?php
        }
        if (isset($custom_filter['price_range']))
        {
            ...
            ?>
            <span class="item">
                <a href="<?php echo $href . $limit_link; ?>"><i class="fa fa-times-circle fa-lg"></i><?php echo 'Preis:$' . $custom_filter['price_range'][0] . ' ~ $' . $custom_filter['price_range'][1]; ?></a>
            </span>
            <?php
        }
        ...
        ?>
        <span class="item">
            <a href="<?php echo LANGPATH . $uris[0] . '/' . $uris[1]; ?>"><span class="clearall">Alle Löschen</span></a>
        </span>
    </div>
    <?php
endif;
