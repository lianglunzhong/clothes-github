...
<section id="main">
    ...
    <div class="w_index_free">
        <div class="layout index_free">
            <a href="<?php echo LANGPATH; ?>/shipping-delivery" class="a1">KOSTENLOSER WELTWEIT VERSAND</a>
            <a href="<?php echo LANGPATH; ?>/customer/login" class="a2">SPAREN SIE 15% BEI ERSTER BESTELLUNG</a>
            <a href="<?php echo LANGPATH; ?>/daily-new" class="a3">10% RABATT NEUHEITEN in 2 Wochen</a>
        </div>
    </div>
            ...
            <div id="productInfo">
                <dl>
                    <dd>
                        ...
                        <div class="infoText">Artikel# : <span id="product_sku"></span></div>
