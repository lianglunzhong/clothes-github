...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Honepage</a>  >  Saison Auswahl</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="banner" id="banner">
                <div class="ibanner">
                    <ul class="bannerPic">
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/croptops_banner2.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/croptops_banner4.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/croptops_banner3.jpg" alt="" /></a></li>
                        <li><a href="#" title=""><img src="/images/<?php echo  LANGUAGE; ?>/croptops_banner1.jpg" alt="" /></a></li>
                    </ul>
                    <div class="banner_lr">
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit1 fix mb25">
                    <h4 id="d1"><img src="/images/activity/croptop_tit1.png" />BAUCHFREI OBERTEIL</h4>
                    <a class="view_morebtn De_JS_view_morebtn">MEHR SEHEN</a>
                </div>
                        ...
                        for($i = 0;$i < 4;$i ++)
                        {
                            ...
                            <li>
                                ...
                                <?php if ($product_inf['type'] != 0): ?>
                                    <a href="#" id="<?php echo $product_id; ?>" class="quick_view JS_shows1">SCHNELLANSICHT</a>
                                <?php endif; ?>
                                ...
                                <p class="price fix">
                                    ...
                                    if ($orig_price > $price)
                                    {
                                        ...
                                        <span class="off"><?php echo $off; ?>% Rabatt</span>
                                        <?php
                                    }
                                    else
                                    {
            ...
            <div class="scroll_list">
                <div class="music_festival_tit tit2 fix mb25">
                    <h4 id="d2"><img src="/images/activity/croptop_tit2.png" />RÖCKE</h4>
                    <a class="view_morebtn De_JS_view_morebtn">MEHR SEHEN</a>
                </div>
                <div class="pro_listcon">
                    <ul class="fix">
...
$(function(){
    ...
    $('.scroll_list .De_De_JS_view_morebtn').click(function(){
        var _this = $(this);
...
//        _this.parents(".scroll_list").siblings().children(".view_morecon").slideUp();
        if(_this.html()=="Mehr Sehen"){
            _this.html("Weniger Sehen");
            _this.parents(".scroll_list").siblings().find(".De_JS_view_morebtn").html("Mehr Sehen");
        }
        else{
            _this.html("Mehr Sehen");
        }
    }) 
    
    $('.dress_list .De_De_JS_view_morebtn').click(function(){
        var _this = $(this);
...
//        _this.parents(".dress_list").siblings().children(".view_morecon").slideUp();
        if(_this.html()=="Mehr Sehen"){
            _this.html("Weniger Sehen");
            _this.parents(".dress_list").siblings().find(".De_JS_view_morebtn").html("Mehr Sehen");
        }
        else{
            _this.html("Mehr Sehen");
        }
