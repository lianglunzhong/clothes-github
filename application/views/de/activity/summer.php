<link rel="canonical" href="/<?php echo $catalog_link; ?>" />
	...
	<div class="grid">	
        ...
        <div class="summer-top">
        	<p><img src="/images/activity/summer-banner-de.jpg" width="1024" height="300"></p>
            <div class="summer-filter">
                <p class="filter-instruction"><i>nach Kategorie kaufen</i></p>
                <ul class="filter-main detail-tab fix">
                    <a href="/activity/hot_summer_style?pick=1"><li class=" current"  id="a1" style="width: 245px;margin: 20px 0 -1px 130px;">Sommerkleider</li></a>
                    <a href="/activity/hot_summer_style?pick=2"><li class="" id="a2"  style="width: 245px;margin: 20px 0 -1px 0;">Sandalen</li></a>
