<style>
    ...
    .addMoreLink,.link-btn{display:block;background:url(../images/myblog_bg.png) no-repeat;}
    ...
    .btn26 {width: 100px;margin-right: 20px;height: 26px;line-height: 26px;}
...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Homepage</a>  >  MEIN BLOG SHOW</div>
        </div>
    ...
    <section class="layout fix">
        <article id="container" class="user flr">
            <div class="blogshow" style="padding-bottom:20px;">
                <h2>MEIN BLOG SHOW</h2>
                <ul class="tab fix">
                    <li <?php if (!$onshowed) echo 'class="on"'; ?>>ZEIGEN</li>
                    <li <?php if ($onshowed) echo 'class="on"'; ?>>GEZEIGT</li>
                </ul>
                <ul class="tab-con">
                    <li <?php echo $onshowed ? 'style="display:none;"' : 'style="display:block;"'; ?>>
                        <p>Wie man ein Show komplettieren?</p>
                        <p>
                            <span>1. Kopieren Sie die Artikel-Link und fügen Sie es zu Ihrem Blog Show Bilder.</span>
                            <span>2. Schreiben Sie Ihre Show url in der rechten Spalte und klicken Sie auf "Senden".</span>
                        </p>
                                ...
                                <tr>
                                    ...
                                    <td width="306">
                                        <dl class="pr-info fix">
                                            ...
                                            <dd>Artikel# : <?php echo $data['sku']; ?></dd>
                                            <dd><?php echo Product::instance($product_id, LANGUAGE)->get('name'); ?></dd>
                                            <dd>Bestell-Nr.: <a><?php echo $data['ordernum']; ?></a></dd>
                                            <dd><input type="button" class="copy-link view_btn btn26 btn40" style="width: 150px;" name="<?php echo Product::instance($product_id, LANGUAGE)->permalink() . '?cid=' . $cele_id . $admin_name; ?>" value="Artikel kopieren Link" /></dd>
                                        </dl>
                                    </td>
                                    <td width="310">
                                        <dl class="show-link">
                                            <form action="<?php echo LANGPATH; ?>/customer/add_url?<?php echo http_build_query($_GET); ?>" method="post">
                                                ...
                                                <dd><a class="addMoreLink">eine weitere Link hinzufügen</a></dd>
                                                <dd><input type="submit" class="view_btn btn26 btn40" value="Senden" /></dd>
                                            </form>
                                        </dl>
                                    </td>
                                </tr>
                        ...
                        <?php
                        $pagination1 = str_replace(array('PAGE', 'NEXT', 'PRE', 'Records Found'), array('SEITE', 'NÄCHSTE', 'FRÜHER', 'Rekord Gefunden'), $pagination1);
                        echo $pagination1; 
                        ?>
                    </li>
                    <li <?php echo $onshowed ? 'style="display:block;"' : 'style="display:none;"'; ?>>
                                            ...
                                            <dd>
                                                <div class="edit-url" style="display:none;">
                                                    <form action="<?php echo LANGPATH; ?>/customer/edit_url?<?php echo http_build_query($_GET); ?>" method="post">
                                                        ...
                                                        <br/>
                                                        <div class="more"></div>
                                                        <a class="addMoreLink">eine weitere Link hinzufügen</a>
                                                        <br/>
                                                        <input type="submit" class="view_btn btn26 btn40" style="width: 85px;margin-right: 20px;height: 20px;line-height: 20px;" value="Senden">
                                                        <a href="#" class="link-cancel" style="text-decoration:underline;margin-left:10px;">ABBRECHEN</a>
                                                        <br/><br/>
                                                    </form>
                                                </div>
                                                <input type="button" name="" class="link-edit view_btn btn26 btn40" value="EDITIEREN" />
                                            </dd>
                                        </dl>
                                    </td>
                                </tr>
                        ...
                        <?php
                        $pagination2 = str_replace(array('PAGE', 'NEXT', 'PRE', 'Records Found'), array('SEITE', 'NÄCHSTE', 'FRÜHER', 'Rekord Gefunden'), $pagination2);
                        echo $pagination2; 
                        ?>
                    </li>
                </ul>
