        ...
        <section id="container" class="flr">
            ...
            if ($show)
            {
                ...
                <ul class="JS_tab3 detail_tab hotnew_box fix" style="margin-top:0;">
                    <?php
                    if ($show == 1)
                        echo '<li class="on">Hot Picks</li>';
                    elseif ($show == 2)
                        echo '<li class="on">New Arrivals</li>';
                    elseif ($show == 3)
                        echo '<li class="on">Hot Picks</li><li>New Arrivals</li>';
                    ?>
                </ul>
                        ...
                        <div class="bd">
                            <div class="JS_carousel4 pro_listcon product_carousel">
                                <ul class="fix">
                                    ...
                                    {
                                        $top_product = Product::instance($top);
                                        ?>
                                        <li>
                                            <a href="<?php echo $top_product->permalink(); ?>"><img src="<?php echo Image::link($top_product->cover_image(), 7); ?>" /></a>
                            ...
                            <div class="JS_carousel5 pro_listcon product_carousel">
                                <ul class="fix">
                                    ...
                                    foreach ($new_arrvals as $new)
                                    {
                                        ...
                                        ?>
                                        <li>
                                            <a href="<?php echo $new_product->permalink(); ?>"><img src="<?php echo Image::link($new_product->cover_image(), 7); ?>" /></a>
            ...
            if (1)
            {
                if (in_array($catalog_link, array('outlet', '2014-summer-sale', 'usd20', 'usd30', 'usd40')))
                {
                    ...
                    <div class="mb25 newin_banner">
                        ...
                        <ul class="sale_">
                            <li class="sale_1"><a target="_blank" href="/2014-summer-sale?0814"></a></li>
                            <li class="sale_2"><a target="_blank" href="/usd20"></a></li>
                            <li class="sale_3"><a target="_blank" href="/usd30"></a></li>
                            <li class="sale_4"><a target="_blank" href="/usd40"></a></li>
                        </ul>
                    </div>
                    <?php
                }
                ...
                <article class="pro_listcon">
                    <ul class="fix">
                        ...
                        for ($i = 0; $i < $_limit; $i++):
                            ...
                            $product_inf = DB::select('type', 'name', 'price', 'has_pick', 'status', 'stock', 'display_date', 'set_id')
                                ->from('products')
                                ->where('id', '=', $product_id)
                                ->execute()->current();
                            ?>
                            <li class="JS_shows_btn1">
                                ...
                                ?>
                                    <div class="pic">
                                        <a href="<?php echo Product::instance($product_id)->permalink(); ?>">
                                            <div class="pic1"><img data-original="<?php echo Image::link($images[0], 7); ?>" src="/images/loading.gif" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                            <?php
                                            if (isset($images[1]))
                                            {
                                                ?>
                                                <div class="pic2" style="display:none;"><img data-original="<?php echo Image::link($images[1], 7); ?>" src="/images/loading.gif" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                                <?php
                                            }
                                            ?>
                                        </a>
                                ...
                                else
                                {
                                    ...
                                    <div class="pic">
                                        <a href="<?php echo Product::instance($product_id)->permalink(); ?>">
                                            <div class="pic1"><img src="<?php echo Image::link($images[0], 7); ?>" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                            <?php
                                            if (isset($images[1]))
                                            {
                                                ?>
                                                <div class="pic2" style="display:none;"><img src="<?php echo Image::link($images[1], 7); ?>" alt="<?php echo 'Fashion ' . $catalog->get('name'); ?>" title="<?php echo $product_inf['name']; ?>" /></div>
                                                <?php
                                            }
                                            ?>
                                        </a>
                                ...
                                ?>
                                <?php
                                if($product_inf['set_id'] == 2)
                                {
                                ?>
                                    <!-- <div style="height: 16px;background:#ff3333;color:#fff;font-family: Century Gothic;font-size: 12px;text-align: center;">
                                        Buy 3 or 3+, Enjoy 35% OFF
                                    </div> -->
                                <?php
                                }
                                ?>
                                ...
                                else
                                {
                                    ...
                                    if ($is_sale && $is_new)
                                    {
                                        echo '<span class="icon_sale1 JS_shows1" style="display:none;"></span><span class="icon_new JS_shows1" style="display:none;"></span>';
                                    }
                                    elseif ($is_sale)
                                    {
                                        echo '<span class="icon_sale JS_shows1" style="display:none;"></span>';
                                    }
                                    elseif ($is_new)
                                    {
                                        echo '<span class="icon_new JS_shows1" style="display:none;"></span>';
                                    }
                                }
                                ?>
                            </li>
...
<script type="text/javascript">ScarabQueue.push(['category', '<?php
$crumbs = $catalog->crumbs();
foreach ($crumbs as $key => $crumb):
