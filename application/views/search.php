    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll">
                ...
                &gt;<span>Search : <strong><?php echo $keywords; ?></strong>
            </div>
        </div>
    </div>
    <div class="grid">
        <article class="filter_page">
            <ul class="filter-bar cf">
                <li style="float:left;"><div>Sort By:&nbsp;</div></li>
                <li class="item-l choice" style="width:120px;">
                    <div class="choice-hd">
                        <?php echo isset($_GET['sort']) ? $sorts[$_GET['sort']]['name'] : 'Default'; ?>
                ...
                <?php
                    ...
                    ?>
                    <a href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . Security::xss_clean(implode('&', $gets1)); ?>" class=""> <i class="icon icon-pick"></i> Icon's Pick</a>
                </li>
        ...
        else
        {
            ...
            <div class="notfound">
                ...
                <div class="searchon_box">
                    <p class="top"><strong>Sorry!</strong> The item you are searching for has not been found,<br />
                ...
                <div class=" font18 mb25">Or your may take a look at our best-selling products:</div>
                    ...
                    foreach ($top_seller as $product):
                        ...
                        <li>
                            <a href="<?php echo $link; ?>" title="<?php echo $relate_name; ?>">
                                <img src="<?php echo image::link(Product::instance($product['product_id'])->cover_image(), 7); ?>" />
                            </a>
