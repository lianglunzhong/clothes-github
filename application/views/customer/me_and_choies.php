                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="325" height="100">
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="110"></td>
                                                                            <td><a href="http://www.choies.com/customer/orders?EDM0120" target="_blank"><img src="/images/docs/order.png" width="100" height="65" onMouseOver="this.src='/images/docs/order_on.png'" onMouseOut="this.src='/images/docs/order.png'" style="margin-bottom:25px;margin-top:10px; display:block;"  border="0" /></a></td>
                                                                            <td width="115" ></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td width="325" height="100"><table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td><a href="http://www.choies.com/customer/wishlist?EDM0120" target="_blank"><img src="/images/docs/wishlist.png" width="100" height="65" onMouseOver="this.src='/images/docs/wishlist_on.png'" onMouseOut="this.src='/images/docs/wishlist.png'"style="margin-bottom:30px;margin-top:5px;display:block;" border="0"/></a></td>
                                                                            <td width="110"></td>
                                                                            <td><a href="http://www.choies.com/customer/points_history?EDM0120" target="_blank"><img src="/images/docs/point.png" width="100" height="65" onMouseOver="this.src='/images/docs/point_on.png'" onMouseOut="this.src='/images/docs/point.png'" style="margin-bottom:30px;margin-top:5px; margin-right:15px;display:block;"border="0"/></a></td>
                                                                        </tr>
                                                                    </table></td>
                                                            </tr>
                                                            <tr>
                                                                <td width="325" height="100">
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="http://www.choies.com/customer/summary?EDM0120" target="_blank"><img src="/images/docs/vip.png" width="100" height="65" onMouseOver="this.src='/images/docs/vip_on.png'" onMouseOut="this.src='/images/docs/vip.png'" style="margin-bottom:30px;margin-top:5px;display:block;" border="0"/></a></td>
                                                                            <td width="115"></td>
                                                                        </tr>
                                                                    </table>
