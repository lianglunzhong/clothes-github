        ...
        <section id="container" class="flr">
            <div class="lp_icecream">
                ...
                <div class="banner" id="banner">
                    <div class="ibanner layout" style="height:300px;">
                        <ul class="bannerPic" style="height:300px;">
                            <!--<li><a href="#" title=""><img src="/images/activity/805-300-1.jpg" alt="" /></a></li>-->
                            <li><a href="#" title=""><img src="/images/activity/805-300-2.jpg" alt="" /></a></li>
                            <li><a href="#" title=""><img src="/images/activity/805-300-3.jpg" alt="" /></a></li>
                            <li><a href="#" title=""><img src="/images/activity/805-300-4.jpg" alt="" /></a></li>
                            <li><a href="#" title=""><img src="/images/activity/805-300-5.jpg" alt="" /></a></li>
                            <li><a href="#" title=""><img src="/images/activity/805-300-6.jpg" alt="" /></a></li>
                        </ul>
                        <div class="banner_lr">
                    ...
                    <div class="pro_listcon">
                        <ul class="fix">
                            ...
                            $products = DB::query(Database::SELECT, 'SELECT p.id, p.stock, p.sku, p.name, p.link, p.price 
                                FROM products p LEFT JOIN catalog_products c ON p.id = c.product_id 
                                WHERE c.catalog_id = ' . $catalog . ' AND p.status = 1 AND p.visibility = 1 AND p.stock <> 0 ORDER BY c.position DESC')
                                ->execute()->as_array();
                            for ($i = 0; $i < 4; $i++)
                            {
                                $pdetail = $products[$i];
                ...
                <ul class="flv_product_details_nav" style="position: fixed;top: 200px; right:135px;">
                    <li onclick="goto(1);"><img src="/images/activity/icecream_01.jpg" /></li>
                    <li onclick="goto(2);"><img src="/images/activity/icecream_02.jpg" /></li>
                    <li onclick="goto(3);"><img src="/images/activity/icecream_03.jpg" /></li>
                    <li onclick="goto(4);"><img src="/images/activity/icecream_04.jpg" /></li>
                    <li onclick="goto(5);"><img src="/images/activity/icecream_05.jpg" /></li>
                    <li onclick="goto(6);"><img src="/images/activity/icecream_06.jpg" /></li>
                    <li onclick="goto(7);"><img src="/images/activity/icecream_07.jpg" /></li>
                    <li onclick="goto(8);"><img src="/images/activity/icecream_08.jpg" /></li>
                </ul>
            </div>
        </section>
