	...
	<div class="special-sign-in">
		<div class="s-box fix">
			...
			<form action="/customer/login?redirect=<?php echo Request::instance()->uri;?>" method="post" class="signin_form sign_form form">
                <input type="hidden" name="referer" value="http://www.choies.com/">
                <ul>
                    <li>
                    ...
                    <li><input type="submit" value="Sign In" name="submit" class="btn30_14_black mr10"><a href="http://www.choies.com/customer/forgot_password" class="text_underline">Forgot password?</a></li>
                </ul>
            </form>
		</div>
	</div>
