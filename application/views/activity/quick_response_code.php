...
<section id="main">
    <div class="main-green">
        <p class="scan-win-img"><img src="/images/activity/scan-win.jpg"></p>
        <?php
        if($customer_id)
        {
            ?>
            <div>
                ...
                <a href="http://www.choies.com/top-sellers"><img src="/images/activity/scan-btn2.jpg" /></a>
            </div>
            <?php
        }
        else
        {
            ?>
            <div>
                <a href="#" class="JS_popwinbtn1"><img src="/images/activity/scan-btn.jpg"></a>
