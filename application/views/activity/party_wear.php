        ...
        <section id="container" class="flr">
            ...
            <div class="lp_partywear">
                ...
                <div class="JS_carousel1 lp_partywear_carousel">
                    <ul class="fix">
                        <li>
                            <a class="" id="<?php echo $products[0][0]; ?>" href="<?php echo Product::instance($products[0][0])->permalink(); ?>" target="_blank"><img src="/images/activity/partywear_pr07.jpg" /></a>
                        </li>
                        <li>
                            <a class="" id="<?php echo $products[0][1]; ?>" href="<?php echo Product::instance($products[0][1])->permalink(); ?>" target="_blank"><img src="/images/activity/partywear_pr08.jpg" /></a>
                        </li>
                        <li>
                            <a class="" id="<?php echo $products[0][2]; ?>" href="<?php echo Product::instance($products[0][2])->permalink(); ?>" target="_blank"><img src="/images/activity/partywear_pr09.jpg" /></a>
                        </li>
                        <li>
                            <a class="" id="<?php echo $products[0][3]; ?>" href="<?php echo Product::instance($products[0][3])->permalink(); ?>" target="_blank"><img src="/images/activity/partywear_pr10.jpg" /></a>
                        </li>
                        <li>
                            <a class="" id="<?php echo $products[0][4]; ?>" href="<?php echo Product::instance($products[0][4])->permalink(); ?>" target="_blank"><img src="/images/activity/partywear_pr11.jpg" /></a>
                        </li>

                        <li>
                            <a class="" id="<?php echo $products[0][5]; ?>" href="<?php echo Product::instance($products[0][5])->permalink(); ?>" target="_blank"><img src="/images/activity/partywear_pr93.jpg" /></a>
                        </li>
                        <li>&nbsp;</li>
                        <li>&nbsp;</li>
                        <li>&nbsp;</li>
