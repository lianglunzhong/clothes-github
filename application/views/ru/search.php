    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll">
                ...
                &gt;Поиск : <strong><?php echo $keywords; ?></strong>
            </div>
        </div>
    </div>
    <div class="grid">
        <article class="filter_page">
            <ul class="filter-bar cf">
                <li style="float:left;"><div>Сортировка по:&nbsp;</div></li>
                <li class="item-l choice" style="width:160px;">
                    <div class="choice-hd">
                        <?php
                        $ens = array("Default", "What's New", 'Best Seller', 'Price: Low To High', 'Price: High To Low','Default');
                        $trns = array('выбрать', 'Новинки', 'популярности', 'цене по возрастанию', 'цене по убыванию','выбрать');
                        if(isset($_GET['sort']))
                        {
                ...
                <?php
                    ...
                    ?>
                    <a href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . Security::xss_clean(implode('&', $gets1)); ?>" class=""> <i class="icon icon-pick"></i> Выбор звёзд</a>
                </li>
        ...
        else
        {
            ...
            <div class="notfound">
                ...
                <div class="searchon_box">
                    <p class="top"><strong>Извините!</strong> По вашему запросу ничего не найдено,<br />
                ...
                <div class=" font18 mb25">Вы можете посмотреть  наши ходовые товары:</div>
