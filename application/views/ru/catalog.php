...
<section id="main">
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            if ($show)
            {
                ...
                <ul class="JS_tab3 detail_tab hotnew_box fix" style="margin-top:0;">
                    <?php
                    if ($show == 1)
                        echo '<li class="on">популярности</li>';
                    elseif ($show == 2)
                        echo '<li class="on">Новинки</li>';
                    elseif ($show == 3)
                        echo '<li class="on">популярности</li><li>Новинки</li>';
                    ?>
                </ul>
                ...
                <article class="filter_page">
                    <ul class="select fix">
                        ...
                        if (!empty($gets1))
                        {
                            ...
                            $gets1[] = 'pick=1';
                        ?>
                        <span><a class="icon_pick" href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . implode('&', $gets1); ?>" title="Выбор звёзд"></a></span>
                        <li class="last">
                            <?php
                            echo $pagination;
                            ?>
                            ...
                            <li class="JS_shows_btn1">
                                ...
                                <p class="price fix">
                                    ...
                                    if ($orig_price > $price)
                                    {
                                        ...
                                        <br/><span class="off"><?php echo $off; ?>% скидки</span>
                                        <?php
                                    }
                                    else
                                    {
            ...
            <article class="filter_page">
                <ul class="select fix">
                    <li><a class="icon_pick" href="<?php echo $_SERVER['REDIRECT_URL'] . '?' . implode('&', $gets); ?>">Выбор звёзд</a></li>
                    <li class="last">
                        <?php
                        echo $pagination;
                        ?>
        ...
        {
            echo View::factory('/'.LANGUAGE.'/catalog_left');
        }
        else
        {
            echo View::factory('/'.LANGUAGE.'/catalog_left_1')
...
<?php echo View::factory('/'.LANGUAGE.'/quickview'); ?>
