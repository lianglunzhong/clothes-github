...
<section id="main">
    ...
    <section class="layout fix">
            ...
            <div class="pro_right flr">
                <dl>
                    <dd>
                        ...
                        <div class="fix">
                            <p style="padding-bottom:12px;color:#999;">
                                ...
                                ?>
                            <span id="product_status" style="margin-right:15px;color:#000;"><?php echo $instock ? 'В наличии' : '<strong class="red">Нет в наличии</strong>'; ?></span>
                            Товар#: <?php echo $product->get('sku'); ?>
                            <?php
                            if(!empty($brands))
                            {
                                ?>
                    ...
                    <dd class="fix info jiage" style="margin-top:15px;">
                        ...
                        if ($vip_level)
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    ?>
                                    VIP. Цена <?php echo $currency_change; ?><?php echo Site::instance()->price($vip_price, 'code_view'); ?>
                                    <?php
                                }
                            }
                        }
                        ...
                        {
                            ?>
                            <a href="<?php echo LANGPATH; ?>/customer/login?redirect=/product/<?php echo $product->get('link'); ?>_p<?php echo $product_id; ?>" style="text-decoration:underline;font:Arial, Helvetica, sans-serif;font-size:11px;" class="pro_sign JS_popwinbtn1" id="sign_in">Войти</a> для VIP привилегий
                            <?php
                        }
                        ?>
                        <?php
                    ...
                    <dd>
                        ...
                        <div class="timeleft_box mt10">
                            ...
                            <div class="JS_dao">Распродажа закончится : <strong class="JS_RemainD"></strong>d <strong class="JS_RemainH"></strong>h <strong class="JS_RemainM"></strong>m <strong class="JS_RemainS"></strong>s</div>
                        </div>
                        <?php
                        }
                        ?>
                    ...
                    <dd class="last" style="margin-top:25px;">
                        ...
                        <div  class="fix">   
                            ...
                            {
                            ?>
                                <a target="_blank" href="#" class="text_underline JS_popwinbtn1" id="write_review" style="margin-left:10px;font-weight:bold;" >Написать отзыв</a>
                            <?php
                            }
                            else
                            {
                                ?>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" class="text_underline" style="margin-left:10px;font-weight:bold;" >Написать отзыв</a>
                                <?php
                            }
                            ?>
                        </div>
                        ...
                        <form action="/cart/add" method="POST" id="formAdd">
                            ...
                            <div class="size">
                                ...
                                {
                                ?>
                                    <span class="JS_popwinbtn2 fix" style="cursor:pointer;float:right;margin-top:3px;text-decoration: underline;font-weight: bold;">Таблица размеров</span>
                                <?php
                                }
                                ?>
                                </div>
                                <script type="text/javascript">
                                    $(function(){
                                        $(".size_list li").live("click",function(){
                                            ...
                                            $(this).addClass('on');
                                            $("#select_size").html('Размеры: '+$(this).text());
                                            if(qty)
                                        ...
                                        $('#addCart').live("click",function(){
                                            ...
                                            if(!size)
                                            {
                                                alert($('#select_size').html()+',пожалуйста');
                                                return false;
                                            }
                                        })
                                    })
                            ...
                            if (!empty($attributes['color']))
                            {
                                ...
                                <div class="color">
                                    ...
                                    <p class="selected_box"><span class="selected" id="select_color">Выбрать цвет товара, пожалуйста:</span></p>
                            ...
                            {
                                ?>
                                <div id="select_type" class="mb10">Выберите Тип:</div>
                                <div class="btn_type">
                            ...
                            <div class="total">
                                ...
                                <span class="font14" style="margin-left:8px;display:inline-block;">Количество:</span><br />
                                ...
                                <br>
                                <input type="submit" value="ДОБАВИТЬ В КОРЗИНУ" id="addCart" class="btn40_16_red" style="font-size:18px;<?php if(!$instock) echo 'display:none;'; ?>" />
                                <span class="btn40_16_gray" id="outofstock" style="font-size:18px;<?php if($instock) echo 'display:none;'; ?>" />Нет в наличии</span>
                                ...
                                $wishlists = DB::select(DB::expr('COUNT(id) AS count'))
                                        ...
                                        ->execute()->get('count');
                                ?>
                                Избранное <?php echo $wishlists ? '(' . $wishlists . ')' : ''; ?>
                                </a>
              ...
              $(".swrp").hover(function(){
                   ...
                   $(this).hide();
                        ...
                        <ul class="JS_tab detail_tab fix">
                            <li class="current ss1" style="width: 90px;margin: 0 0 -1px 0;">Детали</li>
                            <?php
                            $models = '';
                            ...
                            {
                                ?>
                                <li class="ss2" style="width: 90px;margin: 0 0 -1px 0;">модель</li>
                                <?php
                            }
                            ?>
                            <li class="ss3" style="width: 90px;margin: 0 0 -1px 0;">Доставка</li>
                            <li class="ss4" style="width: 90px;margin: 0 0 -1px 0;">Контакт</li>
                            <p><b></b></p>
                        </ul>
                        <div class="JS_tabcon detail_tabcon">
                            <div class="bd">
                                ...
                                $brief = str_replace(array('One size', 'one size', 'One Size'), array('только один размер'), $brief);
                                echo $brief; ?>
								<span class="JS_popwinbtn2 fix" style="cursor:pointer;margin-top:3px;text-decoration: underline;font-weight: bold;">Размеры</span>
								<?php 
								echo '<br><br>';
								if($has == 0){
									$description = $prodes;
        ...
        <article class="buyshow_box layout fix">
            <div class="w_tit layout">
                <ul class="fix dingbu" style="float:left;">
                    ...
                    <li class="current">Шоу Покупателей</li>
                    <?php endif; ?>
                    <?php if ($product->get('has_link') == 1 AND !empty($link_images)): ?>
                    <li <?php if(empty($celebrity_images)) echo 'class="current"'; ?>>Получить Этот</li>
                    <?php endif; ?>
                    <?php if (isset($videos) AND !empty($videos)): ?>
                    <li <?php if ($product->get('has_link') == 0 AND empty($link_images) AND empty($celebrity_images)) echo 'class="current"'; ?>>Видео Клиент</li>
                    <?php endif; ?>
                    <p><b></b></p>
                </ul>
            </div>
            ...
            <div class="product_carousel fix ts">
                ...
                if($count > 8)
                {
                    ...
                    <?php
                    echo '<div class="view1 fix"><p>Далее+</p></div>';
                }
                ?>
            </div>
            <?php
            ...
            ?>
                <div class="pro_lookwith fix ts <?php if(!empty($celebrity_images)) echo 'hide'; ?>" style="width:1024px;height:auto;margin:0 auto;overflow: hidden;">
                    <div style="float:left;">
                        <?php foreach ($link_images as $key => $link_img) : ?>
                            <ul class="fix" style="height:493px;<?php if($key > 0) echo 'display:none;'; ?>">
                                ...
                                <li style="overflow: hidden; float: left; width: 613px; height: 510px;">
                                    ...
                                    <p class="fix"><a class="btn40_16_red flr JS_popwinbtn4" title="<?php echo $key; ?>">Получить Этот</a></p>
                                </li>
                            </ul>
                        <?php endforeach; ?>
                        <?php
                        ...
                        {
                            ?>
                            <a class="view_more flr mr15" onclick="$('.pro_lookwith .fix').show();$(this).hide();">Далее+</a>
                            <?php
                        }
                        ?>
                    </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $(".view1 p").click(function() {
                        ...
                        if(text == 'Далее+')
                        {
                            $(".view1 p").text("Свернуть-");
                        }
                        else if(text == 'Свернуть-')
                        {
                            $(".view1 p").text("Далее+");
                        }
                    })
                        ...
                        if (!empty($skus))
                        {
                            ...
                            <form action="<?php echo LANGPATH; ?>/cart/add_more" method="post" class="form3" id="form<?php echo $key; ?>">
                                    ...
                                    <ul class="scrollableDiv1 scrollableDivs<?php echo $key; ?> fix">
                                        ...
                                        foreach ($skus as $sku)
                                        {
                                            ...
                                            <li>
                                                ...
                                                <p class="select">Размеры: 
                                                    <select name="size[<?php echo $n; ?>]" class="size_select" <?php if(!$instock) echo 'disabled="disabled"'; ?>>
                                                        ...
                                                        if(!empty($pro_stocks))
                                                        {
                                                            ...
                                                            ?>
                                                            <option value="<?php echo str_replace('EUR', '', $sizeval); ?>" ><?php echo $sizeval; ?> <span class="red">(Только <?php echo $p; ?>)</span></option>
                                                            <?php
                                                            }
                                                        }
                                                        else
                                                        ...
                                                        else
                                                        {
                                                            $is_onesize = 1;
                                                            ?>
                                                            <option value="one size" <?php if (isset($pro_stocks['one size'])) echo 'title="' . $pro_stocks['one size'] . '"' ?>> Размеры</option>
                                                            <?php
                                                        }
                                                        }
                                                        ?>
                                                ...
                                                <p class="center"><a href="<?php echo $sku_link; ?>" class="btn22_gray" target="_blank">Детали</a></p>
                                                <?php
                                                if (!$instock)
                                ...
                                <div class="center mt50">
                                    <input type="submit" value="ДОБАВИТЬ В КОРЗИНУ" class="btn40_16_red" /><a href="<?php echo LANGPATH; ?>/wishlist/add_more/<?php echo implode('-', $wishlist); ?>" class="a_underline add_wishlist">Избранное</a>
                                </div>
        ...
        <div class="w_tit layout"><h2>Другие Клиенты Также Просматривали</h2></div>
        <div class="box-dibu1">
        ...
        <article class="wufeng layout">
            <div class="box-title">
                <ul>
                    <li class="current">похожие стили</li>
                    <li class="">Новинки</li>
                    <li class="">Ходовые товары</li>
                    <li class="">последнее рассмотрение</li>
                </ul>
                <p style="left: 180px;">
        ...
        <article class="product_reviews" style="margin-top:30px;">
            <div class="w_tit layout" style="margin-bottom:30px"><h2>Отзывы покупателей</h2></div>
            <?php
            if(empty($reviews))
            {
            ?>
                <div style="text-align:center; margin-bottom:-40px;">
                    <img src="/images/product-detail_hongxin.jpg" /><span style="font-weight:bold; margin-left:10px;font-size:16px;">0</span><span style=" margin-left:5px;font-size:16px;">отзывов</span>
                    <p style="margin-top:15px;font-size:14px;">БУДЬТЕ ПЕРВЫМ, ВЫСКАЖИТЕ СВОЕ МНЕНИЕ</p>
                    <?php
                    if(!$customer_id)
                    {
                    ?>
                        <a class="JS_popwinbtn1 btn40_16_red" id="write_review1" href="javascript:void(0)" style="margin-top:18px;margin-bottom:100px; cursor:pointer;">Написать отзыв</a>
                    <?php
                    }
                    else
                    {
                        ?>
                        <a target="_blank" class="btn40_16_red" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" style="margin-top:18px;margin-bottom:100px; cursor:pointer;">Написать отзыв</a>
                        <?php
                    }
                    ?>
                </div>
                ...
                <div style="margin:0 0 20px 0;padding:10px 0 ; background-color:#fafafa;border:1px solid #CCC">
                    <div class="rating" style="margin:10px 0 0 0;">
                        <span class="s1" style="margin-left:30px;font-weight:bold;">
                            <strong class="<?php echo $star_class; ?>"></strong>Средний Общий Рейтинг
                        </span>
                        <span class="s1" style="margin-left:57px;font-weight:bold;">Рейтинг Качества: <div class="outbt"><div style="width:<?php echo round($reviews_data['quality'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                        <span class="s1" style="margin-left:20px;font-weight:bold;">Рейтинг Цены: <div class="outbt"><div style="width:<?php echo round($reviews_data['price'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></strong></span>
                        <span class="s1" style="margin-left:20px;font-weight:bold;">Рейтинг Фитнеса: </span><span> <?php echo $review_title['fitness'][ceil($reviews_data['fitness'])]; ?></span>
                    </div>
                    <div style="margin:0 0 15px 0;">
                        <span class="s2" style="margin-left:139px;font-weight:bold;">Рейтинг: <?php echo $reviews_data['overall']; ?> / 5(<?php echo $count_reviews; ?>)</span>
                        <span class="s2" style="margin-left:226px;color:##727272;">
                            <?php
                        ...
                        <span class="s2" style="margin-left:110px;color:##727272;">
                            <?php echo $review_title['price'][ceil($reviews_data['price'])]; ?>
                        </span>
                    </div>
                    <div>
                        <span class="s2" style="margin:0 0 15px 30px;"><?php echo $count_reviews; ?> <?php if($count_reviews ==1) {echo 'отзыва';}elseif($count_reviews >=2&&$count_reviews <=4){echo 'отзыва';}else {echo 'отзывов';} ?>  &nbsp; | &nbsp;   
                        <?php
                        if(!$customer_id)
                        {
                            ?>
                            <a href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" class="JS_popwinbtn1" id="write_review2" style="text-decoration:underline;">Написать отзыв</a>
                            <?php
                        }
                        else
                        {
                            ?>
                            <a target="_blank" href="<?php echo LANGPATH; ?>/review/add/<?php echo $product_id; ?>" style="text-decoration:underline;">Написать отзыв</a>
                            <?php
                        }
                        ?>
                        </span>
                ...
                ?>
                    ...
                    ?>
                        <li class="fix bgg">
                            <div class="left">
                                <dl>
                                    <dd><span style="color:#000;width:65px;display:block;float:left;">Name:</span><span><?php echo $firstname; ?></span></dd>      
                                    <dd><span style="color:#000;width:65px;display:block;float:left;">Размеры:</span><span><?php echo $size ? $size : $attributes['size'][0]; ?></span></dd> 
                                    <dd><span style="color:#000;width:65px;display:block;float:left;">по фигуре:</span><span><?php echo $review_title['fitness'][$r['fitness']]; ?></span></dd>     
                                    <dd><span style="color:#000;width:65px;display:block;float:left;">Высота:</span><span><?php echo $r['height']; ?> CM</span></dd> 
                                    <dd><span style="color:#000;width:65px;display:block;float:left;">вес:</span><span><?php echo $r['weight']; ?> KG</span></dd> 
                                </dl>
                            </div>
                            <div class="right">
                                <div class="rating1">
                                    ...
                                    <span class="s1" style="margin-left:20px;font-weight:bold;">Рейтинг Качества: <div class="outbt"><div style="width:<?php echo round($r['quality'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                                    <span class="s1" style="margin-left:20px;font-weight:bold;">Рейтинг Цены: <div class="outbt"><div style="width:<?php echo round($r['price'] / 0.05, 2); ?>%;background:#f8b500;" class="inbt"></div></div></span>
                                </div>
...
<div class="JS_popwincon2 popwincon w_p30 hide">
    ...
    <ul class="JS_tab4 detail_tab fix">
        <?php if ($set_id != 2): ?>
            <li class="current">Одежда</li>
            <li>Преобразование графиков</li>
        <?php endif; ?>
        <?php if ($set_id == 2): ?>
            <li class="current">Обувь</li>
        <?php else: ?>
            <li>Обувь</li>
        <?php endif; ?>
        <?php if (Product::instance($product_id)->get('set_id') != 2 AND !empty($celebrity_lists)): ?>
            <li>Попробуйте на отчет</li>
        <?php endif; ?>
        <li>измерения</li>
    </ul>
        ...
        if ($set_id != 2)
        {
            ...
            <div class="bd">
                ...
                <table class="user_table">
                    <tr>
                        <th width="10%" rowspan="2">Размер топы</th>
                        <?php
                        if (!empty($us_sizes))
                        {
                            ?>
...
?>
        ...
        <div class="bd size_mesurements hide">
            ...
            <div class="fix">
                ...
                <div class="right fll">
                    <h4>Обхват груди</h4>
                    <p>Измеряется на уровне подмышечных впадин по наиболее выступающим точкам груди.</p>
                    <h4>Обхват талии</h4>
                    <p>Измеряется по самому узкому месту талии, чуть выше вашей тазовой кости. Измерение должно быть ближе к животу, но не оказывать давление на вашу кожу.</p>
                    <h4>Обхват бедер</h4>
                    <p>Измеряется по наиболее выступающим точкам ягодиц. В зависимости от роста мерка снимается на расстоянии восемнадцать-двадцать два см от линии талии.</p>
                    <h4>Длина платья</h4>
                    <p>Встайте прямо, пятки вместе. Измеряется по спиной от высшей точки плечи вниз. Пожалуйста, выберите соответствующую длину в соответствии с практической ситуацией.</p>
                </div>
            </div>
            <h3>Обувь</h3>
            <div class="fix">
                ...
                <div class="right fll">
                    <h4>Длина обувь</h4>
                    <p>Измерьте обувь от передней части носочная часть к задней части пятки.</p>
                    <h4>Высота обувь</h4>
                    <p>Измеряется от верха обуви рант к нижней части пятки,покоящегося на плоской поверхности.</p>
                    <h4>Высота каблука</h4>
                    <p>Измеряется каблук от шовы обуви до дна, покоящегося на плоской поверхности.</p>
                    <h4>Высота платформы</h4>
                    <p>Измерьте расстояние от нижней части подошвы, где она соединяется к обуви на платформе.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    $(function(){
        $.ajax({
            ...
            success: function(product){
                ...
                $("#select_size").html('Размеры: '+$(".size_list li").text());
                <?php } ?>
            }
        });
    })
...
var timec;
$(function(){
    $(".box-title ul li").live("click",function(){    
    $(this).addClass("current").siblings().removeClass("current");
...
var timec1;
$(function(){
    $(".box-current li").live("click",function(){ 
    $(this).addClass("on").siblings().removeClass("on");
