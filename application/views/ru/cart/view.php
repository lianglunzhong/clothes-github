        ...
        <section class="cart cart_view">
            ...
            if (!$count)
            {
                ...
                <div class="cart_empty">
                    ...
                    <p>
                        Посмотреть товары в <a href="<?php echo LANGPATH; ?>/customer/wishlist" class="a_underline">избранное</a> 
                        <?php
                        if(!empty($cartcookie))
                        {
                            ?>
                            , <a href="#saved_items" class="a_underline">список сохранения товаров</a>
                            <?php
                        }
                        ?>
                        или <a href="<?php echo LANGPATH; ?>/" class="a_underline">продолжить покупки</a>
                    </p>
                </div>
                <div id="saved_items"></div>
                <?php if(count($cartcookie)>0){ ?>
                <div class="fix mt30">
                    <strong class="fll font18">Ваши Сохраненные Товары</strong>
                </div> 
                        ...
                        <td>
                            <div class="fix">
                                ...
                                <div class="right">
                                    ...
                                    <p class="color666">Товар: #<?php echo $cookie_product->get('sku'); ?></p>
                                    <p class="bottom"><!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Сохранить в избранное</a-->
                                        <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline fll"  onclick="if(!confirm('Вы уверены, что хотите удалить этот товар?')){return false;}">Удалить</a><span style="margin:3px 10px;float:left">|</span>
                                        <a href="<?php echo LANGPATH; ?>/cart/cookie2cart/<?php echo $key;?>" class="a_underline fll green">Добавить в корзину</a>
                                    </p>
                                </div>
                            </div>
                        </td>
                      ...
                      <td>
                        <div class="fix">
                          ...
                          <div class="right">
                            ...
                            <p class="gray">Товар: #<?php echo $cookie_product->get('sku'); ?><span class="red font11 ml5">Нет в наличии</span></p>
                            <p class="bottom"><!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Сохранить в избранное</a-->
                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline">Удалить</a></p>
                          </div>
                        </div>
                      </td>
                      <td>
                ...
                <div class="fix">
                    <div class="fll">
                        <h2>Корзина</h2>
                        <span class="show" >Мы принимаем:<img class="ml10" style="vertical-align:middle" src="/images/shopping-bag-accept.png" usemap="#Shopping" /></span>
                ...
                <!--<p class="mb25"><span class="special_offers">Bitte beachten Sie, dass die Товар jeweils nur für 30 Minuten für Ihren Warenkorb reserviert werden</span></p>-->
                <div class="shopping_bag mb25">
                                ...
                                <td>
                                    <div class="fix">
                                        ...
                                        <div class="right">
                                            ...
                                            <p class="color666">Товар: #<?php echo Product::instance($product['id'])->get('sku'); ?></p>
                                            <p class="bottom">
                                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline fll" onclick="if(!confirm('Вы уверены, что хотите удалить этот товар?')){return false;}">Удалить</a><span style="margin:3px 10px;float:left">|</span>
                                                <?php if($save_show){ ?>
                                                <a href="/cart/cookie2later/<?php echo $key;?>" class="a_underline fll green">Только Сохранить</a>
                                                <?php }else{ ?>
                                                <a id="sign_in" class="pro_sign JS_popwinbtn1" href="<?php echo LANGPATH; ?>/customer/login?redirect=<?php echo LANGPATH; ?>/cart/view">Только Сохранить</a>
                                                <?php } ?>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <form action="<?php echo LANGPATH; ?>/cart/product_edit" method="post" class="hide">
                                        ...
                                        <ul class="cart_option">
                                            ...
                                            if(Product::instance($product['id'])->get('stock') == -1)
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <li class="red">Теперь Только <span><?php echo $stocks; ?></span></li>
                                                    <?php
                                                }
                                            }
                                            ?>
                                            <li>
                                                <input type="reset" value="переустановка" class="btn22_black change_cancel" />
                                                <input type="submit" value="Дальше" class="btn22_black" />
                                            </li>
                                        </ul>
                                    </form>
                                    <ul class="cart_option">
                                        ...
                                        ?>
                                        <li>
                                            <a class="btn22_black change_detail">Изменять детали</a>
                                        </li>
                                    </ul>
                                </td>
                                    ...
                                    <td>
                                        <div class="fix">
                                            ...
                                            <div class="right">
                                                ...
                                                <p>Товар: #<?php echo Product::instance($largess['id'])->get('sku'); ?></p>
                                                <a href="<?php echo LANGPATH; ?>/cart/largess_delete/<?php echo $key; ?>" class="a_underline">Удалить</a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                foreach ($largesses_for_choosing['largesses'] as $key => $largesses_for_choosing_product)
                                {
                                    ...
                                    <form method="POST" action="<?php echo LANGPATH; ?>/cart/largess_add">
                                        <tr>
                                            <td width="35%">
                                                <div class="fix">
                                                    ...
                                                    <div class="right">
                                                        ...
                                                        <p class="color666">Товар: #<?php echo Product::instance($key)->get('sku'); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td width="25%">
                                            ...
                                            <td width="15%"><input type="submit" value="Принять данное предложение" class="btn22_black" /></td>
                                        </tr>
                                    </form>
                                    <?php
                                }
                    ...
                    <ul class="shopping_total">
                        <li class="first">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo $catalog_link; ?>" class="a_underline"><< Продолжить Покупки</a>
                        </li>
                        <li><label>Промежуточный итог:</label><span class="font14"><?php echo Site::instance()->price($subtotal, 'code_view'); ?></span></li>   
                        <li class="red bold">
                            <?php
                            $cart_save = 0;
                            if ($cart['amount']['save'])
                        ...
                        <li class="bottom b1"><label>Итого:</label><span class="font20"><?php echo Site::instance()->price($cart['amount']['items'] - $cart_save, 'code_view'); ?></span></li>
                        <li class="bottom">
                            <a href="<?php echo LANGPATH; ?>/cart/checkout" class="btn40_16_red">Оформить заказ</a>
                        </li>
                        <li class="bottom last">
                            <em class="color666"><b class="red">Совет!</b> Нужно использовать ваши баллы и купоны для оформления заказ.</em>
                        </li>
                    </ul>
                </div>
                      ...
                      <td>
                        <div class="fix">
                          ...
                          <div class="right">
                            ...
                            <p class="color666">Товар: #<?php echo $cookie_product->get('sku'); ?></p>
                            <p class="bottom">
                                <!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Сохранить в избранное</a-->
                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" onclick="if(!confirm('Вы уверены, что хотите удалить этот товар?')){return false;}" class="a_underline fll">Удалить</a><span style="margin:3px 10px;float:left">|</span>
                                <a href="<?php echo LANGPATH; ?>/cart/cookie2cart/<?php echo $key;?>" class="a_underline fll green">Добавить в корзину</a>
                            </p>
                          </div>
                        </div>
                      ...
                      <td>
                        <div class="fix">
                          ...
                          <div class="right">
                            ...
                            <p class="bottom">
                                <!--a href="<?php //echo LANGPATH; ?>/wishlist/cookie_add/<?php //echo $key; ?>?return=cart" class="a_underline">Сохранить в избранное</a-->
                                <a href="<?php echo LANGPATH; ?>/cart/delete/<?php echo $key; ?>" class="a_underline">Удалить</a>
                            </p>
                          </div>
                        </div>
                      </td>
                ...
                <p class="mb20"><a href="<?php echo LANGPATH; ?>/cart/cartcookie_invalid">Удалить Недействительные Товары</a></p>
                <P class="mb20">Цены и Наличие товаров на Choies может Быть изменяться.Корзина-это временное место для хранения списка товаров и отражает последнюю цену каждых товаров .</P>
                <?php } ?>
