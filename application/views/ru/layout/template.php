...
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6014860836030&amp;cd[value]=0.00&amp;cd[currency]=USD&amp;noscript=1" /></noscript>
    ...
    <body>
        ...
        if ($user_id)
        {
            ...
            {
                $c_admin = DB::select('admin')->from('celebrits')->where('id', '=', $cid)->execute()->get('admin');
                $admin_email = DB::select('email')->From('users')->where('id', '=', $c_admin)->execute()->get('email');
                    ...
                    <div class="layout">
                        ...
                        <nav id="nav1" class="nav">
                            <ul class="fix">
                                ...
                                <li class="JS_show">
                                    <a href="<?php echo LANGPATH; ?>/apparels-c-40">Одежда</a>
                                        ...
                                        <ul class="fix">
                                            <li>
                                                <dl>
                                                    ...
                                                    <?php
                                                    $links = array(
                                                        array('Футболки','t-shirts-c-245'),
                                                        array('Верхняя одежда','coats-jackets-c-45'),
                                                        array('Кимоно','kimonos-c-414'),
                                                        array('Рубашки и блузки','shirt-blouse-c-43'),
                                                        array('нереальный мех','unreal-fur-c-285'),
                                                        array('2 в 1','two-piece-suit-c-177'),
                                                        array('Жакет','suits-blazers-c-46'),
                                                        array('Джемпер и кардиган','jumpers-cardigans-c-89'),
                                                        array('Комбинезоны','jumpsuits-playsuits-c-119'),
                                                        array('Байкеры-Куртка','leather-biker-jackets-c-120'),
                                                        array('Фуфайки С Шапкой И Фуфайки','hoodies-sweatshirts-c-117'),
                                                        array('Купальники и пляжная одежда','swimwear-beachwear-c-178'),
                                                        array('Кроп-топы и bralets','crop-tops-bralets-c-244'),
                                                        array('Безрукавка и топы','vests-tanks-c-242'),
                                                    );
                                                ...
                                                <dl>
                                                    <dt><a href="<?php echo LANGPATH; ?>/bottoms-c-240">Боттомс</a></dt>
                                                    <?php
                                                    $hots = array(
                                                        'skirt'
                                                    );
                                                    ...
                                                    foreach ($catalogs as $catalog):
                                                        ...
                                                        ?>
                                                        <dd><a href="<?php echo $link; ?>" <?php if(in_array($link, $hots)) echo 'style="color:#ba2325;"'; ?>><?php echo ucfirst(Catalog::instance($catalog, LANGUAGE)->get('name')); ?></a></dd>
                                                        <?php
                                                    endforeach;
                                                    ?>
                                                </dl>
                                            ...
                                            <li>
                                                <dl>
                                                    ...
                                                    $links = array(
                                                        ...
                                                        array('Облегающие платья', 'bodycon-dresses-c-211'),
                                                        array('Белые платья', 'white-dresses-c-204'),
                                                        array('Длинные платья', 'maxi-dresses-c-207'),
                                                        array('Homecoming Платья', 'homecoming-dresses-c-454'),
                                                        array('Платья с длинными рукавами', 'long-sleeve-dresses-c-507'),
                                                        array('Платья С Открытым Плечом', 'off-the-shoulder-dresses-c-504'),
                                                        array('Платья С Открытой Спиной', 'backless-dress-c-456'),
                                                        array('Платья с короткими рукавами', 'short-sleeve-dresses-c-505'),
                                                    );
                                            ...
                                            <li>
                                                <!--<dl>
                                                    <dt><a href="<?php echo LANGPATH; ?>/apparels-c-40/new">Новинки</a></dt>
                                                    <dd><a href="#"></a></dd>
                                                </dl>-->
                                                <dl>
                                                    <dt><a href="<?php echo LANGPATH; ?>/top-sellers-c-32">Ходовые товары</a></dt>
                                                    <dd><a href="#"></a></dd>
                                                </dl>
                                                <dl>
                                                    <dt><a href="<?php echo LANGPATH; ?>/outlet-c-101">Распродажа</a></dt>
                                                    <dd><a href="#"></a></dd>
                                                    <dd><a href="#"></a></dd>
                                                </dl>
                                                <dl>
                                    ...
                                    <div class="nav_list JS_showcon hide" style="width: 174px; margin-left: 205px;">
                                        ...
                                        <ul class="fix">
                                            <li style="padding-bottom: 0;">
                                                <dl>
                                                    <dt><a href="<?php echo LANGPATH; ?>/shoes-c-53/new">Новинки</a></dt>
                                                    <?php
                                    ...
                                    <div class="nav_list JS_showcon hide" style="<?php if ($count > 11) echo 'width: 400px; margin-left: 140px;'; else echo 'width: 174px; margin-left: 230px;' ?>">
                                        ...
                                        <ul class="fix">
                                            <li style="padding-bottom: 0;width:190px;">
                                                <dl>
                                                    <dt><a href="<?php echo LANGPATH; ?>/accessory-c-52/new">Новинки</a></dt>
                                                    <?php
                                                    for ($i = 0; $i < 11; $i++):
                                                        if (!isset($catalogs[$i]))
                                                            continue;
                                    ...
                                    <div class="nav_list JS_showcon hide" style="width: 244px; margin-left: 202px;">
                                        ...
                                        <ul class="fix">
                                            <li style="padding-bottom: 0;width:240px;">
                                                <dl>
                                                    <dt><a href="<?php echo LANGPATH; ?>/salute-the-spring-c-508">ВЕСЕННЯЯ РАСПРОДАЖА</a></dt>
                                                    <br>
									...
									<div class="nav_list JS_showcon  hide" style="width: 580px; left: -300px;">
                                        ...
                                        <ul class="fix new_list">
                                            <li style="padding-bottom: 0px;">
                                                <dl>
                                                    <dt>Рекомендуемые</dt>
                                                    <!--<dd><a href=" echo LANGPATH; /freetrial/add">Центр бесплатного испытания</a></dd>-->
                                            ...
                                            <li style="padding-bottom: 0px;">
                                                <dl>
                                                    <dt>Тенденция</dt>
                                                    <dd><a href="<?php echo LANGPATH; ?>/tropical-palm-tree-print-c-447">С Рисунком Пальмовых Деревьев</a></dd>
                                                    <dd><a href="<?php echo LANGPATH; ?>/off-shoulder-c-444">С Открытыми Плечами</a></dd>
                                                    <dd><a href="<?php echo LANGPATH; ?>/activity/stripes-collection">Полосатая Коллекция</a></dd>
                                                    <dd><a href="<?php echo LANGPATH; ?>/crochet-lace-c-419">Вязание Кружева</a></dd>
                                                    <dd><a href="<?php echo LANGPATH; ?>/vintage-floral-c-421">С Рисунком Цветов</a></dd>
													 <dd><a href="<?php echo LANGPATH; ?>/kimonos-c-414?sort=0&limit=1">Кимоно стиль</a></dd>
                                                </dl>
                                            </li>
