        ...
        $.post(
            ...
            function(product)
            {
                ...
                for(var n in product['images'])
                {
                    ...
                    {
                        bimage = 'http://www.choies.com/pimages/' + product['images'][n]['id'] + '/2.' + product['images'][n]['suffix'];
                        simage = 'http://www.choies.com/pimages/' + product['images'][n]['id'] + '/3.' + product['images'][n]['suffix'];
                    }
                    else
                    {
                        bimage = 'http://www.choies.com/pimages1/' + product['images'][n]['id'] + '/2.' + product['images'][n]['suffix'];
                        simage = 'http://www.choies.com/pimages1/' + product['images'][n]['id'] + '/3.' + product['images'][n]['suffix'];
                    }
                    if(n == 0)
                    {
