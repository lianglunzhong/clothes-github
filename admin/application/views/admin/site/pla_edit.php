...
<input type="hidden" name='pla' value="add"></input>
	...
	<tr>
		...
		<td>
			<select name="type" >
				<option value="0">自定义类feed</option>
				<option value="1">自动获取类feed</option>
			</select>
		</td>
	</tr>
	<?php }?>
<?php }else{?>
	...
	<table>
		...
		<tr><td>promotion</td><td><input type="text" name='promotion' value=""></td></tr>
	</table>
	<?php }else{?>
		<table>
			<tr><td>country:</td>
				<td>
					<select name="country">
						<option value="US" <?php if($feed_list[0]['country']=='US'){echo "selected='selected'";}?>>US</option>
						<option value="UK" <?php if($feed_list[0]['country']=='UK'){echo "selected='selected'";}?>>UK</option>
						<option value="AU" <?php if($feed_list[0]['country']=='AU'){echo "selected='selected'";}?>>AU</option>
						<option value="CA" <?php if($feed_list[0]['country']=='CA'){echo "selected='selected'";}?>>CA</option>
						<option value="FR" <?php if($feed_list[0]['country']=='FR'){echo "selected='selected'";}?>>FR</option>
						<option value="ES" <?php if($feed_list[0]['country']=='ES'){echo "selected='selected'";}?>>ES</option>
						<option value="DE" <?php if($feed_list[0]['country']=='DE'){echo "selected='selected'";}?>>DE</option>
					</select>
				</td>
			</tr>
			<tr><td>promotion</td><td><input type="text" name='promotion' value="<?php if($feed_list[0]['promotion']){echo $feed_list[0]['promotion'];}?>"></td></tr>
		</table>
	<?php }?>
<?php }?>
