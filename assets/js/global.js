function showup(ms) {
    ...
    $('.JS-popwincon5').appendTo('body').fadeIn(320);
    $('.JS-popwincon5').show();
    $('#jsshowup').html(ms);
    return false
}
$(".JS-close6,.JS-filter4").live("click",
function() {
    $(".JS-filter4").remove();
...
function() {
    ...
    $('.JS_popwincon').show();
    return false
}) $(".JS_popwincon .JS_close1,.JS_filter").live("click",
function() {
    $(".JS_filter").remove();
...
$(function() {
    ...
    $(".JS_select").click(function() {
        ...
        $(this).addClass("selected") $(this).parent().find(".JS_hidden2").val("1")
    },
    function() {
        $(this).removeClass("selected") $(this).parent().find(".JS_hidden2").val("0")
...
function() {
    ...
    $('.JS_popwincon').show();
    return false
}) $(".JS_close1,.JS_filter").live("click",
function() {
    $(".JS_filter").remove();
    $('.JS_popwincon').fadeOut(160);
    return false
}) $(".JS_popwinbtn1").live("click",
function() {
    var top = getScrollTop();
    top = top - 35;
    ...
    $('.JS_popwincon1').show();
    return false
}) $(".JS_close2,.JS_filter1").live("click",
function() {
    $(".JS_filter1").remove();
    $('.JS_popwincon1').fadeOut(160);
    return false
}) $(".JS_popwinbtn2").live("click",
function() {
    var top = getScrollTop();
    top = top - 35;
    ...
    $('.JS_popwincon2').show();
    return false
}) $(".JS_close3,.JS_filter2").live("click",
function() {
    $(".JS_filter2").remove();
    $('.JS_popwincon2').fadeOut(160);
    return false
}) $(".JS_popwinbtn3").live("click",
function() {
    var top = getScrollTop();
    top = top - 35;
    ...
    $('.JS_popwincon3').show();
    return false
}) $(".JS_close4,.JS_filter3").live("click",
function() {
    $(".JS_filter3").remove();
    $('.JS_popwincon3').fadeOut(160);
    return false
}) $(".JS_popwinbtn4").live("click",
function() {
    var top = getScrollTop();
    top = top - 35;
    ...
    $('.JS_popwincon4').show();
    return false
}) $(".JS_close5,.JS_filter4").live("click",
function() {
    $(".JS_filter4").remove();
