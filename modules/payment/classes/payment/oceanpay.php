...
class Payment_OceanPay extends Payment
{
        ...
        public function pay($order, $data = NULL)
        {
                ...
                $mail_params['order_view_link'] = 'http://' . Site::instance()->get('domain') . '/order/view/' . $order['ordernum'];
                ...
                switch ($data['succeed'])
                {
                        case '1':
                                ...
                                else
                                {
                                        ...
                                        $array = array(
                                                array('name'=>'email','value'=>$mail_params['email']),
                                                array('name'=>'created','value'=>$mail_params['created']),
                                                array('name'=>'order_num','value'=>$mail_params['order_num']),
                                                array('name'=>'currency','value'=>$mail_params['currency']),
                                                array('name'=>'amount','value'=>$mail_params['amount']),
                                                array('name'=>'points','value'=>$mail_params['points'])
                                            );
                                        $mail_lang = 'active';
                                        $postarr[]['fields'] = $array;
                                        $send = Mail::Sendcustomer($postarr,$mail_lang,'PAYSUCCESS');
